 ...
 */
function convert(jdlEntities, creationTimestamp, disableBuiltInEntitiesFiltering) {
    if (!jdlEntities) {
        throw new Error('JDL entities must be passed to get the basic entity information.');
    }
    return createJSONEntities(jdlEntities, creationTimestamp || new Date(), disableBuiltInEntitiesFiltering);
}

function createJSONEntities(jdlEntities, creationTimestamp, disableBuiltInEntitiesFiltering) {
