 ...
 */
function convert(jdlRelationships = [], entityNames = [], skipUserManagement) {
    ...
    relatedRelationships.forEach((relatedRelationship, currentEntityName) => {
        setRelationshipsFromEntity(relatedRelationship, currentEntityName, skipUserManagement);
...
function setRelationshipsFromEntity(relatedRelationships, entityName, skipUserManagement) {
    relatedRelationships.from.forEach(relationshipToConvert => {
        ...
        if (relationshipToConvert.type === ONE_TO_ONE) {
            ...
            if (!relationshipToConvert.injectedFieldInTo) {
                ...
                if (skipUserManagement || !builtInEntities.has(relationshipToConvert.to.toLowerCase())) {
