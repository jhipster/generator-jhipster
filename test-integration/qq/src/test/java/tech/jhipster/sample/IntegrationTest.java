...
import tech.jhipster.sample.SampleGatewayApp;
...
@SpringBootTest(classes = { SampleGatewayApp.class, AsyncSyncConfiguration.class, TestSecurityConfiguration.class })
@EmbeddedSQL
