 ...
 *        - forceNoFiltering: whether to filter out unchanged entities,
 *        - application:
 *          - forNewApplication: whether the application is to be generated too,
...
function exportEntities(passedConfiguration) {
  ...
  createJHipsterJSONFolder(passedConfiguration.application.forNewApplication ? configuration.application.name : '');
  ...
  writeEntities(passedConfiguration.application.forNewApplication ? configuration.application.name : '');
  return _.values(configuration.entities);
}
