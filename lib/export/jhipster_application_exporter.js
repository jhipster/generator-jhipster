...
function setUpArrayOptions(application) {
  application[GENERATOR_NAME].testFrameworks = toArray(application[GENERATOR_NAME].testFrameworks);
  application[GENERATOR_NAME].languages = toArray(application[GENERATOR_NAME].languages);
  return application;
}
