module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c109 = function(head, tail) {return makeString(concat([head],tail));},
        peg$c110 = "required",
        ...
        peg$c147 = function(underscore, head, tail) {return makeString(concat(concat(underscore,[head]), tail));},
