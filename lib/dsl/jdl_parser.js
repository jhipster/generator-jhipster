...
module.exports = class JDLParser extends CstParser {
  ...
  parse() {
    ...
    this.skipClientDeclaration();
    this.skipServerDeclaration();
    this.noFluentMethod();
    ...
    this.RULE('prog', () => {
      this.MANY(() => {
        this.OR([
          ...
          { ALT: () => this.SUBRULE(this.skipClientDeclaration) },
          { ALT: () => this.SUBRULE(this.skipServerDeclaration) },
  ...
  skipClientDeclaration() {
    this.RULE('skipClientDeclaration', () => {
  ...
  skipServerDeclaration() {
    this.RULE('skipServerDeclaration', () => {
