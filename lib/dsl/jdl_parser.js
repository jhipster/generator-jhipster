...
module.exports = class JDLParser extends Parser {
  ...
  parse() {
    ...
    this.simpleAnnotationDeclaration();
    this.complexAnnotationDeclaration();
  ...
  simpleAnnotationDeclaration() {
    this.RULE('simpleAnnotationDeclaration', () => {
  ...
  complexAnnotationDeclaration() {
    this.RULE('complexAnnotationDeclaration', () => {
      this.CONSUME(LexerTokens.AT);
      this.OR([
  ...
  entityList() {
    this.RULE('entityList', () => {
      ...
      this.OR([
        ...
        { ALT: () => this.CONSUME1(LexerTokens.NAME) } // name includes the 'all' option, but it's handled afterwards
      ]);
      this.CONSUME(LexerTokens.WITH);
