...
// by defining keywords to 'inherit' from NAME, keywords become unreserved at the parsers level.
...
createToken({ name: 'JPA_DERIVED_IDENTIFIER', pattern: 'jpaDerivedIdentifier' });
...
createToken({ name: 'READ_ONLY', pattern: 'readOnly' });
...
createToken({ name: 'COMMA_WITHOUT_NEWLINE', pattern: /,[^\n\r]/ });
