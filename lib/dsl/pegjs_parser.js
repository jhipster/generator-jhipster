...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c99 = /^[A-z0-9\-]/,
      peg$c100 = peg$classExpectation([["A", "z"], ["0", "9"], "-"], false, false),
      peg$c101 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c102 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c103 = function() { return 'one-to-one'; },
      peg$c104 = function() { return 'one-to-many'; },
      peg$c105 = function() { return 'many-to-one'; },
      peg$c106 = function() { return 'many-to-many'; },
      peg$c107 = /^[A-Z]/,
      ...
      peg$c112 = function(constantName) { return { key: 'minlength', value: constantName, constant: true }; },
      peg$c113 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c114 = function(constantName) { return { key: 'maxlength', value: constantName, constant: true }; },
      peg$c115 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c116 = function(constantName) { return { key: 'minbytes', value: constantName, constant: true }; },
      peg$c117 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c118 = function(constantName) { return { key: 'maxbytes', value: constantName, constant: true }; },
      peg$c119 = function(int) { return { key: 'min', value: int };},
      peg$c120 = function(constantName) { return { key: 'min', value: constantName, constant: true };},
      peg$c121 = function(int) { return { key: 'max', value: int };},
      peg$c122 = function(constantName) { return { key: 'max', value: constantName, constant: true };},
      peg$c123 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c124 = function(notAComment) { return notAComment.join(''); },
      peg$c125 = "/*",
      ...
      peg$c132 = function(char) { return char; },
      peg$c133 = "application",
      peg$c134 = peg$literalExpectation("application", false),
      peg$c135 = "baseName",
      peg$c136 = peg$literalExpectation("baseName", false),
      peg$c137 = "packageName",
      peg$c138 = peg$literalExpectation("packageName", false),
      peg$c139 = "authenticationType",
      peg$c140 = peg$literalExpectation("authenticationType", false),
      peg$c141 = "hibernateCache",
      peg$c142 = peg$literalExpectation("hibernateCache", false),
      peg$c143 = "clusteredHttpSession",
      peg$c144 = peg$literalExpectation("clusteredHttpSession", false),
      peg$c145 = "websocket",
      peg$c146 = peg$literalExpectation("websocket", false),
      peg$c147 = "databaseType",
      peg$c148 = peg$literalExpectation("databaseType", false),
      peg$c149 = "devDatabaseType",
      peg$c150 = peg$literalExpectation("devDatabaseType", false),
      peg$c151 = "prodDatabaseType",
      peg$c152 = peg$literalExpectation("prodDatabaseType", false),
      peg$c153 = "useCompass",
      peg$c154 = peg$literalExpectation("useCompass", false),
      peg$c155 = "buildTool",
      peg$c156 = peg$literalExpectation("buildTool", false),
      peg$c157 = "searchEngine",
      peg$c158 = peg$literalExpectation("searchEngine", false),
      peg$c159 = "enableTranslation",
      peg$c160 = peg$literalExpectation("enableTranslation", false),
      peg$c161 = "applicationType",
      peg$c162 = peg$literalExpectation("applicationType", false),
      peg$c163 = "testFrameworks",
      peg$c164 = peg$literalExpectation("testFrameworks", false),
      peg$c165 = "languages",
      peg$c166 = peg$literalExpectation("languages", false),
      peg$c167 = "serverPort",
      peg$c168 = peg$literalExpectation("serverPort", false),
      peg$c169 = "enableSocialSignIn",
      peg$c170 = peg$literalExpectation("enableSocialSignIn", false),
      peg$c171 = "true",
      peg$c172 = peg$literalExpectation("true", false),
      peg$c173 = "false",
      peg$c174 = peg$literalExpectation("false", false),
      peg$c175 = "entity",
      peg$c176 = peg$literalExpectation("entity", false),
      peg$c177 = "relationship",
      peg$c178 = peg$literalExpectation("relationship", false),
      peg$c179 = "enum",
      peg$c180 = peg$literalExpectation("enum", false),
      peg$c181 = "OneToOne",
      peg$c182 = peg$literalExpectation("OneToOne", false),
      peg$c183 = "OneToMany",
      peg$c184 = peg$literalExpectation("OneToMany", false),
      peg$c185 = "ManyToOne",
      peg$c186 = peg$literalExpectation("ManyToOne", false),
      peg$c187 = "ManyToMany",
      peg$c188 = peg$literalExpectation("ManyToMany", false),
      peg$c189 = "all",
      peg$c190 = peg$literalExpectation("all", false),
      peg$c191 = "*",
      peg$c192 = peg$literalExpectation("*", false),
      peg$c193 = "for",
      peg$c194 = peg$literalExpectation("for", false),
      peg$c195 = "with",
      peg$c196 = peg$literalExpectation("with", false),
      peg$c197 = "except",
      peg$c198 = peg$literalExpectation("except", false),
      peg$c199 = "noFluentMethod",
      peg$c200 = peg$literalExpectation("noFluentMethod", false),
      peg$c201 = "dto",
      peg$c202 = peg$literalExpectation("dto", false),
      peg$c203 = "paginate",
      peg$c204 = peg$literalExpectation("paginate", false),
      peg$c205 = "service",
      peg$c206 = peg$literalExpectation("service", false),
      peg$c207 = "microservice",
      peg$c208 = peg$literalExpectation("microservice", false),
      peg$c209 = "search",
      peg$c210 = peg$literalExpectation("search", false),
      peg$c211 = "skipClient",
      peg$c212 = peg$literalExpectation("skipClient", false),
      peg$c213 = "skipServer",
      peg$c214 = peg$literalExpectation("skipServer", false),
      peg$c215 = "angularSuffix",
      peg$c216 = peg$literalExpectation("angularSuffix", false),
      peg$c217 = "minlength",
      peg$c218 = peg$literalExpectation("minlength", false),
      peg$c219 = "maxlength",
      peg$c220 = peg$literalExpectation("maxlength", false),
      peg$c221 = "minbytes",
      peg$c222 = peg$literalExpectation("minbytes", false),
      peg$c223 = "maxbytes",
      peg$c224 = peg$literalExpectation("maxbytes", false),
      peg$c225 = "max",
      peg$c226 = peg$literalExpectation("max", false),
      peg$c227 = "min",
      peg$c228 = peg$literalExpectation("min", false),
      peg$c229 = "pattern",
      peg$c230 = peg$literalExpectation("pattern", false),
      peg$c231 = /^[_]/,
      peg$c232 = peg$classExpectation(["_"], false, false),
      peg$c233 = /^[A-Z0-9]/,
      peg$c234 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c235 = /^[A-Z0-9_]/,
      peg$c236 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c237 = function(underscore, head, tail) {
          return `${underscore.join('')}${head}${tail.join('')}`;
        },
      peg$c238 = /^[A-Z_]/,
      peg$c239 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c240 = "-",
      peg$c241 = peg$literalExpectation("-", false),
      peg$c242 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c243 = /^[a-zA-Z]/,
      peg$c244 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c245 = /^[A-z0-9()]/,
      peg$c246 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c247 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
      peg$c248 = peg$classExpectation(["'", "\n", "'", "|", "'", "\t", "'", "|", "'", "\r", "'", "|", "'", " ", "'", "|", "\u2028", "|", "\u2029"], false, false),
      peg$c249 = /^['\t'|' '|\u2028|\u2029]/,
      peg$c250 = peg$classExpectation(["'", "\t", "'", "|", "'", " ", "'", "|", "\u2028", "|", "\u2029"], false, false),
      peg$c251 = /^[A-z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
      peg$c252 = peg$classExpectation([["A", "z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
      peg$c253 = function(word) { return word.join('') },
      peg$c254 = /^["|']/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c71(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
  ...
  function peg$parseCLUSTERED_HTTP_SESSION() {
    ...
    if (input.substr(peg$currPos, 20) === peg$c143) {
      s0 = peg$c143;
      peg$currPos += 20;
    } else {
      s0 = peg$FAILED;
  ...
  function peg$parseENABLE_SOCIAL_SIGN_IN() {
    ...
    if (input.substr(peg$currPos, 18) === peg$c169) {
      s0 = peg$c169;
      peg$currPos += 18;
    } else {
      s0 = peg$FAILED;
