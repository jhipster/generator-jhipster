...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c86 = "entity",
      peg$c87 = peg$literalExpectation("entity", false),
      peg$c88 = "relationship",
      peg$c89 = peg$literalExpectation("relationship", false),
      peg$c90 = "enum",
      peg$c91 = peg$literalExpectation("enum", false),
      peg$c92 = "OneToOne",
      peg$c93 = peg$literalExpectation("OneToOne", false),
      peg$c94 = "OneToMany",
      peg$c95 = peg$literalExpectation("OneToMany", false),
      peg$c96 = "ManyToOne",
      peg$c97 = peg$literalExpectation("ManyToOne", false),
      peg$c98 = "ManyToMany",
      peg$c99 = peg$literalExpectation("ManyToMany", false),
      peg$c100 = "all",
      peg$c101 = peg$literalExpectation("all", false),
      peg$c102 = "*",
      ...
      peg$c108 = "except",
      peg$c109 = peg$literalExpectation("except", false),
      peg$c110 = "noFluentMethod",
      peg$c111 = peg$literalExpectation("noFluentMethod", false),
      peg$c112 = "dto",
      peg$c113 = peg$literalExpectation("dto", false),
      peg$c114 = "paginate",
      peg$c115 = peg$literalExpectation("paginate", false),
      peg$c116 = "service",
      peg$c117 = peg$literalExpectation("service", false),
      peg$c118 = "microservice",
      peg$c119 = peg$literalExpectation("microservice", false),
      peg$c120 = "search",
      peg$c121 = peg$literalExpectation("search", false),
      peg$c122 = "skipClient",
      peg$c123 = peg$literalExpectation("skipClient", false),
      peg$c124 = "skipServer",
      peg$c125 = peg$literalExpectation("skipServer", false),
      peg$c126 = "angularSuffix",
      peg$c127 = peg$literalExpectation("angularSuffix", false),
      peg$c128 = "minlength",
      peg$c129 = peg$literalExpectation("minlength", false),
      peg$c130 = "maxlength",
      peg$c131 = peg$literalExpectation("maxlength", false),
      peg$c132 = "minbytes",
      peg$c133 = peg$literalExpectation("minbytes", false),
      peg$c134 = "maxbytes",
      peg$c135 = peg$literalExpectation("maxbytes", false),
      peg$c136 = "max",
      peg$c137 = peg$literalExpectation("max", false),
      peg$c138 = "min",
      peg$c139 = peg$literalExpectation("min", false),
      peg$c140 = "pattern",
      peg$c141 = peg$literalExpectation("pattern", false),
      peg$c142 = /^[_]/,
      peg$c143 = peg$classExpectation(["_"], false, false),
      peg$c144 = /^[A-Z0-9]/,
      peg$c145 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c146 = /^[A-Z0-9_]/,
      peg$c147 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c148 = function(underscore, head, tail) {
      ...
      peg$c153 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c154 = /^[a-zA-Z]/,
      peg$c155 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c156 = /^[A-z0-9()]/,
      peg$c157 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c158 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
      peg$c159 = peg$classExpectation(["'", "\n", "'", "|", "'", "\t", "'", "|", "'", "\r", "'", "|", "'", " ", "'", "|", "\u2028", "|", "\u2029"], false, false),
      peg$c160 = /^[A-z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
      peg$c161 = peg$classExpectation([["A", "z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
      peg$c162 = function(word) { return word.join('') },
      peg$c163 = /^["|']/,
      peg$c164 = peg$classExpectation(["\"", "|", "'"], false, false),
      peg$c165 = function(notAComment) { return notAComment.join(''); },
      peg$c166 = "/*",
