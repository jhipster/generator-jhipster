...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c43 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c44 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c45 = "(",
      ...
      peg$c51 = function(name) { return name.join(''); },
      peg$c52 = function(fdl) { return fdl; },
      peg$c53 = function() { return []; },
      peg$c54 = ",",
      peg$c55 = peg$literalExpectation(",", false),
      peg$c56 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c57 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c58 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c59 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c60 = function(rb) { return [rb]; },
      peg$c61 = "to",
      peg$c62 = peg$literalExpectation("to", false),
      peg$c63 = function(from, to) {
          return { from: from , to: to };
        },
      peg$c64 = "required",
      peg$c65 = peg$literalExpectation("required", false),
      peg$c66 = function(jd, e, i, required) {
          return { name: e, injectedfield: i, javadoc: jd, required: required ? true : false };
        },
      peg$c67 = function(jd, e) {
          return { name: e, injectedfield: null, javadoc: jd };
        },
      peg$c68 = function(e) { return { name: e, injectedfield: null, javadoc: '' }; },
      peg$c69 = function(e, el) {
          return { name: e, values: el };
        },
      peg$c70 = function(e, el) { return addUniqueElements([e], el); },
      peg$c71 = function(e) { return [e]; },
      peg$c72 = function(sub) { return sub; },
      peg$c73 = function(e, sub) { return addUniqueElements([e], sub); },
      ...
      peg$c86 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c87 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c88 = function() { return 'one-to-one'; },
      peg$c89 = function() { return 'one-to-many'; },
      peg$c90 = function() { return 'many-to-one'; },
      peg$c91 = function() { return 'many-to-many'; },
      peg$c92 = /^[A-Z]/,
      peg$c93 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c94 = function(head, tail) { return `${head}${tail.join('')}`; },
      peg$c95 = function() { return { key: 'required', value: '' }; },
      peg$c96 = function(int) { return { key: 'minlength', value: int }; },
      peg$c97 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c98 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c99 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c100 = function(int) { return { key: 'max', value: int };},
      peg$c101 = function(int) { return { key: 'min', value: int };},
      peg$c102 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c103 = function(notAComment) { return notAComment.join(''); },
      peg$c104 = "/*",
      ...
      peg$c111 = function(char) { return char; },
      peg$c112 = "application",
      peg$c113 = peg$literalExpectation("application", false),
      peg$c114 = "baseName",
      peg$c115 = peg$literalExpectation("baseName", false),
      peg$c116 = "packageName",
      peg$c117 = peg$literalExpectation("packageName", false),
      peg$c118 = "authenticationType",
      peg$c119 = peg$literalExpectation("authenticationType", false),
      peg$c120 = "hibernateCache",
      peg$c121 = peg$literalExpectation("hibernateCache", false),
      peg$c122 = "clusteredHttpSession",
      peg$c123 = peg$literalExpectation("clusteredHttpSession", false),
      peg$c124 = "websocket",
      peg$c125 = peg$literalExpectation("websocket", false),
      peg$c126 = "databaseType",
      peg$c127 = peg$literalExpectation("databaseType", false),
      peg$c128 = "devDatabaseType",
      peg$c129 = peg$literalExpectation("devDatabaseType", false),
      peg$c130 = "prodDatabaseType",
      peg$c131 = peg$literalExpectation("prodDatabaseType", false),
      peg$c132 = "useCompass",
      peg$c133 = peg$literalExpectation("useCompass", false),
      peg$c134 = "buildTool",
      peg$c135 = peg$literalExpectation("buildTool", false),
      peg$c136 = "true",
      peg$c137 = peg$literalExpectation("true", false),
      peg$c138 = "false",
      peg$c139 = peg$literalExpectation("false", false),
      peg$c140 = "entity",
      peg$c141 = peg$literalExpectation("entity", false),
      peg$c142 = "relationship",
      peg$c143 = peg$literalExpectation("relationship", false),
      peg$c144 = "enum",
      peg$c145 = peg$literalExpectation("enum", false),
      peg$c146 = "OneToOne",
      peg$c147 = peg$literalExpectation("OneToOne", false),
      peg$c148 = "OneToMany",
      peg$c149 = peg$literalExpectation("OneToMany", false),
      peg$c150 = "ManyToOne",
      peg$c151 = peg$literalExpectation("ManyToOne", false),
      peg$c152 = "ManyToMany",
      peg$c153 = peg$literalExpectation("ManyToMany", false),
      peg$c154 = "all",
      peg$c155 = peg$literalExpectation("all", false),
      peg$c156 = "*",
      ...
      peg$c162 = "except",
      peg$c163 = peg$literalExpectation("except", false),
      peg$c164 = "noFluentMethod",
      peg$c165 = peg$literalExpectation("noFluentMethod", false),
      peg$c166 = "dto",
      peg$c167 = peg$literalExpectation("dto", false),
      peg$c168 = "paginate",
      peg$c169 = peg$literalExpectation("paginate", false),
      peg$c170 = "service",
      peg$c171 = peg$literalExpectation("service", false),
      peg$c172 = "microservice",
      peg$c173 = peg$literalExpectation("microservice", false),
      peg$c174 = "search",
      peg$c175 = peg$literalExpectation("search", false),
      peg$c176 = "skipClient",
      peg$c177 = peg$literalExpectation("skipClient", false),
      peg$c178 = "skipServer",
      peg$c179 = peg$literalExpectation("skipServer", false),
      peg$c180 = "angularSuffix",
      peg$c181 = peg$literalExpectation("angularSuffix", false),
      peg$c182 = "minlength",
      peg$c183 = peg$literalExpectation("minlength", false),
      peg$c184 = "maxlength",
      peg$c185 = peg$literalExpectation("maxlength", false),
      peg$c186 = "minbytes",
      peg$c187 = peg$literalExpectation("minbytes", false),
      peg$c188 = "maxbytes",
      peg$c189 = peg$literalExpectation("maxbytes", false),
      peg$c190 = "max",
      peg$c191 = peg$literalExpectation("max", false),
      peg$c192 = "min",
      peg$c193 = peg$literalExpectation("min", false),
      peg$c194 = "pattern",
      peg$c195 = peg$literalExpectation("pattern", false),
      peg$c196 = /^[_]/,
      peg$c197 = peg$classExpectation(["_"], false, false),
      peg$c198 = /^[A-Z0-9]/,
      peg$c199 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c200 = /^[A-Z0-9_]/,
      peg$c201 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c202 = function(underscore, head, tail) {
      ...
      peg$c207 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c208 = /^[a-zA-Z]/,
      peg$c209 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c210 = /^[A-z0-9()]/,
      peg$c211 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c212 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
      ...
      peg$c218 = function(word) { return word.join('') },
      peg$c219 = /^["|']/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c56(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
  ...
  function peg$parseAUTHENTICATION_TYPE() {
    ...
    if (input.substr(peg$currPos, 18) === peg$c118) {
      s0 = peg$c118;
      peg$currPos += 18;
    } else {
      s0 = peg$FAILED;
  ...
  function peg$parseCLUSTERED_HTTP_SESSION() {
    ...
    if (input.substr(peg$currPos, 20) === peg$c122) {
      s0 = peg$c122;
      peg$currPos += 20;
    } else {
      s0 = peg$FAILED;
