...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c37 = function(packageName, applicationConfigDecl) {
      ...
      peg$c54 = function(testFrameworks, applicationConfigDecl) {
      ...
      peg$c55 = function(languages, applicationConfigDecl) {
      ...
      peg$c66 = function(clientPackageManager, applicationConfigDecl) {
          return addToApplicationDecl(applicationConfigDecl, 'clientPackageManager', clientPackageManager.join(''));
        },
      peg$c67 = function(clientFramework, applicationConfigDecl) {
          return addToApplicationDecl(applicationConfigDecl, 'clientFramework', clientFramework.join(''));
        },
      peg$c68 = function(nativeLanguage, applicationConfigDecl) {
          return addToApplicationDecl(applicationConfigDecl, 'nativeLanguage', nativeLanguage.join(''));
        },
      peg$c69 = function(frontEndBuilder, applicationConfigDecl) {
          return addToApplicationDecl(applicationConfigDecl, 'frontEndBuilder', frontEndBuilder.join(''));
        },
      peg$c70 = function(skipUserManagement, applicationConfigDecl) {
          return addToApplicationDecl(applicationConfigDecl, 'skipUserManagement', skipUserManagement.join(''));
        },
      peg$c71 = function(skipClient, applicationConfigDecl) {
          return addToApplicationDecl(applicationConfigDecl, 'skipClient', skipClient);
        },
      peg$c72 = function(skipServer, applicationConfigDecl) {
          return addToApplicationDecl(applicationConfigDecl, 'skipServer', skipServer);
        },
      peg$c73 = function(applicationConfigDecl) { return applicationConfigDecl; },
      peg$c74 = function() { return true; },
      peg$c75 = function() { return false; },
      peg$c76 = "=",
      peg$c77 = peg$literalExpectation("=", false),
      peg$c78 = function(name, value) { return { name: name, value: value }; },
      peg$c79 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c80 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c81 = "(",
      peg$c82 = peg$literalExpectation("(", false),
      peg$c83 = ")",
      peg$c84 = peg$literalExpectation(")", false),
      peg$c85 = function(name) { return name.join(''); },
      peg$c86 = function(fdl) { return fdl; },
      peg$c87 = function() { return []; },
      peg$c88 = ",",
      peg$c89 = peg$literalExpectation(",", false),
      peg$c90 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c91 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c92 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c93 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c94 = function(rb) { return [rb]; },
      peg$c95 = "to",
      peg$c96 = peg$literalExpectation("to", false),
      peg$c97 = function(from, to) {
          return { from: from , to: to };
        },
      peg$c98 = "required",
      peg$c99 = peg$literalExpectation("required", false),
      peg$c100 = function(jd, e, i, required) {
          return { name: e, injectedfield: i, javadoc: jd, required: required ? true : false };
        },
      peg$c101 = function(jd, e) {
          return { name: e, injectedfield: null, javadoc: jd };
        },
      peg$c102 = function(e) { return { name: e, injectedfield: null, javadoc: '' }; },
      peg$c103 = function(e, el) {
          return { name: e, values: el };
        },
      peg$c104 = function(e, el) { return addUniqueElements([e], el); },
      peg$c105 = function(e) { return [e]; },
      peg$c106 = function(sub) { return sub; },
      peg$c107 = function(e, sub) { return addUniqueElements([e], sub); },
      ...
      peg$c120 = /^[A-z0-9\-]/,
      peg$c121 = peg$classExpectation([["A", "z"], ["0", "9"], "-"], false, false),
      peg$c122 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c123 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c124 = function() { return 'one-to-one'; },
      peg$c125 = function() { return 'one-to-many'; },
      peg$c126 = function() { return 'many-to-one'; },
      peg$c127 = function() { return 'many-to-many'; },
      peg$c128 = /^[A-Z]/,
      peg$c129 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c130 = function(head, tail) { return `${head}${tail.join('')}`; },
      peg$c131 = function() { return { key: 'required', value: '' }; },
      peg$c132 = function(int) { return { key: 'minlength', value: int }; },
      peg$c133 = function(constantName) { return { key: 'minlength', value: constantName, constant: true }; },
      peg$c134 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c135 = function(constantName) { return { key: 'maxlength', value: constantName, constant: true }; },
      peg$c136 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c137 = function(constantName) { return { key: 'minbytes', value: constantName, constant: true }; },
      peg$c138 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c139 = function(constantName) { return { key: 'maxbytes', value: constantName, constant: true }; },
      peg$c140 = function(int) { return { key: 'min', value: int };},
      peg$c141 = function(constantName) { return { key: 'min', value: constantName, constant: true }; },
      peg$c142 = function(int) { return { key: 'max', value: int };},
      peg$c143 = function(constantName) { return { key: 'max', value: constantName, constant: true }; },
      peg$c144 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c145 = function(notAComment) { return notAComment.join(''); },
      peg$c146 = "/*",
      ...
      peg$c154 = "application",
      peg$c155 = peg$literalExpectation("application", false),
      peg$c156 = "config",
      peg$c157 = peg$literalExpectation("config", false),
      peg$c158 = "baseName",
      peg$c159 = peg$literalExpectation("baseName", false),
      ...
      peg$c216 = "entity",
      peg$c217 = peg$literalExpectation("entity", false),
      peg$c218 = "relationship",
      peg$c219 = peg$literalExpectation("relationship", false),
      peg$c220 = "enum",
      peg$c221 = peg$literalExpectation("enum", false),
      peg$c222 = "OneToOne",
      peg$c223 = peg$literalExpectation("OneToOne", false),
      peg$c224 = "OneToMany",
      peg$c225 = peg$literalExpectation("OneToMany", false),
      peg$c226 = "ManyToOne",
      peg$c227 = peg$literalExpectation("ManyToOne", false),
      peg$c228 = "ManyToMany",
      peg$c229 = peg$literalExpectation("ManyToMany", false),
      peg$c230 = "all",
      peg$c231 = peg$literalExpectation("all", false),
      peg$c232 = "*",
      peg$c233 = peg$literalExpectation("*", false),
      peg$c234 = "with",
      peg$c235 = peg$literalExpectation("with", false),
      peg$c236 = "except",
      peg$c237 = peg$literalExpectation("except", false),
      peg$c238 = "noFluentMethod",
      peg$c239 = peg$literalExpectation("noFluentMethod", false),
      peg$c240 = "dto",
      peg$c241 = peg$literalExpectation("dto", false),
      peg$c242 = "paginate",
      peg$c243 = peg$literalExpectation("paginate", false),
      peg$c244 = "service",
      peg$c245 = peg$literalExpectation("service", false),
      peg$c246 = "microservice",
      peg$c247 = peg$literalExpectation("microservice", false),
      peg$c248 = "search",
      peg$c249 = peg$literalExpectation("search", false),
      peg$c250 = "skipClient",
      peg$c251 = peg$literalExpectation("skipClient", false),
      peg$c252 = "skipServer",
      peg$c253 = peg$literalExpectation("skipServer", false),
      peg$c254 = "angularSuffix",
      peg$c255 = peg$literalExpectation("angularSuffix", false),
      peg$c256 = "filter",
      peg$c257 = peg$literalExpectation("filter", false),
      peg$c258 = "clientRootFolder",
      peg$c259 = peg$literalExpectation("clientRootFolder", false),
      peg$c260 = "minlength",
      peg$c261 = peg$literalExpectation("minlength", false),
      peg$c262 = "maxlength",
      peg$c263 = peg$literalExpectation("maxlength", false),
      peg$c264 = "minbytes",
      peg$c265 = peg$literalExpectation("minbytes", false),
      peg$c266 = "maxbytes",
      peg$c267 = peg$literalExpectation("maxbytes", false),
      peg$c268 = "max",
      peg$c269 = peg$literalExpectation("max", false),
      peg$c270 = "min",
      peg$c271 = peg$literalExpectation("min", false),
      peg$c272 = "pattern",
      peg$c273 = peg$literalExpectation("pattern", false),
      peg$c274 = /^[^\n\r\/]/,
      peg$c275 = peg$classExpectation(["\n", "\r", "/"], true, false),
      peg$c276 = function(pattern) { return pattern.join(''); },
      peg$c277 = /^[_]/,
      peg$c278 = peg$classExpectation(["_"], false, false),
      peg$c279 = /^[A-Z0-9]/,
      peg$c280 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c281 = /^[A-Z0-9_]/,
      peg$c282 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c283 = function(underscore, head, tail) {
          return `${underscore.join('')}${head}${tail.join('')}`;
        },
      peg$c284 = /^[A-Z_]/,
      peg$c285 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c286 = "-",
      peg$c287 = peg$literalExpectation("-", false),
      peg$c288 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c289 = /^[a-zA-Z]/,
      peg$c290 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c291 = /^[A-z0-9()]/,
      peg$c292 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c293 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c90(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
