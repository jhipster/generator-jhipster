...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c38 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c39 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c40 = "(",
      peg$c41 = peg$literalExpectation("(", false),
      peg$c42 = /^[A-z0-9_\-]/,
      peg$c43 = peg$classExpectation([["A", "z"], ["0", "9"], "_", "-"], false, false),
      peg$c44 = ")",
      peg$c45 = peg$literalExpectation(")", false),
      peg$c46 = function(name) { return name.join(''); },
      peg$c47 = function(fdl) { return fdl; },
      peg$c48 = function() { return []; },
      peg$c49 = ",",
      peg$c50 = peg$literalExpectation(",", false),
      peg$c51 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c52 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c53 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c54 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c55 = function(rb) { return [rb]; },
      peg$c56 = "to",
      peg$c57 = peg$literalExpectation("to", false),
      peg$c58 = function(from, to) {
          return { from: from , to: to };
        },
      peg$c59 = "required",
      peg$c60 = peg$literalExpectation("required", false),
      peg$c61 = function(jd, e, i, required) {
          return { name: e, injectedfield: i, javadoc: jd, required: required ? true : false };
        },
      peg$c62 = function(jd, e) {
          return { name: e, injectedfield: null, javadoc: jd };
        },
      peg$c63 = function(e) { return { name: e, injectedfield: null, javadoc: '' }; },
      peg$c64 = function(e, el) {
          return { name: e, values: el };
        },
      peg$c65 = function(e, el) { return addUniqueElements([e], el); },
      peg$c66 = function(e) { return [e]; },
      peg$c67 = function(sub) { return sub; },
      peg$c68 = function(e, sub) { return addUniqueElements([e], sub); },
      ...
      peg$c79 = /^[A-z0-9\-]/,
      peg$c80 = peg$classExpectation([["A", "z"], ["0", "9"], "-"], false, false),
      peg$c81 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c82 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c83 = function() { return 'one-to-one'; },
      peg$c84 = function() { return 'one-to-many'; },
      peg$c85 = function() { return 'many-to-one'; },
      peg$c86 = function() { return 'many-to-many'; },
      peg$c87 = /^[A-Z]/,
      peg$c88 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c89 = /^[A-z0-9]/,
      peg$c90 = peg$classExpectation([["A", "z"], ["0", "9"]], false, false),
      peg$c91 = function(head, tail) { return `${head}${tail.join('')}`; },
      peg$c92 = function() { return { key: 'required', value: '' }; },
      peg$c93 = function(int) { return { key: 'minlength', value: int }; },
      peg$c94 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c95 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c96 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c97 = function(int) { return { key: 'max', value: int };},
      peg$c98 = function(int) { return { key: 'min', value: int };},
      peg$c99 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c100 = function(notAComment) { return notAComment.join(''); },
      peg$c101 = "/*",
      ...
      peg$c109 = "application",
      peg$c110 = peg$literalExpectation("application", false),
      peg$c111 = "baseName",
      peg$c112 = peg$literalExpectation("baseName", false),
      peg$c113 = "packageName",
      peg$c114 = peg$literalExpectation("packageName", false),
      peg$c115 = "authenticationType",
      peg$c116 = peg$literalExpectation("authenticationType", false),
      peg$c117 = "hibernateCache",
      peg$c118 = peg$literalExpectation("hibernateCache", false),
      peg$c119 = "clusteredHttpSession",
      peg$c120 = peg$literalExpectation("clusteredHttpSession", false),
      peg$c121 = "websocket",
      peg$c122 = peg$literalExpectation("websocket", false),
      peg$c123 = "entity",
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c51(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
  ...
  function peg$parseAUTHENTICATION_TYPE() {
    ...
    if (input.substr(peg$currPos, 18) === peg$c115) {
      s0 = peg$c115;
      peg$currPos += 18;
    } else {
      s0 = peg$FAILED;
