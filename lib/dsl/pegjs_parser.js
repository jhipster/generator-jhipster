...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c16 = function(clientRootFolder, p) {
      ...
      peg$c21 = function(name, value) { return { name: name, value: value }; },
      peg$c22 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c23 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c24 = "(",
      ...
      peg$c30 = function(name) { return name.join(''); },
      peg$c31 = "{",
      peg$c32 = peg$literalExpectation("{", false),
      peg$c33 = "}",
      peg$c34 = peg$literalExpectation("}", false),
      peg$c35 = function(fdl) { return fdl; },
      peg$c36 = function() { return []; },
      peg$c37 = ",",
      peg$c38 = peg$literalExpectation(",", false),
      peg$c39 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c40 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c41 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c42 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c43 = function(rb) { return [rb]; },
      peg$c44 = "to",
      ...
      peg$c69 = /^[A-z0-9\-]/,
      peg$c70 = peg$classExpectation([["A", "z"], ["0", "9"], "-"], false, false),
      peg$c71 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c72 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c73 = function() { return 'one-to-one'; },
      peg$c74 = function() { return 'one-to-many'; },
      peg$c75 = function() { return 'many-to-one'; },
      peg$c76 = function() { return 'many-to-many'; },
      peg$c77 = /^[A-Z]/,
      ...
      peg$c83 = function(int) { return { key: 'minlength', value: int }; },
      peg$c84 = function(constantName) { return { key: 'minlength', value: constantName, constant: true }; },
      peg$c85 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c86 = function(constantName) { return { key: 'maxlength', value: constantName, constant: true }; },
      peg$c87 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c88 = function(constantName) { return { key: 'minbytes', value: constantName, constant: true }; },
      peg$c89 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c90 = function(constantName) { return { key: 'maxbytes', value: constantName, constant: true }; },
      peg$c91 = function(int) { return { key: 'min', value: int };},
      peg$c92 = function(constantName) { return { key: 'min', value: constantName, constant: true }; },
      peg$c93 = function(int) { return { key: 'max', value: int };},
      peg$c94 = function(constantName) { return { key: 'max', value: constantName, constant: true }; },
      peg$c95 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c96 = function(notAComment) { return notAComment.join(''); },
      peg$c97 = "/*",
      ...
      peg$c104 = function(char) { return char; },
      peg$c105 = "entity",
      peg$c106 = peg$literalExpectation("entity", false),
      peg$c107 = "relationship",
      peg$c108 = peg$literalExpectation("relationship", false),
      peg$c109 = "enum",
      peg$c110 = peg$literalExpectation("enum", false),
      peg$c111 = "OneToOne",
      peg$c112 = peg$literalExpectation("OneToOne", false),
      peg$c113 = "OneToMany",
      peg$c114 = peg$literalExpectation("OneToMany", false),
      peg$c115 = "ManyToOne",
      peg$c116 = peg$literalExpectation("ManyToOne", false),
      peg$c117 = "ManyToMany",
      peg$c118 = peg$literalExpectation("ManyToMany", false),
      peg$c119 = "all",
      peg$c120 = peg$literalExpectation("all", false),
      peg$c121 = "*",
      ...
      peg$c147 = "clientRootFolder",
      peg$c148 = peg$literalExpectation("clientRootFolder", false),
      peg$c149 = "minlength",
      peg$c150 = peg$literalExpectation("minlength", false),
      peg$c151 = "maxlength",
      peg$c152 = peg$literalExpectation("maxlength", false),
      peg$c153 = "minbytes",
      peg$c154 = peg$literalExpectation("minbytes", false),
      peg$c155 = "maxbytes",
      peg$c156 = peg$literalExpectation("maxbytes", false),
      peg$c157 = "max",
      peg$c158 = peg$literalExpectation("max", false),
      peg$c159 = "min",
      peg$c160 = peg$literalExpectation("min", false),
      peg$c161 = "pattern",
      peg$c162 = peg$literalExpectation("pattern", false),
      peg$c163 = /^[^\n\r\/]/,
      peg$c164 = peg$classExpectation(["\n", "\r", "/"], true, false),
      peg$c165 = function(pattern) { return pattern.join(''); },
      peg$c166 = /^[_]/,
      peg$c167 = peg$classExpectation(["_"], false, false),
      peg$c168 = /^[A-Z0-9]/,
      peg$c169 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c170 = /^[A-Z0-9_]/,
      peg$c171 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c172 = function(underscore, head, tail) {
          return `${underscore.join('')}${head}${tail.join('')}`;
        },
      peg$c173 = /^[A-Z_]/,
      peg$c174 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c175 = "-",
      peg$c176 = peg$literalExpectation("-", false),
      peg$c177 = /^[0-9]/,
      peg$c178 = peg$classExpectation([["0", "9"]], false, false),
      peg$c179 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c180 = /^[a-zA-Z]/,
      peg$c181 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c182 = /^[A-z0-9()]/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c39(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
