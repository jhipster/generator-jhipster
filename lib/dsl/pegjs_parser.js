...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c66 = function(name, value) { return { name: name, value: value }; },
      peg$c67 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c68 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c69 = "(",
      peg$c70 = peg$literalExpectation("(", false),
      peg$c71 = ")",
      peg$c72 = peg$literalExpectation(")", false),
      peg$c73 = function(name) { return name.join(''); },
      peg$c74 = function(fdl) { return fdl; },
      peg$c75 = function() { return []; },
      peg$c76 = ",",
      peg$c77 = peg$literalExpectation(",", false),
      peg$c78 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c79 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c80 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c81 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c82 = function(rb) { return [rb]; },
      peg$c83 = "to",
      peg$c84 = peg$literalExpectation("to", false),
      peg$c85 = function(from, to) {
          return { from: from , to: to };
        },
      peg$c86 = "required",
      peg$c87 = peg$literalExpectation("required", false),
      peg$c88 = function(jd, e, i, required) {
          return { name: e, injectedfield: i, javadoc: jd, required: required ? true : false };
        },
      peg$c89 = function(jd, e) {
          return { name: e, injectedfield: null, javadoc: jd };
        },
      peg$c90 = function(e) { return { name: e, injectedfield: null, javadoc: '' }; },
      peg$c91 = function(e, el) {
          return { name: e, values: el };
        },
      peg$c92 = function(e, el) { return addUniqueElements([e], el); },
      peg$c93 = function(e) { return [e]; },
      peg$c94 = function(sub) { return sub; },
      peg$c95 = function(e, sub) { return addUniqueElements([e], sub); },
      peg$c96 = function(decl, ex) {
      ...
      peg$c106 = /^[A-z0-9\-]/,
      peg$c107 = peg$classExpectation([["A", "z"], ["0", "9"], "-"], false, false),
      peg$c108 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c109 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c110 = function() { return 'one-to-one'; },
      peg$c111 = function() { return 'one-to-many'; },
      peg$c112 = function() { return 'many-to-one'; },
      peg$c113 = function() { return 'many-to-many'; },
      peg$c114 = /^[A-Z]/,
      ...
      peg$c119 = function(constantName) { return { key: 'minlength', value: constantName, constant: true }; },
      peg$c120 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c121 = function(constantName) { return { key: 'maxlength', value: constantName, constant: true }; },
      peg$c122 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c123 = function(constantName) { return { key: 'minbytes', value: constantName, constant: true }; },
      peg$c124 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c125 = function(constantName) { return { key: 'maxbytes', value: constantName, constant: true }; },
      peg$c126 = function(int) { return { key: 'min', value: int };},
      peg$c127 = function(constantName) { return { key: 'min', value: constantName, constant: true };},
      peg$c128 = function(int) { return { key: 'max', value: int };},
      peg$c129 = function(constantName) { return { key: 'max', value: constantName, constant: true };},
      peg$c130 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c131 = function(notAComment) { return notAComment.join(''); },
      peg$c132 = "/*",
      ...
      peg$c139 = function(char) { return char; },
      peg$c140 = "application",
      peg$c141 = peg$literalExpectation("application", false),
      peg$c142 = "baseName",
      peg$c143 = peg$literalExpectation("baseName", false),
      peg$c144 = "packageName",
      peg$c145 = peg$literalExpectation("packageName", false),
      peg$c146 = "authenticationType",
      peg$c147 = peg$literalExpectation("authenticationType", false),
      peg$c148 = "hibernateCache",
      peg$c149 = peg$literalExpectation("hibernateCache", false),
      peg$c150 = "clusteredHttpSession",
      peg$c151 = peg$literalExpectation("clusteredHttpSession", false),
      peg$c152 = "websocket",
      peg$c153 = peg$literalExpectation("websocket", false),
      peg$c154 = "databaseType",
      peg$c155 = peg$literalExpectation("databaseType", false),
      peg$c156 = "devDatabaseType",
      peg$c157 = peg$literalExpectation("devDatabaseType", false),
      peg$c158 = "prodDatabaseType",
      peg$c159 = peg$literalExpectation("prodDatabaseType", false),
      peg$c160 = "useCompass",
      peg$c161 = peg$literalExpectation("useCompass", false),
      peg$c162 = "buildTool",
      peg$c163 = peg$literalExpectation("buildTool", false),
      peg$c164 = "searchEngine",
      peg$c165 = peg$literalExpectation("searchEngine", false),
      peg$c166 = "enableTranslation",
      peg$c167 = peg$literalExpectation("enableTranslation", false),
      peg$c168 = "applicationType",
      peg$c169 = peg$literalExpectation("applicationType", false),
      peg$c170 = "testFrameworks",
      peg$c171 = peg$literalExpectation("testFrameworks", false),
      peg$c172 = "languages",
      peg$c173 = peg$literalExpectation("languages", false),
      peg$c174 = "serverPort",
      peg$c175 = peg$literalExpectation("serverPort", false),
      peg$c176 = "enableSocialSignIn",
      peg$c177 = peg$literalExpectation("enableSocialSignIn", false),
      peg$c178 = "useSass",
      peg$c179 = peg$literalExpectation("useSass", false),
      peg$c180 = "jhiPrefix",
      peg$c181 = peg$literalExpectation("jhiPrefix", false),
      peg$c182 = "messageBroker",
      peg$c183 = peg$literalExpectation("messageBroker", false),
      peg$c184 = "serviceDiscoveryType",
      peg$c185 = peg$literalExpectation("serviceDiscoveryType", false),
      peg$c186 = "clientPackageManager",
      peg$c187 = peg$literalExpectation("clientPackageManager", false),
      peg$c188 = "clientFramework",
      peg$c189 = peg$literalExpectation("clientFramework", false),
      peg$c190 = "nativeLanguage",
      peg$c191 = peg$literalExpectation("nativeLanguage", false),
      peg$c192 = "true",
      peg$c193 = peg$literalExpectation("true", false),
      peg$c194 = "false",
      peg$c195 = peg$literalExpectation("false", false),
      peg$c196 = "entity",
      peg$c197 = peg$literalExpectation("entity", false),
      peg$c198 = "relationship",
      peg$c199 = peg$literalExpectation("relationship", false),
      peg$c200 = "enum",
      peg$c201 = peg$literalExpectation("enum", false),
      peg$c202 = "OneToOne",
      peg$c203 = peg$literalExpectation("OneToOne", false),
      peg$c204 = "OneToMany",
      peg$c205 = peg$literalExpectation("OneToMany", false),
      peg$c206 = "ManyToOne",
      peg$c207 = peg$literalExpectation("ManyToOne", false),
      peg$c208 = "ManyToMany",
      peg$c209 = peg$literalExpectation("ManyToMany", false),
      peg$c210 = "all",
      peg$c211 = peg$literalExpectation("all", false),
      peg$c212 = "*",
      ...
      peg$c218 = "except",
      peg$c219 = peg$literalExpectation("except", false),
      peg$c220 = "noFluentMethod",
      peg$c221 = peg$literalExpectation("noFluentMethod", false),
      peg$c222 = "dto",
      peg$c223 = peg$literalExpectation("dto", false),
      peg$c224 = "paginate",
      peg$c225 = peg$literalExpectation("paginate", false),
      peg$c226 = "service",
      peg$c227 = peg$literalExpectation("service", false),
      peg$c228 = "microservice",
      peg$c229 = peg$literalExpectation("microservice", false),
      peg$c230 = "search",
      peg$c231 = peg$literalExpectation("search", false),
      peg$c232 = "skipClient",
      peg$c233 = peg$literalExpectation("skipClient", false),
      peg$c234 = "skipServer",
      peg$c235 = peg$literalExpectation("skipServer", false),
      peg$c236 = "angularSuffix",
      peg$c237 = peg$literalExpectation("angularSuffix", false),
      peg$c238 = "minlength",
      peg$c239 = peg$literalExpectation("minlength", false),
      peg$c240 = "maxlength",
      peg$c241 = peg$literalExpectation("maxlength", false),
      peg$c242 = "minbytes",
      peg$c243 = peg$literalExpectation("minbytes", false),
      peg$c244 = "maxbytes",
      peg$c245 = peg$literalExpectation("maxbytes", false),
      peg$c246 = "max",
      peg$c247 = peg$literalExpectation("max", false),
      peg$c248 = "min",
      peg$c249 = peg$literalExpectation("min", false),
      peg$c250 = "pattern",
      peg$c251 = peg$literalExpectation("pattern", false),
      peg$c252 = /^[_]/,
      peg$c253 = peg$classExpectation(["_"], false, false),
      peg$c254 = /^[A-Z0-9]/,
      peg$c255 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c256 = /^[A-Z0-9_]/,
      peg$c257 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c258 = function(underscore, head, tail) {
          return `${underscore.join('')}${head}${tail.join('')}`;
        },
      peg$c259 = /^[A-Z_]/,
      peg$c260 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c261 = "-",
      peg$c262 = peg$literalExpectation("-", false),
      peg$c263 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c264 = /^[a-zA-Z]/,
      peg$c265 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c266 = /^[A-z0-9()]/,
      peg$c267 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c268 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
      peg$c269 = peg$classExpectation(["'", "\n", "'", "|", "'", "\t", "'", "|", "'", "\r", "'", "|", "'", " ", "'", "|", "\u2028", "|", "\u2029"], false, false),
      peg$c270 = /^['\t'|' '|\u2028|\u2029]/,
      peg$c271 = peg$classExpectation(["'", "\t", "'", "|", "'", " ", "'", "|", "\u2028", "|", "\u2029"], false, false),
      peg$c272 = /^[A-z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
      peg$c273 = peg$classExpectation([["A", "z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
      peg$c274 = function(word) { return word.join('') },
      peg$c275 = /^["|']/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c78(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
  ...
  function peg$parseCLIENT_PACKAGE_MANAGER() {
    ...
    if (input.substr(peg$currPos, 20) === peg$c186) {
      s0 = peg$c186;
      peg$currPos += 20;
    } else {
      s0 = peg$FAILED;
