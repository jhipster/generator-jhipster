...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c62 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c63 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c64 = "(",
      peg$c65 = peg$literalExpectation("(", false),
      peg$c66 = ")",
      peg$c67 = peg$literalExpectation(")", false),
      peg$c68 = function(name) { return name.join(''); },
      peg$c69 = function(fdl) { return fdl; },
      peg$c70 = function() { return []; },
      peg$c71 = ",",
      peg$c72 = peg$literalExpectation(",", false),
      peg$c73 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c74 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c75 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c76 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c77 = function(rb) { return [rb]; },
      peg$c78 = "to",
      peg$c79 = peg$literalExpectation("to", false),
      peg$c80 = function(from, to) {
          return { from: from , to: to };
        },
      peg$c81 = "required",
      peg$c82 = peg$literalExpectation("required", false),
      peg$c83 = function(jd, e, i, required) {
          return { name: e, injectedfield: i, javadoc: jd, required: required ? true : false };
        },
      peg$c84 = function(jd, e) {
          return { name: e, injectedfield: null, javadoc: jd };
        },
      peg$c85 = function(e) { return { name: e, injectedfield: null, javadoc: '' }; },
      peg$c86 = function(e, el) {
          return { name: e, values: el };
        },
      peg$c87 = function(e, el) { return addUniqueElements([e], el); },
      peg$c88 = function(e) { return [e]; },
      peg$c89 = function(sub) { return sub; },
      peg$c90 = function(e, sub) { return addUniqueElements([e], sub); },
      ...
      peg$c103 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c104 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c105 = function() { return 'one-to-one'; },
      peg$c106 = function() { return 'one-to-many'; },
      ...
      peg$c114 = function(constantName) { return { key: 'minlength', value: constantName, constant: true }; },
      peg$c115 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c116 = function(constantName) { return { key: 'maxlength', value: constantName, constant: true }; },
      peg$c117 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c118 = function(constantName) { return { key: 'minbytes', value: constantName, constant: true }; },
      peg$c119 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c120 = function(constantName) { return { key: 'maxbytes', value: constantName, constant: true }; },
      peg$c121 = function(int) { return { key: 'min', value: int };},
      peg$c122 = function(constantName) { return { key: 'min', value: constantName, constant: true };},
      peg$c123 = function(int) { return { key: 'max', value: int };},
      peg$c124 = function(constantName) { return { key: 'max', value: constantName, constant: true };},
      peg$c125 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c126 = function(notAComment) { return notAComment.join(''); },
      peg$c127 = "/*",
      ...
      peg$c134 = function(char) { return char; },
      peg$c135 = "application",
      peg$c136 = peg$literalExpectation("application", false),
      peg$c137 = "baseName",
      peg$c138 = peg$literalExpectation("baseName", false),
      peg$c139 = "packageName",
      peg$c140 = peg$literalExpectation("packageName", false),
      peg$c141 = "authenticationType",
      peg$c142 = peg$literalExpectation("authenticationType", false),
      peg$c143 = "hibernateCache",
      peg$c144 = peg$literalExpectation("hibernateCache", false),
      peg$c145 = "clusteredHttpSession",
      peg$c146 = peg$literalExpectation("clusteredHttpSession", false),
      peg$c147 = "websocket",
      peg$c148 = peg$literalExpectation("websocket", false),
      peg$c149 = "databaseType",
      peg$c150 = peg$literalExpectation("databaseType", false),
      peg$c151 = "devDatabaseType",
      peg$c152 = peg$literalExpectation("devDatabaseType", false),
      peg$c153 = "prodDatabaseType",
      peg$c154 = peg$literalExpectation("prodDatabaseType", false),
      peg$c155 = "useCompass",
      peg$c156 = peg$literalExpectation("useCompass", false),
      peg$c157 = "buildTool",
      peg$c158 = peg$literalExpectation("buildTool", false),
      peg$c159 = "searchEngine",
      peg$c160 = peg$literalExpectation("searchEngine", false),
      peg$c161 = "enableTranslation",
      peg$c162 = peg$literalExpectation("enableTranslation", false),
      peg$c163 = "applicationType",
      peg$c164 = peg$literalExpectation("applicationType", false),
      peg$c165 = "testFrameworks",
      peg$c166 = peg$literalExpectation("testFrameworks", false),
      peg$c167 = "languages",
      peg$c168 = peg$literalExpectation("languages", false),
      peg$c169 = "serverPort",
      peg$c170 = peg$literalExpectation("serverPort", false),
      peg$c171 = "enableSocialSignIn",
      peg$c172 = peg$literalExpectation("enableSocialSignIn", false),
      peg$c173 = "useSass",
      peg$c174 = peg$literalExpectation("useSass", false),
      peg$c175 = "jhiPrefix",
      peg$c176 = peg$literalExpectation("jhiPrefix", false),
      peg$c177 = "true",
      peg$c178 = peg$literalExpectation("true", false),
      peg$c179 = "false",
      peg$c180 = peg$literalExpectation("false", false),
      peg$c181 = "entity",
      peg$c182 = peg$literalExpectation("entity", false),
      peg$c183 = "relationship",
      peg$c184 = peg$literalExpectation("relationship", false),
      peg$c185 = "enum",
      peg$c186 = peg$literalExpectation("enum", false),
      peg$c187 = "OneToOne",
      peg$c188 = peg$literalExpectation("OneToOne", false),
      peg$c189 = "OneToMany",
      peg$c190 = peg$literalExpectation("OneToMany", false),
      peg$c191 = "ManyToOne",
      peg$c192 = peg$literalExpectation("ManyToOne", false),
      peg$c193 = "ManyToMany",
      peg$c194 = peg$literalExpectation("ManyToMany", false),
      peg$c195 = "all",
      peg$c196 = peg$literalExpectation("all", false),
      peg$c197 = "*",
      peg$c198 = peg$literalExpectation("*", false),
      peg$c199 = "for",
      peg$c200 = peg$literalExpectation("for", false),
      peg$c201 = "with",
      peg$c202 = peg$literalExpectation("with", false),
      peg$c203 = "except",
      peg$c204 = peg$literalExpectation("except", false),
      peg$c205 = "noFluentMethod",
      peg$c206 = peg$literalExpectation("noFluentMethod", false),
      peg$c207 = "dto",
      peg$c208 = peg$literalExpectation("dto", false),
      peg$c209 = "paginate",
      peg$c210 = peg$literalExpectation("paginate", false),
      peg$c211 = "service",
      peg$c212 = peg$literalExpectation("service", false),
      peg$c213 = "microservice",
      peg$c214 = peg$literalExpectation("microservice", false),
      peg$c215 = "search",
      peg$c216 = peg$literalExpectation("search", false),
      peg$c217 = "skipClient",
      peg$c218 = peg$literalExpectation("skipClient", false),
      peg$c219 = "skipServer",
      peg$c220 = peg$literalExpectation("skipServer", false),
      peg$c221 = "angularSuffix",
      peg$c222 = peg$literalExpectation("angularSuffix", false),
      peg$c223 = "minlength",
      peg$c224 = peg$literalExpectation("minlength", false),
      peg$c225 = "maxlength",
      peg$c226 = peg$literalExpectation("maxlength", false),
      peg$c227 = "minbytes",
      peg$c228 = peg$literalExpectation("minbytes", false),
      peg$c229 = "maxbytes",
      peg$c230 = peg$literalExpectation("maxbytes", false),
      peg$c231 = "max",
      peg$c232 = peg$literalExpectation("max", false),
      peg$c233 = "min",
      peg$c234 = peg$literalExpectation("min", false),
      peg$c235 = "pattern",
      peg$c236 = peg$literalExpectation("pattern", false),
      peg$c237 = /^[_]/,
      peg$c238 = peg$classExpectation(["_"], false, false),
      peg$c239 = /^[A-Z0-9]/,
      peg$c240 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c241 = /^[A-Z0-9_]/,
      peg$c242 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c243 = function(underscore, head, tail) {
          return `${underscore.join('')}${head}${tail.join('')}`;
        },
      peg$c244 = /^[A-Z_]/,
      peg$c245 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c246 = "-",
      peg$c247 = peg$literalExpectation("-", false),
      peg$c248 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c249 = /^[a-zA-Z]/,
      peg$c250 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c251 = /^[A-z0-9()]/,
      ...
      peg$c257 = /^[A-z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
      peg$c258 = peg$classExpectation([["A", "z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
      peg$c259 = function(word) { return word.join('') },
      peg$c260 = /^["|']/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c73(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
  ...
  function peg$parseENABLE_SOCIAL_SIGN_IN() {
    ...
    if (input.substr(peg$currPos, 18) === peg$c171) {
      s0 = peg$c171;
      peg$currPos += 18;
    } else {
      s0 = peg$FAILED;
