...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c268 = function(pattern) { return pattern.join(''); },
      peg$c269 = /^[_]/,
      peg$c270 = peg$classExpectation(["_"], false, false),
      peg$c271 = /^[A-Z0-9]/,
      peg$c272 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c273 = /^[A-Z0-9_]/,
      peg$c274 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c275 = function(underscore, head, tail) {
          return `${underscore.join('')}${head}${tail.join('')}`;
        },
      peg$c276 = /^[A-Z_]/,
      peg$c277 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c278 = "-",
      peg$c279 = peg$literalExpectation("-", false),
      peg$c280 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c281 = /^[a-zA-Z]/,
      peg$c282 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c283 = /^[A-z0-9()]/,
      peg$c284 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c285 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
