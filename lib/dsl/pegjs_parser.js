...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c44 = function(enableHibernateCache, applicationConfigDecl) {
      ...
      peg$c66 = function(useSass, applicationConfigDecl) {
          return addToApplicationDecl(applicationConfigDecl, 'useSass', useSass);
        },
      peg$c67 = /^[A-z0-9_\-]/,
      peg$c68 = peg$classExpectation([["A", "z"], ["0", "9"], "_", "-"], false, false),
      peg$c69 = function(jhiPrefixStart, jhiPrefixEnd, applicationConfigDecl) {
          return addToApplicationDecl(applicationConfigDecl, 'jhiPrefix', `${jhiPrefixStart}${jhiPrefixEnd.join('')}`);
        },
      peg$c70 = function(messageBroker, applicationConfigDecl) {
          return addToApplicationDecl(applicationConfigDecl, 'messageBroker', messageBroker);
        },
      peg$c71 = function(serviceDiscoveryType, applicationConfigDecl) {
      ...
      peg$c86 = function(name, value) { return { name: name, value: value }; },
      peg$c87 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c88 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c89 = "(",
      peg$c90 = peg$literalExpectation("(", false),
      peg$c91 = ")",
      peg$c92 = peg$literalExpectation(")", false),
      peg$c93 = function(start, end) { return `${start}${end.join('')}`; },
      peg$c94 = function(fdl) { return fdl; },
      peg$c95 = function() { return []; },
      peg$c96 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c97 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c98 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c99 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c100 = function(rb) { return [rb]; },
      peg$c101 = "to",
      peg$c102 = peg$literalExpectation("to", false),
      peg$c103 = function(from, to) {
          return { from: from , to: to };
        },
      peg$c104 = "required",
      peg$c105 = peg$literalExpectation("required", false),
      peg$c106 = function(jd, e, i, required) {
          return { name: e, injectedfield: i, javadoc: jd, required: required ? true : false };
        },
      peg$c107 = function(jd, e) {
          return { name: e, injectedfield: null, javadoc: jd };
        },
      peg$c108 = function(e) { return { name: e, injectedfield: null, javadoc: '' }; },
      peg$c109 = function(e, el) {
          return { name: e, values: el };
        },
      peg$c110 = function(e, el) { return addUniqueElements([e], el); },
      peg$c111 = function(e) { return [e]; },
      peg$c112 = function(sub) { return sub; },
      peg$c113 = function(e, sub) { return addUniqueElements([e], sub); },
      ...
      peg$c126 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c127 = /^[A-z0-9\-]/,
      peg$c128 = peg$classExpectation([["A", "z"], ["0", "9"], "-"], false, false),
      peg$c129 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c130 = function(methodStart, methodEnd) { return `${methodStart}${methodEnd.join('')}`; },
      peg$c131 = function() { return 'one-to-one'; },
      peg$c132 = function() { return 'one-to-many'; },
      peg$c133 = function() { return 'many-to-one'; },
      peg$c134 = function() { return 'many-to-many'; },
      peg$c135 = /^[A-Z]/,
      peg$c136 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c137 = /^[A-z0-9]/,
      peg$c138 = peg$classExpectation([["A", "z"], ["0", "9"]], false, false),
      ...
      peg$c175 = "enableHibernateCache",
      peg$c176 = peg$literalExpectation("enableHibernateCache", false),
      ...
      peg$c203 = "useSass",
      peg$c204 = peg$literalExpectation("useSass", false),
      peg$c205 = "jhiPrefix",
      peg$c206 = peg$literalExpectation("jhiPrefix", false),
      peg$c207 = "messageBroker",
      peg$c208 = peg$literalExpectation("messageBroker", false),
      peg$c209 = "serviceDiscoveryType",
      peg$c210 = peg$literalExpectation("serviceDiscoveryType", false),
      peg$c211 = "clientPackageManager",
      peg$c212 = peg$literalExpectation("clientPackageManager", false),
      peg$c213 = "clientFramework",
      peg$c214 = peg$literalExpectation("clientFramework", false),
      peg$c215 = "nativeLanguage",
      peg$c216 = peg$literalExpectation("nativeLanguage", false),
      peg$c217 = "frontendBuilder",
      peg$c218 = peg$literalExpectation("frontendBuilder", false),
      peg$c219 = "skipUserManagement",
      peg$c220 = peg$literalExpectation("skipUserManagement", false),
      peg$c221 = "true",
      peg$c222 = peg$literalExpectation("true", false),
      peg$c223 = "false",
      peg$c224 = peg$literalExpectation("false", false),
      peg$c225 = "entity",
      peg$c226 = peg$literalExpectation("entity", false),
      peg$c227 = "relationship",
      peg$c228 = peg$literalExpectation("relationship", false),
      peg$c229 = "enum",
      peg$c230 = peg$literalExpectation("enum", false),
      peg$c231 = "OneToOne",
      peg$c232 = peg$literalExpectation("OneToOne", false),
      peg$c233 = "OneToMany",
      peg$c234 = peg$literalExpectation("OneToMany", false),
      peg$c235 = "ManyToOne",
      peg$c236 = peg$literalExpectation("ManyToOne", false),
      peg$c237 = "ManyToMany",
      peg$c238 = peg$literalExpectation("ManyToMany", false),
      peg$c239 = "all",
      peg$c240 = peg$literalExpectation("all", false),
      peg$c241 = "*",
      peg$c242 = peg$literalExpectation("*", false),
      peg$c243 = "with",
      peg$c244 = peg$literalExpectation("with", false),
      peg$c245 = "except",
      peg$c246 = peg$literalExpectation("except", false),
      peg$c247 = "noFluentMethod",
      peg$c248 = peg$literalExpectation("noFluentMethod", false),
      peg$c249 = "dto",
      peg$c250 = peg$literalExpectation("dto", false),
      peg$c251 = "paginate",
      peg$c252 = peg$literalExpectation("paginate", false),
      peg$c253 = "service",
      peg$c254 = peg$literalExpectation("service", false),
      peg$c255 = "microservice",
      peg$c256 = peg$literalExpectation("microservice", false),
      peg$c257 = "search",
      peg$c258 = peg$literalExpectation("search", false),
      peg$c259 = "skipClient",
      peg$c260 = peg$literalExpectation("skipClient", false),
      peg$c261 = "skipServer",
      peg$c262 = peg$literalExpectation("skipServer", false),
      peg$c263 = "angularSuffix",
      peg$c264 = peg$literalExpectation("angularSuffix", false),
      peg$c265 = "filter",
      peg$c266 = peg$literalExpectation("filter", false),
      peg$c267 = "clientRootFolder",
      peg$c268 = peg$literalExpectation("clientRootFolder", false),
      peg$c269 = "minlength",
      peg$c270 = peg$literalExpectation("minlength", false),
      peg$c271 = "maxlength",
      peg$c272 = peg$literalExpectation("maxlength", false),
      peg$c273 = "minbytes",
      peg$c274 = peg$literalExpectation("minbytes", false),
      peg$c275 = "maxbytes",
      peg$c276 = peg$literalExpectation("maxbytes", false),
      peg$c277 = "max",
      peg$c278 = peg$literalExpectation("max", false),
      peg$c279 = "min",
      peg$c280 = peg$literalExpectation("min", false),
      peg$c281 = "pattern",
      peg$c282 = peg$literalExpectation("pattern", false),
      peg$c283 = /^[^\n\r\/]/,
      peg$c284 = peg$classExpectation(["\n", "\r", "/"], true, false),
      peg$c285 = function(pattern) { return pattern.join(''); },
      peg$c286 = /^[A-z_]/,
      peg$c287 = peg$classExpectation([["A", "z"], "_"], false, false),
      peg$c288 = /^[A-z0-9_]/,
      peg$c289 = peg$classExpectation([["A", "z"], ["0", "9"], "_"], false, false),
      peg$c290 = function(head, tail) {
          return `${head}${tail.join('')}`;
        },
      peg$c291 = /^[A-Z_]/,
      peg$c292 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c293 = function(name) { return name.join(''); },
      peg$c294 = "-",
      peg$c295 = peg$literalExpectation("-", false),
      peg$c296 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c297 = /^[a-zA-Z]/,
      peg$c298 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c299 = /^[A-z0-9()]/,
      peg$c300 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c301 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c96(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
  ...
  function peg$parseENABLE_HIBERNATE_CACHE() {
    ...
    if (input.substr(peg$currPos, 20) === peg$c175) {
      s0 = peg$c175;
      peg$currPos += 20;
    } else {
      s0 = peg$FAILED;
  ...
  function peg$parseSKIP_USER_MANAGEMENT() {
    ...
    if (input.substr(peg$currPos, 18) === peg$c219) {
      s0 = peg$c219;
      peg$currPos += 18;
    } else {
      s0 = peg$FAILED;
  ...
  function peg$parseCLIENT_ROOT_FOLDER() {
    ...
    if (input.substr(peg$currPos, 16) === peg$c267) {
      s0 = peg$c267;
      peg$currPos += 16;
    } else {
      s0 = peg$FAILED;
