...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c92 = "entity",
      peg$c93 = peg$literalExpectation("entity", false),
      peg$c94 = "relationship",
      peg$c95 = peg$literalExpectation("relationship", false),
      peg$c96 = "enum",
      ...
      peg$c102 = "ManyToOne",
      peg$c103 = peg$literalExpectation("ManyToOne", false),
      peg$c104 = "ManyToMany",
      peg$c105 = peg$literalExpectation("ManyToMany", false),
      peg$c106 = "all",
      ...
      peg$c116 = "noFluentMethod",
      peg$c117 = peg$literalExpectation("noFluentMethod", false),
      peg$c118 = "dto",
      peg$c119 = peg$literalExpectation("dto", false),
      peg$c120 = "paginate",
      peg$c121 = peg$literalExpectation("paginate", false),
      peg$c122 = "service",
      peg$c123 = peg$literalExpectation("service", false),
      peg$c124 = "microservice",
      peg$c125 = peg$literalExpectation("microservice", false),
      peg$c126 = "search",
      peg$c127 = peg$literalExpectation("search", false),
      peg$c128 = "skipClient",
      peg$c129 = peg$literalExpectation("skipClient", false),
      peg$c130 = "skipServer",
      peg$c131 = peg$literalExpectation("skipServer", false),
      peg$c132 = "angularSuffix",
      peg$c133 = peg$literalExpectation("angularSuffix", false),
      peg$c134 = "minlength",
      peg$c135 = peg$literalExpectation("minlength", false),
      peg$c136 = "maxlength",
      peg$c137 = peg$literalExpectation("maxlength", false),
      peg$c138 = "minbytes",
      peg$c139 = peg$literalExpectation("minbytes", false),
      peg$c140 = "maxbytes",
      peg$c141 = peg$literalExpectation("maxbytes", false),
      peg$c142 = "max",
      peg$c143 = peg$literalExpectation("max", false),
      peg$c144 = "min",
      peg$c145 = peg$literalExpectation("min", false),
      peg$c146 = "pattern",
      peg$c147 = peg$literalExpectation("pattern", false),
      peg$c148 = /^[_]/,
      peg$c149 = peg$classExpectation(["_"], false, false),
      peg$c150 = /^[A-Z0-9]/,
      peg$c151 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c152 = /^[A-Z0-9_]/,
      peg$c153 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c154 = function(underscore, head, tail) {
      ...
      peg$c166 = /^[A-z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
      peg$c167 = peg$classExpectation([["A", "z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
      peg$c168 = function(word) { return word.join('') },
      peg$c169 = /^["|']/,
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                ...
                                if (s15 !== peg$FAILED) {
                                  s16 = peg$parsefieldDeclList();
                                  if (s16 !== peg$FAILED) {
                                    peg$savedPos = s0;
                                    s1 = peg$c33(s2, s5, s7, s9, s11, s16);
                                    s0 = s1;
                                  } else {
                                    peg$currPos = s0;
                                    s0 = peg$FAILED;
