...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c22 = function(baseName, applicationContentDecl) {
      ...
      peg$c27 = function(packageName, applicationContentDecl) {
      ...
      peg$c28 = function(authenticationType, applicationContentDecl) {
          parsed.application.authenticationType = authenticationType.join('');
        },
      peg$c29 = function(hibernateCache, applicationContentDecl) {
          parsed.application.hibernateCache = hibernateCache.join('');
        },
      peg$c30 = function(clusteredHttpSession, applicationContentDecl) {
          parsed.application.clusteredHttpSession = clusteredHttpSession;
        },
      peg$c31 = function(websocket, applicationContentDecl) {
          parsed.application.websocket = websocket;
        },
      peg$c32 = function(databaseType, applicationContentDecl) {
          parsed.application.databaseType = databaseType.join('');
        },
      peg$c33 = /^[A-z0-9]/,
      peg$c34 = peg$classExpectation([["A", "z"], ["0", "9"]], false, false),
      peg$c35 = function(devDatabaseType, applicationContentDecl) {
          parsed.application.devDatabaseType = devDatabaseType.join('');
        },
      peg$c36 = function(prodDatabaseType, applicationContentDecl) {
         parsed.application.prodDatabaseType = prodDatabaseType.join('');
        },
      peg$c37 = function() { return true; },
      peg$c38 = function() { return false; },
      peg$c39 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c40 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c41 = "(",
      peg$c42 = peg$literalExpectation("(", false),
      peg$c43 = /^[A-z0-9_\-]/,
      peg$c44 = peg$classExpectation([["A", "z"], ["0", "9"], "_", "-"], false, false),
      peg$c45 = ")",
      peg$c46 = peg$literalExpectation(")", false),
      peg$c47 = function(name) { return name.join(''); },
      peg$c48 = function(fdl) { return fdl; },
      peg$c49 = function() { return []; },
      peg$c50 = ",",
      peg$c51 = peg$literalExpectation(",", false),
      peg$c52 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c53 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c54 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c55 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c56 = function(rb) { return [rb]; },
      peg$c57 = "to",
      peg$c58 = peg$literalExpectation("to", false),
      peg$c59 = function(from, to) {
          return { from: from , to: to };
        },
      peg$c60 = "required",
      peg$c61 = peg$literalExpectation("required", false),
      peg$c62 = function(jd, e, i, required) {
          return { name: e, injectedfield: i, javadoc: jd, required: required ? true : false };
        },
      peg$c63 = function(jd, e) {
          return { name: e, injectedfield: null, javadoc: jd };
        },
      peg$c64 = function(e) { return { name: e, injectedfield: null, javadoc: '' }; },
      peg$c65 = function(e, el) {
          return { name: e, values: el };
        },
      peg$c66 = function(e, el) { return addUniqueElements([e], el); },
      peg$c67 = function(e) { return [e]; },
      peg$c68 = function(sub) { return sub; },
      peg$c69 = function(e, sub) { return addUniqueElements([e], sub); },
      ...
      peg$c80 = /^[A-z0-9\-]/,
      peg$c81 = peg$classExpectation([["A", "z"], ["0", "9"], "-"], false, false),
      peg$c82 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c83 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c84 = function() { return 'one-to-one'; },
      peg$c85 = function() { return 'one-to-many'; },
      peg$c86 = function() { return 'many-to-one'; },
      peg$c87 = function() { return 'many-to-many'; },
      peg$c88 = /^[A-Z]/,
      peg$c89 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c90 = function(head, tail) { return `${head}${tail.join('')}`; },
      peg$c91 = function() { return { key: 'required', value: '' }; },
      peg$c92 = function(int) { return { key: 'minlength', value: int }; },
      peg$c93 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c94 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c95 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c96 = function(int) { return { key: 'max', value: int };},
      peg$c97 = function(int) { return { key: 'min', value: int };},
      peg$c98 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c99 = function(notAComment) { return notAComment.join(''); },
      peg$c100 = "/*",
      ...
      peg$c108 = "application",
      peg$c109 = peg$literalExpectation("application", false),
      peg$c110 = "baseName",
      peg$c111 = peg$literalExpectation("baseName", false),
      peg$c112 = "packageName",
      peg$c113 = peg$literalExpectation("packageName", false),
      peg$c114 = "authenticationType",
      peg$c115 = peg$literalExpectation("authenticationType", false),
      peg$c116 = "hibernateCache",
      peg$c117 = peg$literalExpectation("hibernateCache", false),
      peg$c118 = "clusteredHttpSession",
      peg$c119 = peg$literalExpectation("clusteredHttpSession", false),
      peg$c120 = "websocket",
      peg$c121 = peg$literalExpectation("websocket", false),
      peg$c122 = "databaseType",
      peg$c123 = peg$literalExpectation("databaseType", false),
      peg$c124 = "devDatabaseType",
      peg$c125 = peg$literalExpectation("devDatabaseType", false),
      peg$c126 = "prodDatabaseType",
      peg$c127 = peg$literalExpectation("prodDatabaseType", false),
      peg$c128 = "true",
      peg$c129 = peg$literalExpectation("true", false),
      peg$c130 = "false",
      peg$c131 = peg$literalExpectation("false", false),
      peg$c132 = "entity",
      peg$c133 = peg$literalExpectation("entity", false),
      peg$c134 = "relationship",
      peg$c135 = peg$literalExpectation("relationship", false),
      peg$c136 = "enum",
      peg$c137 = peg$literalExpectation("enum", false),
      peg$c138 = "OneToOne",
      peg$c139 = peg$literalExpectation("OneToOne", false),
      peg$c140 = "OneToMany",
      peg$c141 = peg$literalExpectation("OneToMany", false),
      peg$c142 = "ManyToOne",
      peg$c143 = peg$literalExpectation("ManyToOne", false),
      peg$c144 = "ManyToMany",
      peg$c145 = peg$literalExpectation("ManyToMany", false),
      peg$c146 = "all",
      peg$c147 = peg$literalExpectation("all", false),
      peg$c148 = "*",
      peg$c149 = peg$literalExpectation("*", false),
      peg$c150 = "for",
      peg$c151 = peg$literalExpectation("for", false),
      peg$c152 = "with",
      peg$c153 = peg$literalExpectation("with", false),
      peg$c154 = "except",
      peg$c155 = peg$literalExpectation("except", false),
      peg$c156 = "noFluentMethod",
      peg$c157 = peg$literalExpectation("noFluentMethod", false),
      peg$c158 = "dto",
      peg$c159 = peg$literalExpectation("dto", false),
      peg$c160 = "paginate",
      peg$c161 = peg$literalExpectation("paginate", false),
      peg$c162 = "service",
      peg$c163 = peg$literalExpectation("service", false),
      peg$c164 = "microservice",
      peg$c165 = peg$literalExpectation("microservice", false),
      peg$c166 = "search",
      peg$c167 = peg$literalExpectation("search", false),
      peg$c168 = "skipClient",
      peg$c169 = peg$literalExpectation("skipClient", false),
      peg$c170 = "skipServer",
      peg$c171 = peg$literalExpectation("skipServer", false),
      peg$c172 = "angularSuffix",
      peg$c173 = peg$literalExpectation("angularSuffix", false),
      peg$c174 = "minlength",
      peg$c175 = peg$literalExpectation("minlength", false),
      peg$c176 = "maxlength",
      peg$c177 = peg$literalExpectation("maxlength", false),
      peg$c178 = "minbytes",
      peg$c179 = peg$literalExpectation("minbytes", false),
      peg$c180 = "maxbytes",
      peg$c181 = peg$literalExpectation("maxbytes", false),
      peg$c182 = "max",
      peg$c183 = peg$literalExpectation("max", false),
      peg$c184 = "min",
      peg$c185 = peg$literalExpectation("min", false),
      peg$c186 = "pattern",
      peg$c187 = peg$literalExpectation("pattern", false),
      peg$c188 = /^[_]/,
      peg$c189 = peg$classExpectation(["_"], false, false),
      peg$c190 = /^[A-Z0-9]/,
      peg$c191 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c192 = /^[A-Z0-9_]/,
      peg$c193 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c194 = function(underscore, head, tail) {
      ...
      peg$c199 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c200 = /^[a-zA-Z]/,
      peg$c201 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c202 = /^[A-z0-9()]/,
      peg$c203 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c204 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
      peg$c205 = peg$classExpectation(["'", "\n", "'", "|", "'", "\t", "'", "|", "'", "\r", "'", "|", "'", " ", "'", "|", "\u2028", "|", "\u2029"], false, false),
      peg$c206 = /^['\t'|' '|\u2028|\u2029]/,
      peg$c207 = peg$classExpectation(["'", "\t", "'", "|", "'", " ", "'", "|", "\u2028", "|", "\u2029"], false, false),
      peg$c208 = /^[A-z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
      peg$c209 = peg$classExpectation([["A", "z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
      peg$c210 = function(word) { return word.join('') },
      peg$c211 = /^["|']/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c52(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
