...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c44 = function(applicationType, applicationContentDecl) {
          parsed.application.applicationType = applicationType;
        },
      ...
      peg$c50 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c51 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c52 = "(",
      ...
      peg$c58 = function(name) { return name.join(''); },
      peg$c59 = function(fdl) { return fdl; },
      peg$c60 = function() { return []; },
      peg$c61 = ",",
      peg$c62 = peg$literalExpectation(",", false),
      peg$c63 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c64 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c65 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c66 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c67 = function(rb) { return [rb]; },
      peg$c68 = "to",
      peg$c69 = peg$literalExpectation("to", false),
      peg$c70 = function(from, to) {
          return { from: from , to: to };
        },
      peg$c71 = "required",
      peg$c72 = peg$literalExpectation("required", false),
      peg$c73 = function(jd, e, i, required) {
          return { name: e, injectedfield: i, javadoc: jd, required: required ? true : false };
        },
      peg$c74 = function(jd, e) {
          return { name: e, injectedfield: null, javadoc: jd };
        },
      peg$c75 = function(e) { return { name: e, injectedfield: null, javadoc: '' }; },
      peg$c76 = function(e, el) {
          return { name: e, values: el };
        },
      peg$c77 = function(e, el) { return addUniqueElements([e], el); },
      peg$c78 = function(e) { return [e]; },
      peg$c79 = function(sub) { return sub; },
      peg$c80 = function(e, sub) { return addUniqueElements([e], sub); },
      ...
      peg$c91 = /^[A-z0-9\-]/,
      peg$c92 = peg$classExpectation([["A", "z"], ["0", "9"], "-"], false, false),
      peg$c93 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c94 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c95 = function() { return 'one-to-one'; },
      peg$c96 = function() { return 'one-to-many'; },
      peg$c97 = function() { return 'many-to-one'; },
      peg$c98 = function() { return 'many-to-many'; },
      peg$c99 = /^[A-Z]/,
      peg$c100 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c101 = function(head, tail) { return `${head}${tail.join('')}`; },
      peg$c102 = function() { return { key: 'required', value: '' }; },
      peg$c103 = function(int) { return { key: 'minlength', value: int }; },
      peg$c104 = function(constantName) { return { key: 'minlength', value: constantName, constant: true }; },
      peg$c105 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c106 = function(constantName) { return { key: 'maxlength', value: constantName, constant: true }; },
      peg$c107 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c108 = function(constantName) { return { key: 'minbytes', value: constantName, constant: true }; },
      peg$c109 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c110 = function(constantName) { return { key: 'maxbytes', value: constantName, constant: true }; },
      peg$c111 = function(int) { return { key: 'min', value: int };},
      peg$c112 = function(constantName) { return { key: 'min', value: constantName, constant: true };},
      peg$c113 = function(int) { return { key: 'max', value: int };},
      peg$c114 = function(constantName) { return { key: 'max', value: constantName, constant: true };},
      peg$c115 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c116 = function(notAComment) { return notAComment.join(''); },
      peg$c117 = "/*",
      ...
      peg$c125 = "application",
      peg$c126 = peg$literalExpectation("application", false),
      peg$c127 = "baseName",
      peg$c128 = peg$literalExpectation("baseName", false),
      peg$c129 = "packageName",
      peg$c130 = peg$literalExpectation("packageName", false),
      peg$c131 = "authenticationType",
      peg$c132 = peg$literalExpectation("authenticationType", false),
      peg$c133 = "hibernateCache",
      peg$c134 = peg$literalExpectation("hibernateCache", false),
      peg$c135 = "clusteredHttpSession",
      peg$c136 = peg$literalExpectation("clusteredHttpSession", false),
      peg$c137 = "websocket",
      peg$c138 = peg$literalExpectation("websocket", false),
      peg$c139 = "databaseType",
      peg$c140 = peg$literalExpectation("databaseType", false),
      peg$c141 = "devDatabaseType",
      peg$c142 = peg$literalExpectation("devDatabaseType", false),
      peg$c143 = "prodDatabaseType",
      peg$c144 = peg$literalExpectation("prodDatabaseType", false),
      peg$c145 = "useCompass",
      peg$c146 = peg$literalExpectation("useCompass", false),
      peg$c147 = "buildTool",
      peg$c148 = peg$literalExpectation("buildTool", false),
      peg$c149 = "searchEngine",
      peg$c150 = peg$literalExpectation("searchEngine", false),
      peg$c151 = "enableTranslation",
      peg$c152 = peg$literalExpectation("enableTranslation", false),
      peg$c153 = "applicationType",
      peg$c154 = peg$literalExpectation("applicationType", false),
      peg$c155 = "true",
      peg$c156 = peg$literalExpectation("true", false),
      peg$c157 = "false",
      peg$c158 = peg$literalExpectation("false", false),
      peg$c159 = "entity",
      peg$c160 = peg$literalExpectation("entity", false),
      peg$c161 = "relationship",
      peg$c162 = peg$literalExpectation("relationship", false),
      peg$c163 = "enum",
      peg$c164 = peg$literalExpectation("enum", false),
      peg$c165 = "OneToOne",
      peg$c166 = peg$literalExpectation("OneToOne", false),
      peg$c167 = "OneToMany",
      peg$c168 = peg$literalExpectation("OneToMany", false),
      peg$c169 = "ManyToOne",
      peg$c170 = peg$literalExpectation("ManyToOne", false),
      peg$c171 = "ManyToMany",
      peg$c172 = peg$literalExpectation("ManyToMany", false),
      peg$c173 = "all",
      peg$c174 = peg$literalExpectation("all", false),
      peg$c175 = "*",
      peg$c176 = peg$literalExpectation("*", false),
      peg$c177 = "for",
      peg$c178 = peg$literalExpectation("for", false),
      peg$c179 = "with",
      peg$c180 = peg$literalExpectation("with", false),
      peg$c181 = "except",
      peg$c182 = peg$literalExpectation("except", false),
      peg$c183 = "noFluentMethod",
      peg$c184 = peg$literalExpectation("noFluentMethod", false),
      peg$c185 = "dto",
      peg$c186 = peg$literalExpectation("dto", false),
      peg$c187 = "paginate",
      peg$c188 = peg$literalExpectation("paginate", false),
      peg$c189 = "service",
      peg$c190 = peg$literalExpectation("service", false),
      peg$c191 = "microservice",
      peg$c192 = peg$literalExpectation("microservice", false),
      peg$c193 = "search",
      peg$c194 = peg$literalExpectation("search", false),
      peg$c195 = "skipClient",
      peg$c196 = peg$literalExpectation("skipClient", false),
      peg$c197 = "skipServer",
      peg$c198 = peg$literalExpectation("skipServer", false),
      peg$c199 = "angularSuffix",
      peg$c200 = peg$literalExpectation("angularSuffix", false),
      peg$c201 = "minlength",
      peg$c202 = peg$literalExpectation("minlength", false),
      peg$c203 = "maxlength",
      peg$c204 = peg$literalExpectation("maxlength", false),
      peg$c205 = "minbytes",
      peg$c206 = peg$literalExpectation("minbytes", false),
      peg$c207 = "maxbytes",
      peg$c208 = peg$literalExpectation("maxbytes", false),
      peg$c209 = "max",
      peg$c210 = peg$literalExpectation("max", false),
      peg$c211 = "min",
      peg$c212 = peg$literalExpectation("min", false),
      peg$c213 = "pattern",
      peg$c214 = peg$literalExpectation("pattern", false),
      peg$c215 = /^[_]/,
      peg$c216 = peg$classExpectation(["_"], false, false),
      peg$c217 = /^[A-Z0-9]/,
      peg$c218 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c219 = /^[A-Z0-9_]/,
      peg$c220 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c221 = function(underscore, head, tail) {
          return `${underscore.join('')}${head}${tail.join('')}`;
        },
      peg$c222 = /^[A-Z_]/,
      peg$c223 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c224 = "-",
      peg$c225 = peg$literalExpectation("-", false),
      peg$c226 = /^[0-9]/,
      peg$c227 = peg$classExpectation([["0", "9"]], false, false),
      peg$c228 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c229 = /^[a-zA-Z]/,
      peg$c230 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c231 = /^[A-z0-9()]/,
      peg$c232 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c233 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
      peg$c234 = peg$classExpectation(["'", "\n", "'", "|", "'", "\t", "'", "|", "'", "\r", "'", "|", "'", " ", "'", "|", "\u2028", "|", "\u2029"], false, false),
      peg$c235 = /^['\t'|' '|\u2028|\u2029]/,
      peg$c236 = peg$classExpectation(["'", "\t", "'", "|", "'", " ", "'", "|", "\u2028", "|", "\u2029"], false, false),
      peg$c237 = /^[A-z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
      peg$c238 = peg$classExpectation([["A", "z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
      peg$c239 = function(word) { return word.join('') },
      peg$c240 = /^["|']/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c63(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
  ...
  function peg$parseAUTHENTICATION_TYPE() {
    ...
    if (input.substr(peg$currPos, 18) === peg$c131) {
      s0 = peg$c131;
      peg$currPos += 18;
    } else {
      s0 = peg$FAILED;
  ...
  function peg$parseCLUSTERED_HTTP_SESSION() {
    ...
    if (input.substr(peg$currPos, 20) === peg$c135) {
      s0 = peg$c135;
      peg$currPos += 20;
    } else {
      s0 = peg$FAILED;
