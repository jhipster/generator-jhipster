...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c63 = function(skipUserManagement, applicationContentDecl) {
          parsed.application.skipUserManagement = skipUserManagement;
        },
      peg$c64 = function(skipClient, applicationContentDecl) {
          parsed.application.skipClient = skipClient;
        },
      peg$c65 = function(skipServer, applicationContentDecl) {
      ...
      peg$c71 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c72 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c73 = "(",
      peg$c74 = peg$literalExpectation("(", false),
      peg$c75 = ")",
      peg$c76 = peg$literalExpectation(")", false),
      peg$c77 = function(name) { return name.join(''); },
      peg$c78 = function(fdl) { return fdl; },
      peg$c79 = function() { return []; },
      peg$c80 = ",",
      peg$c81 = peg$literalExpectation(",", false),
      peg$c82 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c83 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c84 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c85 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c86 = function(rb) { return [rb]; },
      peg$c87 = "to",
      peg$c88 = peg$literalExpectation("to", false),
      peg$c89 = function(from, to) {
          return { from: from , to: to };
        },
      peg$c90 = "required",
      peg$c91 = peg$literalExpectation("required", false),
      peg$c92 = function(jd, e, i, required) {
          return { name: e, injectedfield: i, javadoc: jd, required: required ? true : false };
        },
      peg$c93 = function(jd, e) {
          return { name: e, injectedfield: null, javadoc: jd };
        },
      peg$c94 = function(e) { return { name: e, injectedfield: null, javadoc: '' }; },
      peg$c95 = function(e, el) {
          return { name: e, values: el };
        },
      peg$c96 = function(e, el) { return addUniqueElements([e], el); },
      peg$c97 = function(e) { return [e]; },
      peg$c98 = function(sub) { return sub; },
      peg$c99 = function(e, sub) { return addUniqueElements([e], sub); },
      ...
      peg$c110 = /^[A-z0-9\-]/,
      peg$c111 = peg$classExpectation([["A", "z"], ["0", "9"], "-"], false, false),
      peg$c112 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c113 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c114 = function() { return 'one-to-one'; },
      peg$c115 = function() { return 'one-to-many'; },
      peg$c116 = function() { return 'many-to-one'; },
      peg$c117 = function() { return 'many-to-many'; },
      peg$c118 = /^[A-Z]/,
      peg$c119 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c120 = function(head, tail) { return `${head}${tail.join('')}`; },
      peg$c121 = function() { return { key: 'required', value: '' }; },
      peg$c122 = function(int) { return { key: 'minlength', value: int }; },
      peg$c123 = function(constantName) { return { key: 'minlength', value: constantName, constant: true }; },
      peg$c124 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c125 = function(constantName) { return { key: 'maxlength', value: constantName, constant: true }; },
      peg$c126 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c127 = function(constantName) { return { key: 'minbytes', value: constantName, constant: true }; },
      peg$c128 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c129 = function(constantName) { return { key: 'maxbytes', value: constantName, constant: true }; },
      peg$c130 = function(int) { return { key: 'min', value: int };},
      peg$c131 = function(constantName) { return { key: 'min', value: constantName, constant: true };},
      peg$c132 = function(int) { return { key: 'max', value: int };},
      peg$c133 = function(constantName) { return { key: 'max', value: constantName, constant: true };},
      peg$c134 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c135 = function(notAComment) { return notAComment.join(''); },
      peg$c136 = "/*",
      ...
      peg$c142 = peg$anyExpectation(),
      peg$c143 = function(char) { return char; },
      peg$c144 = "application",
      peg$c145 = peg$literalExpectation("application", false),
      peg$c146 = "baseName",
      peg$c147 = peg$literalExpectation("baseName", false),
      peg$c148 = "packageName",
      peg$c149 = peg$literalExpectation("packageName", false),
      peg$c150 = "authenticationType",
      peg$c151 = peg$literalExpectation("authenticationType", false),
      peg$c152 = "hibernateCache",
      peg$c153 = peg$literalExpectation("hibernateCache", false),
      peg$c154 = "clusteredHttpSession",
      peg$c155 = peg$literalExpectation("clusteredHttpSession", false),
      peg$c156 = "websocket",
      peg$c157 = peg$literalExpectation("websocket", false),
      peg$c158 = "databaseType",
      peg$c159 = peg$literalExpectation("databaseType", false),
      peg$c160 = "devDatabaseType",
      peg$c161 = peg$literalExpectation("devDatabaseType", false),
      peg$c162 = "prodDatabaseType",
      peg$c163 = peg$literalExpectation("prodDatabaseType", false),
      peg$c164 = "useCompass",
      peg$c165 = peg$literalExpectation("useCompass", false),
      peg$c166 = "buildTool",
      peg$c167 = peg$literalExpectation("buildTool", false),
      peg$c168 = "searchEngine",
      peg$c169 = peg$literalExpectation("searchEngine", false),
      peg$c170 = "enableTranslation",
      peg$c171 = peg$literalExpectation("enableTranslation", false),
      peg$c172 = "applicationType",
      peg$c173 = peg$literalExpectation("applicationType", false),
      peg$c174 = "testFrameworks",
      peg$c175 = peg$literalExpectation("testFrameworks", false),
      peg$c176 = "languages",
      peg$c177 = peg$literalExpectation("languages", false),
      peg$c178 = "serverPort",
      peg$c179 = peg$literalExpectation("serverPort", false),
      peg$c180 = "enableSocialSignIn",
      peg$c181 = peg$literalExpectation("enableSocialSignIn", false),
      peg$c182 = "useSass",
      peg$c183 = peg$literalExpectation("useSass", false),
      peg$c184 = "jhiPrefix",
      peg$c185 = peg$literalExpectation("jhiPrefix", false),
      peg$c186 = "messageBroker",
      peg$c187 = peg$literalExpectation("messageBroker", false),
      peg$c188 = "serviceDiscoveryType",
      peg$c189 = peg$literalExpectation("serviceDiscoveryType", false),
      peg$c190 = "clientPackageManager",
      peg$c191 = peg$literalExpectation("clientPackageManager", false),
      peg$c192 = "clientFramework",
      peg$c193 = peg$literalExpectation("clientFramework", false),
      peg$c194 = "nativeLanguage",
      peg$c195 = peg$literalExpectation("nativeLanguage", false),
      peg$c196 = "frontendBuilder",
      peg$c197 = peg$literalExpectation("frontendBuilder", false),
      peg$c198 = "skipUserManagement",
      peg$c199 = peg$literalExpectation("skipUserManagement", false),
      peg$c200 = "true",
      peg$c201 = peg$literalExpectation("true", false),
      peg$c202 = "false",
      peg$c203 = peg$literalExpectation("false", false),
      peg$c204 = "entity",
      peg$c205 = peg$literalExpectation("entity", false),
      peg$c206 = "relationship",
      peg$c207 = peg$literalExpectation("relationship", false),
      peg$c208 = "enum",
      peg$c209 = peg$literalExpectation("enum", false),
      peg$c210 = "OneToOne",
      peg$c211 = peg$literalExpectation("OneToOne", false),
      peg$c212 = "OneToMany",
      peg$c213 = peg$literalExpectation("OneToMany", false),
      peg$c214 = "ManyToOne",
      peg$c215 = peg$literalExpectation("ManyToOne", false),
      peg$c216 = "ManyToMany",
      peg$c217 = peg$literalExpectation("ManyToMany", false),
      peg$c218 = "all",
      peg$c219 = peg$literalExpectation("all", false),
      peg$c220 = "*",
      peg$c221 = peg$literalExpectation("*", false),
      peg$c222 = "for",
      peg$c223 = peg$literalExpectation("for", false),
      peg$c224 = "with",
      peg$c225 = peg$literalExpectation("with", false),
      peg$c226 = "except",
      peg$c227 = peg$literalExpectation("except", false),
      peg$c228 = "noFluentMethod",
      peg$c229 = peg$literalExpectation("noFluentMethod", false),
      peg$c230 = "dto",
      peg$c231 = peg$literalExpectation("dto", false),
      peg$c232 = "paginate",
      peg$c233 = peg$literalExpectation("paginate", false),
      peg$c234 = "service",
      peg$c235 = peg$literalExpectation("service", false),
      peg$c236 = "microservice",
      peg$c237 = peg$literalExpectation("microservice", false),
      peg$c238 = "search",
      peg$c239 = peg$literalExpectation("search", false),
      peg$c240 = "skipClient",
      peg$c241 = peg$literalExpectation("skipClient", false),
      peg$c242 = "skipServer",
      peg$c243 = peg$literalExpectation("skipServer", false),
      peg$c244 = "angularSuffix",
      peg$c245 = peg$literalExpectation("angularSuffix", false),
      peg$c246 = "minlength",
      peg$c247 = peg$literalExpectation("minlength", false),
      peg$c248 = "maxlength",
      peg$c249 = peg$literalExpectation("maxlength", false),
      peg$c250 = "minbytes",
      peg$c251 = peg$literalExpectation("minbytes", false),
      peg$c252 = "maxbytes",
      peg$c253 = peg$literalExpectation("maxbytes", false),
      peg$c254 = "max",
      peg$c255 = peg$literalExpectation("max", false),
      peg$c256 = "min",
      peg$c257 = peg$literalExpectation("min", false),
      peg$c258 = "pattern",
      peg$c259 = peg$literalExpectation("pattern", false),
      peg$c260 = /^[_]/,
      peg$c261 = peg$classExpectation(["_"], false, false),
      peg$c262 = /^[A-Z0-9]/,
      peg$c263 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c264 = /^[A-Z0-9_]/,
      peg$c265 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c266 = function(underscore, head, tail) {
          return `${underscore.join('')}${head}${tail.join('')}`;
        },
      peg$c267 = /^[A-Z_]/,
      peg$c268 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c269 = "-",
      peg$c270 = peg$literalExpectation("-", false),
      peg$c271 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c272 = /^[a-zA-Z]/,
      peg$c273 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c274 = /^[A-z0-9()]/,
      ...
      peg$c280 = /^[A-z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
      peg$c281 = peg$classExpectation([["A", "z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
      peg$c282 = function(word) { return word.join('') },
      peg$c283 = /^["|']/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c82(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
  ...
  function peg$parseAUTHENTICATION_TYPE() {
    ...
    if (input.substr(peg$currPos, 18) === peg$c150) {
      s0 = peg$c150;
      peg$currPos += 18;
    } else {
      s0 = peg$FAILED;
