...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c47 = function(name, value) { return { name: name, value: value }; },
      peg$c48 = function(jd, e, tableName, eb) {
          return { name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd };
        },
      peg$c49 = function(e, eb) { return { name: e, body: eb, javadoc: '' }; },
      peg$c50 = "(",
      peg$c51 = peg$literalExpectation("(", false),
      peg$c52 = /^[A-z0-9_\-]/,
      peg$c53 = peg$classExpectation([["A", "z"], ["0", "9"], "_", "-"], false, false),
      peg$c54 = ")",
      peg$c55 = peg$literalExpectation(")", false),
      peg$c56 = function(name) { return name.join(''); },
      peg$c57 = function(fdl) { return fdl; },
      peg$c58 = function() { return []; },
      peg$c59 = ",",
      peg$c60 = peg$literalExpectation(",", false),
      peg$c61 = function(com, f, t, vl, com2, fdl) {
          return addUniqueElements([{ name: f, type: t, validations: vl, javadoc: com || com2 }], fdl );
        },
      peg$c62 = function(v, vl) { return addUniqueElements([v], vl); },
      peg$c63 = function(rt, bodies) {
              addCardinalityToRelationships(rt, bodies);
              return addUniqueElements([], bodies);
          },
      peg$c64 = function(rb, morerb) { return addUniqueElements([rb], morerb); },
      peg$c65 = function(rb) { return [rb]; },
      peg$c66 = "to",
      peg$c67 = peg$literalExpectation("to", false),
      peg$c68 = function(from, to) {
          return { from: from , to: to };
        },
      peg$c69 = "required",
      peg$c70 = peg$literalExpectation("required", false),
      peg$c71 = function(jd, e, i, required) {
          return { name: e, injectedfield: i, javadoc: jd, required: required ? true : false };
        },
      peg$c72 = function(jd, e) {
          return { name: e, injectedfield: null, javadoc: jd };
        },
      peg$c73 = function(e) { return { name: e, injectedfield: null, javadoc: '' }; },
      peg$c74 = function(e, el) {
          return { name: e, values: el };
        },
      peg$c75 = function(e, el) { return addUniqueElements([e], el); },
      peg$c76 = function(e) { return [e]; },
      peg$c77 = function(sub) { return sub; },
      peg$c78 = function(e, sub) { return addUniqueElements([e], sub); },
      ...
      peg$c91 = function(method) { return ['*', method.toString().replace(/,/g,'')]; },
      peg$c92 = function(e, method) { return [e, method.toString().replace(/,/g,'')]; },
      peg$c93 = function() { return 'one-to-one'; },
      peg$c94 = function() { return 'one-to-many'; },
      peg$c95 = function() { return 'many-to-one'; },
      peg$c96 = function() { return 'many-to-many'; },
      peg$c97 = /^[A-Z]/,
      peg$c98 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c99 = function(head, tail) { return `${head}${tail.join('')}`; },
      peg$c100 = function() { return { key: 'required', value: '' }; },
      peg$c101 = function(int) { return { key: 'minlength', value: int }; },
      peg$c102 = function(constantName) { return { key: 'minlength', value: constantName, constant: true }; },
      peg$c103 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c104 = function(constantName) { return { key: 'maxlength', value: constantName, constant: true }; },
      peg$c105 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c106 = function(constantName) { return { key: 'minbytes', value: constantName, constant: true }; },
      peg$c107 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c108 = function(constantName) { return { key: 'maxbytes', value: constantName, constant: true }; },
      peg$c109 = function(int) { return { key: 'min', value: int };},
      peg$c110 = function(constantName) { return { key: 'min', value: constantName, constant: true };},
      peg$c111 = function(int) { return { key: 'max', value: int };},
      peg$c112 = function(constantName) { return { key: 'max', value: constantName, constant: true };},
      ...
      peg$c123 = "application",
      peg$c124 = peg$literalExpectation("application", false),
      peg$c125 = "baseName",
      peg$c126 = peg$literalExpectation("baseName", false),
      peg$c127 = "packageName",
      peg$c128 = peg$literalExpectation("packageName", false),
      peg$c129 = "authenticationType",
      peg$c130 = peg$literalExpectation("authenticationType", false),
      peg$c131 = "hibernateCache",
      peg$c132 = peg$literalExpectation("hibernateCache", false),
      peg$c133 = "clusteredHttpSession",
      peg$c134 = peg$literalExpectation("clusteredHttpSession", false),
      peg$c135 = "websocket",
      peg$c136 = peg$literalExpectation("websocket", false),
      peg$c137 = "databaseType",
      peg$c138 = peg$literalExpectation("databaseType", false),
      peg$c139 = "devDatabaseType",
      peg$c140 = peg$literalExpectation("devDatabaseType", false),
      peg$c141 = "prodDatabaseType",
      peg$c142 = peg$literalExpectation("prodDatabaseType", false),
      peg$c143 = "useCompass",
      peg$c144 = peg$literalExpectation("useCompass", false),
      peg$c145 = "buildTool",
      peg$c146 = peg$literalExpectation("buildTool", false),
      peg$c147 = "searchEngine",
      peg$c148 = peg$literalExpectation("searchEngine", false),
      peg$c149 = "true",
      peg$c150 = peg$literalExpectation("true", false),
      peg$c151 = "false",
      peg$c152 = peg$literalExpectation("false", false),
      peg$c153 = "entity",
      peg$c154 = peg$literalExpectation("entity", false),
      peg$c155 = "relationship",
      peg$c156 = peg$literalExpectation("relationship", false),
      peg$c157 = "enum",
      peg$c158 = peg$literalExpectation("enum", false),
      peg$c159 = "OneToOne",
      peg$c160 = peg$literalExpectation("OneToOne", false),
      peg$c161 = "OneToMany",
      peg$c162 = peg$literalExpectation("OneToMany", false),
      peg$c163 = "ManyToOne",
      peg$c164 = peg$literalExpectation("ManyToOne", false),
      peg$c165 = "ManyToMany",
      peg$c166 = peg$literalExpectation("ManyToMany", false),
      peg$c167 = "all",
      peg$c168 = peg$literalExpectation("all", false),
      peg$c169 = "*",
      ...
      peg$c175 = "except",
      peg$c176 = peg$literalExpectation("except", false),
      peg$c177 = "noFluentMethod",
      peg$c178 = peg$literalExpectation("noFluentMethod", false),
      peg$c179 = "dto",
      peg$c180 = peg$literalExpectation("dto", false),
      peg$c181 = "paginate",
      peg$c182 = peg$literalExpectation("paginate", false),
      peg$c183 = "service",
      peg$c184 = peg$literalExpectation("service", false),
      peg$c185 = "microservice",
      peg$c186 = peg$literalExpectation("microservice", false),
      peg$c187 = "search",
      peg$c188 = peg$literalExpectation("search", false),
      peg$c189 = "skipClient",
      peg$c190 = peg$literalExpectation("skipClient", false),
      peg$c191 = "skipServer",
      peg$c192 = peg$literalExpectation("skipServer", false),
      peg$c193 = "angularSuffix",
      peg$c194 = peg$literalExpectation("angularSuffix", false),
      peg$c195 = "minlength",
      peg$c196 = peg$literalExpectation("minlength", false),
      peg$c197 = "maxlength",
      peg$c198 = peg$literalExpectation("maxlength", false),
      peg$c199 = "minbytes",
      peg$c200 = peg$literalExpectation("minbytes", false),
      peg$c201 = "maxbytes",
      peg$c202 = peg$literalExpectation("maxbytes", false),
      peg$c203 = "max",
      peg$c204 = peg$literalExpectation("max", false),
      peg$c205 = "min",
      peg$c206 = peg$literalExpectation("min", false),
      peg$c207 = "pattern",
      peg$c208 = peg$literalExpectation("pattern", false),
      peg$c209 = /^[_]/,
      peg$c210 = peg$classExpectation(["_"], false, false),
      peg$c211 = /^[A-Z0-9]/,
      peg$c212 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c213 = /^[A-Z0-9_]/,
      peg$c214 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c215 = function(underscore, head, tail) {
          return `${underscore.join('')}${head}${tail.join('')}`;
        },
      peg$c216 = /^[A-Z_]/,
      peg$c217 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c218 = "-",
      peg$c219 = peg$literalExpectation("-", false),
      peg$c220 = /^[0-9]/,
      peg$c221 = peg$classExpectation([["0", "9"]], false, false),
      peg$c222 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c223 = /^[a-zA-Z]/,
      peg$c224 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c225 = /^[A-z0-9()]/,
      ...
      peg$c231 = /^[A-z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
      peg$c232 = peg$classExpectation([["A", "z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
      peg$c233 = function(word) { return word.join('') },
      peg$c234 = /^["|']/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c61(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
  ...
  function peg$parseAUTHENTICATION_TYPE() {
    ...
    if (input.substr(peg$currPos, 18) === peg$c129) {
      s0 = peg$c129;
      peg$currPos += 18;
    } else {
      s0 = peg$FAILED;
