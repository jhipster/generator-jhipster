...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c159 = function(pattern) { return pattern.join(''); },
      peg$c160 = /^[_]/,
      peg$c161 = peg$classExpectation(["_"], false, false),
      peg$c162 = /^[A-Z0-9]/,
      peg$c163 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c164 = /^[A-Z0-9_]/,
      peg$c165 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c166 = function(underscore, head, tail) {
      ...
      peg$c173 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c174 = /^[a-zA-Z]/,
      peg$c175 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c176 = /^[A-z0-9()]/,
      peg$c177 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c178 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c37(s2, s4, s6, s8, s10, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
