...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c143 = "filter",
      peg$c144 = peg$literalExpectation("filter", false),
      peg$c145 = "minlength",
      peg$c146 = peg$literalExpectation("minlength", false),
      peg$c147 = "maxlength",
      peg$c148 = peg$literalExpectation("maxlength", false),
      peg$c149 = "minbytes",
      peg$c150 = peg$literalExpectation("minbytes", false),
      peg$c151 = "maxbytes",
      peg$c152 = peg$literalExpectation("maxbytes", false),
      peg$c153 = "max",
      peg$c154 = peg$literalExpectation("max", false),
      peg$c155 = "min",
      peg$c156 = peg$literalExpectation("min", false),
      peg$c157 = "pattern",
      peg$c158 = peg$literalExpectation("pattern", false),
      peg$c159 = /^[^\n\r\/]/,
      peg$c160 = peg$classExpectation(["\n", "\r", "/"], true, false),
      peg$c161 = function(pattern) { return pattern.join(''); },
      peg$c162 = /^[_]/,
      peg$c163 = peg$classExpectation(["_"], false, false),
      peg$c164 = /^[A-Z0-9]/,
      peg$c165 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
      peg$c166 = /^[A-Z0-9_]/,
      peg$c167 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c168 = function(underscore, head, tail) {
          return `${underscore.join('')}${head}${tail.join('')}`;
        },
      peg$c169 = /^[A-Z_]/,
      peg$c170 = peg$classExpectation([["A", "Z"], "_"], false, false),
      peg$c171 = "-",
      peg$c172 = peg$literalExpectation("-", false),
      peg$c173 = /^[0-9]/,
      peg$c174 = peg$classExpectation([["0", "9"]], false, false),
      peg$c175 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
      peg$c176 = /^[a-zA-Z]/,
      peg$c177 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c178 = /^[A-z0-9()]/,
      peg$c179 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
      peg$c180 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
