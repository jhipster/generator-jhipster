...
const EOF = require('chevrotain').EOF;
const Lexer = require('./lexer');
const JDLParser = require('./jdl_parser');
const performAdditionalSyntaxChecks = require('./validator').performAdditionalSyntaxChecks;
const buildAst = require('./ast_builder').buildAst;
const findRedundantTokens = require('./self_checks').findRedundantTokens;
...
findRedundantTokens(_.values(tokens), rules);
