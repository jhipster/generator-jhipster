...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c93 = function(jd, e, tableName, eb) {
          if (tableName && _.snakeCase(e) === _.snakeCase(tableName)) {
            parsed.errors.ENT_OPTIONAL_TABLE_NAME.push({ entityName: e });
          }
          if (eb === 'ENT_SHORTER_DECL') {
            parsed.errors.ENT_SHORTER_DECL.push({ entityName: e });
            eb = [];
          }
          parsed.errors.FLD_OPTIONAL_COMMAS.forEach((entry) => {
            if (!entry.entity) {
              entry.entity = e;
            }
          });
      ...
      peg$c100 = function(fdl) {
          if (fdl.length === 0) {
            return 'ENT_SHORTER_DECL';
          }
          return fdl;
        },
      peg$c101 = function() { return []; },
      peg$c102 = function(com, f, t, vl, com2, comma, space, fdl) {
          if (comma && (space.includes('\n') || space.includes('\r'))) {
            parsed.errors.FLD_OPTIONAL_COMMAS.push({ field: f });
          }
      ...
      peg$c104 = function(rt, bodies) {
              ...
              if (bodies.length === 1 && relationshipCounts[rt] !== 0) {
                parsed.errors.REL_INDIVIDUAL_DECL.push({
                  from: bodies[0].from.name,
                  to: bodies[0].to.name,
                  type: rt
                });
              }
              relationshipCounts[rt] += bodies.length;
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c102(s2, s4, s6, s8, s10, s12, s13, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
