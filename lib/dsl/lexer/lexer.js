...
const deploymentTokenConfigs = require('./deployment_token_configs');
const relationshipTypeTokenConfigs = require('./relationship_type_token_configs');
...
deploymentTokenConfigs.forEach(tokenConfig => {
  createTokenFromConfig({
    ...tokenConfig,
...
const RELATIONSHIP_TYPE = createTokenFromConfig({
  name: 'RELATIONSHIP_TYPE',
  pattern: Lexer.NA
});

relationshipTypeTokenConfigs.forEach(tokenConfig => {
  createTokenFromConfig({
    ...tokenConfig,
