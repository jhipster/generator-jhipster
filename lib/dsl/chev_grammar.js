...
createToken({ name: 'MINLENGTH', pattern: 'minlength' });
createToken({ name: 'MAXLENGTH', pattern: 'maxlength' });
createToken({ name: 'MINBYTES', pattern: 'minbytes' });
createToken({ name: 'MAXBYTES', pattern: 'maxbytes' });
createToken({ name: 'MAX', pattern: 'max' });
createToken({ name: 'MIN', pattern: 'min' });
