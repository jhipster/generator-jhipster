...
const { convertEntitiesToJDL, parseServerOptions } = require('../converters/json_to_jdl_entity_converter');
...
function parseFromDir(dir) {
  ...
  const jdl = parseServerOptions(JSONFileReader.readEntityJSON(`${dir}/.yo-rc.json`)['generator-jhipster']);
