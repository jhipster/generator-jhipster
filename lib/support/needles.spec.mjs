...
import { checkContentIn, insertContentBeforeNeedle, createNeedleCallback, createBaseNeedle } from './needles.cjs';
...
`,
  ...
  `);
        ...
        it('should apply with needles at start and end of contents', () => {
          const content = insertContentBeforeNeedle({
...
`);
        ...
        it('should not apply with needles with extra letter', () => {
          const content = insertContentBeforeNeedle({
        ...
        it('should not apply with needles with extra dash', () => {
          const content = insertContentBeforeNeedle({
            content: `${needlePrefix} jhipster-needle-${needle}-`,
            contentToAdd,
            needle,
        ...
        it('should not apply without a leading space', () => {
          const content = insertContentBeforeNeedle({
            content: `${needlePrefix}jhipster-needle-${needle}-`,
            contentToAdd,
            needle,
