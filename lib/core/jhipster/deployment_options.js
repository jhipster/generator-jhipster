  ...
  _.omitBy(
    {
      ...
      appsFolders: Options.appsFolders,
      clusteredDbApps: Options.clusteredDbApps,
      consoleOptions: [],
      ...
      istio: deploymentType === Options.deploymentType.kubernetes ? Options.istio.no : undefined,
      istioRoute: deploymentType === Options.deploymentType.kubernetes ? Options.istioRoute : undefined,
      enableRancherLoadBalancing:
        deploymentType === Options.deploymentType.rancherCompose ? Options.enableRancherLoadBalancing : undefined,
      openshiftNamespace: deploymentType === Options.deploymentType.openshift ? Options.openshiftNamespace : undefined,
      storageType: deploymentType === Options.deploymentType.openshift ? Options.storageType : undefined
    },
    _.isUndefined
  );
