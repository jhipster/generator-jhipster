...
const MySQLReservedKeywords = [
  ...
  'ESCAPED', 'EXCEPT', 'EXISTS', 'EXIT', 'EXPLAIN', 'FALSE', 'FETCH', 'FIRST_VALUE', 'FLOAT', 'FLOAT4',
  'FLOAT8', 'FOR', 'FORCE', 'FOREIGN', 'FROM', 'FULLTEXT', 'GRANT', 'GROUP', 'GROUPING', 'GROUPS',
  ...
  'INT8', 'INTEGER', 'INTERVAL', 'INTO', 'IS', 'ITERATE', 'JOIN', 'JSON_TABLE', 'KEY', 'KEYS', 'KILL',
  'LAG', 'LAST_VALUE', 'LEAD', 'LEADING', 'LEAVE', 'LEFT', 'LIKE', 'LIMIT', 'LINEAR', 'LINES', 'LOAD',
  ...
  'NO_WRITE_TO_BINLOG', 'NTH_VALUE', 'NTILE', 'NULL', 'NUMERIC', 'OF', 'ON', 'OPTIMIZE', 'OPTION',
  'OPTIONALLY', 'OR', 'ORDER', 'OUT', 'OUTER', 'OUTFILE', 'OVER', 'PERCENT_RANK', 'PERSIST', 'PERSIST_ONLY',
  'PRECISION', 'PRIMARY', 'PROCEDURE', 'PURGE', 'RANGE', 'RANK', 'RECURSIVE', 'READ', 'READS', 'READ_WRITE',
  'REAL', 'REFERENCES', 'REGEXP', 'RELEASE', 'RENAME', 'REPEAT', 'REPLACE', 'REQUIRE', 'RESIGNAL', 'RESTRICT',
  'RETURN', 'REVOKE', 'RIGHT', 'RLIKE', 'ROW_NUMBER', 'SCHEMA', 'SCHEMAS', 'SECOND_MICROSECOND', 'SELECT',
  ...
  'VARYING', 'WHEN', 'WHERE', 'WHILE', 'WITH', 'WRITE', 'XOR', 'YEAR_MONTH', 'ZEROFILL', 'GENERAL',
  'IGNORE_SERVER_IDS', 'MASTER_HEARTBEAT_PERIOD', 'MAXVALUE', 'RESIGNAL', 'SIGNAL', 'SLOW', 'WINDOW'
];

const ReservedWords = {
  JHIPSTER: [
    'ACCOUNT', 'ACTIVATE', 'AUDITS', 'CONFIGURATION', 'DOCS', 'HEALTH', 'LOGS', 'METRICS', 'PASSWORD',
    'REGISTER', 'RESET', 'SESSIONS', 'SETTINGS', 'TEST', 'EVENTMANAGER', 'PRINCIPAL', 'ENTITY', 'RESULT'
  ],
  ANGULAR: [
  ...
  COUCHBASE: [
    'ALL', 'AND', 'ANY', 'APPLY', 'AS', 'ASC', 'AT', 'AUTOGENERATED', 'BETWEEN', 'BTREE', 'BUCKET', 'BY',
    'CASE', 'CLOSED', 'CREATE', 'COMPACTION', 'COMPACT', 'CONNECT', 'CONNECTED', 'CORRELATE', 'COLLECTION',
    'DATASET', 'DATAVERSE', 'DECLARE', 'DEFINITION', 'DECLARE', 'DEFINITION', 'DELETE', 'DESC', 'DISCONNECT',
    'DISTINCT', 'DROP', 'ELEMENT', 'EXPLAIN', 'ELSE', 'ENFORCED', 'END', 'EVERY', 'EXCEPT', 'EXISTS', 'EXTERNAL',
    'FEED', 'FILTER', 'FLATTEN', 'FOR', 'FROM', 'FULL', 'FUNCTION', 'GROUP', 'HAVING', 'HINTS', 'IF', 'INTO',
    'IN', 'INDEX', 'INGESTION', 'INNER', 'INSERT', 'INTERNAL', 'INTERSECT', 'IS', 'JOIN', 'KEYWORD', 'KEY',
    'LEFT', 'LETTING', 'LET', 'LIKE', 'LIMIT', 'LOAD', 'NODEGROUP', 'NGRAM', 'NOT', 'OFFSET', 'ON', 'OPEN', 'OR',
    'ORDER', 'OUTER', 'OUTPUT', 'PATH', 'POLICY', 'PRE-SORTED', 'PRIMARY', 'RAW', 'REFRESH', 'RETURN', 'RTREE',
    'RUN', 'SATISFIES', 'SECONDARY', 'SELECT', 'SET', 'SHADOW', 'SOME', 'TEMPORARY', 'THEN', 'TYPE', 'TO',
    'UNION', 'UNKNOWN', 'UNNEST', 'UPDATE', 'USE', 'USING', 'VALUE', 'WHEN', 'WHERE', 'WITH', 'WRITE'
  ],
  ORACLE: [
...
function isReserved(keyword, type) {
  return !!keyword && !!type && !!ReservedWords[type.toUpperCase()]
...
function isReservedFieldName(keyword, clientFramework) {
  if (clientFramework) {
    if (clientFramework === 'angularX') {
      ...
      return isReserved(keyword, 'REACT') || isReserved(keyword, 'TYPESCRIPT') || isReserved(keyword, 'JAVA');
    }
  }
  ...
  return isReserved(keyword, 'ANGULAR') || isReserved(keyword, 'REACT') || isReserved(keyword, 'TYPESCRIPT') || isReserved(keyword, 'JAVA');
}
