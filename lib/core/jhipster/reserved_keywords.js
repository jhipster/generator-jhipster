...
const RESERVED_WORDS = {
  JHIPSTER: [
    ...
    'REGISTER', 'RESET', 'SESSIONS', 'SETTINGS', 'TEST', 'EVENTMANAGER', 'PRINCIPAL'
  ],
  ANGULAR: [
...
module.exports = {
  ...
  isReservedClassName: isReservedClassName,
  isReservedTableName: isReservedTableName,
  isReservedFieldName: isReservedFieldName,
