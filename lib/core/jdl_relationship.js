...
class JDLRelationship {
  ...
  static isValid(relationship) {
    return !!relationship && exists(relationship.type)
      && 'from' in relationship && JDLEntity.isValid(relationship.from)
      && 'to' in relationship && JDLEntity.isValid(relationship.to)
      && (('injectedFieldInFrom' in relationship && !!relationship.injectedFieldInFrom)
      || ('injectedFieldInTo' in relationship && !!relationship.injectedFieldInTo));
  }
