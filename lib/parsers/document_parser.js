...
function fillClassesAndFields() {
  configuration.document.entities.forEach(entity => {
...
function fillAssociations() {
  const jdlRelationships = convertRelationships(configuration.document.relationships, convertAnnotationsToOptions);
