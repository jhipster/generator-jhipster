...
function jsonToJDLField(field) {
  ...
  if (jdlField.type === 'byte[]') {
    ...
    case 'image':
      jdlField.type = FieldTypes.COMMON_DB_TYPES.IMAGE_BLOB;
      break;
    case 'any':
      jdlField.type = FieldTypes.COMMON_DB_TYPES.ANY_BLOB;
      break;
    case 'text':
      jdlField.type = FieldTypes.COMMON_DB_TYPES.TEXT_BLOB;
      break;
    default:
    }
  }
