...
import type { BaseApplicationApplication, CommonClientServerApplication } from '../../../generators/base-application/types.js';
...
export type ApplicationType<E = Entity> = BaseApplicationApplication &
