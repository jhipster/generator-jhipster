...
const GeneratorBaseEntities = require('../generators/generator-base-application.cjs');
...
const PageGenerator = require('../generators/page/generator.cjs');
const ServerGenerator = require('../generators/server');
const SpringControllerGenerator = require('../generators/spring-controller/generator.cjs');
const SpringServiceGenerator = require('../generators/spring-service/generator.cjs');
