...
function checkForValidValues() {
  ...
  Object.keys(nonCustomOptions).forEach(option => {
    ...
    if (option === 'databaseType') {
      checkDatabaseTypeValue(value);
      return;
    }
    if (option === 'devDatabaseType') {
      checkDevDatabaseTypeValue(value);
      return;
    }
    if (option === 'prodDatabaseType') {
...
function checkDatabaseTypeValue(value) {
  if (!ApplicationOptions.databaseType[value]) {
...
function checkDevDatabaseTypeValue(value) {
  if (
    !ApplicationOptions.databaseType[value] &&
    !ApplicationOptions.devDatabaseType[value] &&
    !ApplicationOptions.prodDatabaseType[value]
  ) {
...
function checkProdDatabaseTypeValue(value) {
  if (!ApplicationOptions.databaseType[value] && !ApplicationOptions.prodDatabaseType[value]) {
