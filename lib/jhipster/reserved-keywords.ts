...
import { cassandraReservedKeywords } from '../../generators/spring-boot/generators/data-cassandra/support/reserved-keywords.ts';
import { couchbaseReservedKeywords } from '../../generators/spring-boot/generators/data-couchbase/support/reserved-keywords.ts';
import { neo4jReservedKeywords } from '../../generators/spring-boot/generators/data-neo4j/support/reserved-keywords.ts';
import { mssqlReservedKeywords } from '../../generators/spring-boot/generators/data-relational/support/mssql-reserved-keywords.ts';
import { mysqlReservedKeywords } from '../../generators/spring-boot/generators/data-relational/support/mysql-reserved-keywords.ts';
import { oracleReservedKeywords } from '../../generators/spring-boot/generators/data-relational/support/oracle-reserved-keywords.ts';
import { postgresqlReservedKeywords } from '../../generators/spring-boot/generators/data-relational/support/postgresql-reserved-keywords.ts';
