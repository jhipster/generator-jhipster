...
function convert(jdlRelationships = [], entityNames = []) {
  ...
  relatedRelationships.forEach((relatedRelationships, currentEntityName) => {
    setRelationshipsFromEntity(relatedRelationships, currentEntityName);
    setRelationshipsToEntity(relatedRelationships, currentEntityName);
  });
