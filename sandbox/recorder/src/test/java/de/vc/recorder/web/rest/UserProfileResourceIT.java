...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().principal(DEFAULT_PRINCIPAL);
        return userProfile;
    }
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().principal(UPDATED_PRINCIPAL);
        return userProfile;
    }
    ...
    void createUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getPrincipal()).isEqualTo(DEFAULT_PRINCIPAL);
    }
    ...
    void putNewUserProfile() throws Exception {
        ...
        updatedUserProfile.principal(UPDATED_PRINCIPAL);
        ...
        UserProfile testUserProfile = userProfileList.get(userProfileList.size() - 1);
        assertThat(testUserProfile.getPrincipal()).isEqualTo(UPDATED_PRINCIPAL);
    }
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.principal(UPDATED_PRINCIPAL);
