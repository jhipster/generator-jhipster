...
describe('JDLGatewayApplication', () => {
  ...
  describe('#forEachEntityName', () => {
    ...
    before(() => {
      application = new JDLGatewayApplication({ entities: ['A', 'B'] });
    });
  ...
  describe('#toString', () => {
    context('when there is no entity', () => {
      ...
      before(() => {
        jdlApplication = new JDLGatewayApplication({ config: { jhipsterVersion: '4.9.0' } });
      });
  ...
  config {
    ...
    context('when there are listed entities', () => {
      ...
      before(() => {
        jdlApplication = new JDLGatewayApplication({ entities: ['A', 'B', 'C', 'C'] });
      });
