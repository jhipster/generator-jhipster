...
describe('JDLMonolithApplication', () => {
  describe('#new', () => {
    context('by default', () => {
      ...
      it(`sets the application type to ${ApplicationOptions.applicationType.monolith}`, () => {
        expect(jdlApplicationConfig.applicationType).to.equal(ApplicationOptions.applicationType.monolith);
      });
