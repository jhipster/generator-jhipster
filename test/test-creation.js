...
describe('JHipster generator ', function () {
    ...
    it('creates files for default configuration', function () {
        assert.file([
            ...
            'src/main/java/com/mycompany/myapp/config/MailConfiguration.java',
            ...
            'src/main/java/com/mycompany/myapp/config/metrics/JavaMailHealthIndicator.java',
            ...
            'src/main/java/com/mycompany/myapp/domain/util/CustomLocalDateSerializer.java',
            'src/main/java/com/mycompany/myapp/domain/util/CustomDateTimeSerializer.java',
            'src/main/java/com/mycompany/myapp/domain/util/CustomDateTimeDeserializer.java',
            'src/main/java/com/mycompany/myapp/domain/util/ISO8601LocalDateDeserializer.java',
            ...
            'src/main/java/com/mycompany/myapp/web/filter/gzip/package-info.java',
            'src/main/java/com/mycompany/myapp/web/filter/gzip/GzipResponseHeadersNotModifiableException.java',
            'src/main/java/com/mycompany/myapp/web/filter/gzip/GZipResponseUtil.java',
            'src/main/java/com/mycompany/myapp/web/filter/gzip/GZipServletFilter.java',
            'src/main/java/com/mycompany/myapp/web/filter/gzip/GZipServletOutputStream.java',
            'src/main/java/com/mycompany/myapp/web/filter/gzip/GZipServletResponseWrapper.java',
            'src/main/java/com/mycompany/myapp/web/propertyeditors/package-info.java',
            'src/main/java/com/mycompany/myapp/web/propertyeditors/LocaleDateTimeEditor.java',
            ...
            'src/main/webapp/i18n/en/language.json',
            ...
            'src/main/webapp/i18n/fr/language.json',
            ...
            'src/main/webapp/scripts/components/form/pager.directive.js',
            'src/main/webapp/scripts/components/form/pager.html',
            'src/main/webapp/scripts/components/form/pagination.directive.js',
            ...
            'src/test/javascript/spec/app/account/health/health.controller.spec.js',
