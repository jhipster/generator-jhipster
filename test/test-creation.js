...
const expectedFiles = {
    ...
    client_2: [
        ...
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/auth.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/principal.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/has-authority.directive.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/has-any-authority.directive.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/auth.session.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/account.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/activate.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/password.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/password-reset-init.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/password-reset-finish.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/register.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/services/auth/sessions.service.ts',
        ...
        CLIENT_MAIN_SRC_DIR + 'app/services/user/user.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/components/util/base64.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/components/util/parse-links.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/components/util/truncate-characters.filter.ts',
        CLIENT_MAIN_SRC_DIR + 'app/components/util/truncate-words.filter.ts',
        CLIENT_MAIN_SRC_DIR + 'app/components/util/date-util.service.ts',
        CLIENT_MAIN_SRC_DIR + 'app/components/util/sort.directive.ts',
        CLIENT_MAIN_SRC_DIR + 'app/components/util/sort-by.directive.ts',
        CLIENT_MAIN_SRC_DIR + 'app/account/account.state.ts',
        CLIENT_MAIN_SRC_DIR + 'app/account/activate/activate.html',
        CLIENT_MAIN_SRC_DIR + 'app/account/activate/activate.state.ts',
        CLIENT_MAIN_SRC_DIR + 'app/account/activate/activate.controller.ts',
        CLIENT_MAIN_SRC_DIR + 'app/components/login/login.html',
        ...
        CLIENT_MAIN_SRC_DIR + 'app/account/reset/finish/reset.finish.html',
        CLIENT_MAIN_SRC_DIR + 'app/account/reset/finish/reset.finish.state.ts',
        CLIENT_MAIN_SRC_DIR + 'app/account/reset/finish/reset.finish.controller.ts',
        CLIENT_MAIN_SRC_DIR + 'app/account/sessions/sessions.html',
        CLIENT_MAIN_SRC_DIR + 'app/account/sessions/sessions.state.ts',
        CLIENT_MAIN_SRC_DIR + 'app/account/sessions/sessions.controller.ts',
        CLIENT_MAIN_SRC_DIR + 'app/account/settings/settings.html',
        ...
        CLIENT_MAIN_SRC_DIR + 'app/admin/audits/audits.controller.ts',
        CLIENT_MAIN_SRC_DIR + 'app/admin/configuration/configuration.html',
        ...
        CLIENT_MAIN_SRC_DIR + 'app/admin/logs/logs.controller.ts',
        CLIENT_MAIN_SRC_DIR + 'app/admin/metrics/metrics.html',
        ...
        CLIENT_TEST_SRC_DIR + 'karma.conf.ts',
        CLIENT_TEST_SRC_DIR + 'spec/helpers/httpBackend.ts',
        CLIENT_TEST_SRC_DIR + 'spec/helpers/module.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/admin/health/health.controller.spec.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/components/login/login.controller.spec.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/account/password/password.controller.spec.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/account/password/password-strength-bar.directive.spec.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/account/sessions/sessions.controller.spec.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/account/settings/settings.controller.spec.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/account/activate/activate.controller.spec.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/account/register/register.controller.spec.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/account/reset/finish/reset.finish.controller.spec.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/account/reset/request/reset.request.controller.spec.ts',
        CLIENT_TEST_SRC_DIR + 'spec/app/services/auth/auth.services.spec.ts',
        CLIENT_MAIN_SRC_DIR + 'content/css/documentation.css',
        CLIENT_MAIN_SRC_DIR + 'content/images/hipster.png',
        CLIENT_MAIN_SRC_DIR + 'content/images/hipster2x.png'
    ],
