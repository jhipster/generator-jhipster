...
const expectedFiles = {
    ...
    client: [
        ...
        CLIENT_MAIN_SRC_DIR + 'app/admin/audits/audits.component.js',
        CLIENT_MAIN_SRC_DIR + 'app/admin/audits/audit-data.model.js',
        CLIENT_MAIN_SRC_DIR + 'app/admin/audits/audit.model.js',
    ...
    client_2: [
        ...
        CLIENT_MAIN_SRC_DIR + 'app/components/util/truncate-characters.pipe.ts',
        CLIENT_MAIN_SRC_DIR + 'app/components/util/truncate-words.pipe.ts',
