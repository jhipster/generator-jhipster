...
describe('JHipster generator', function () {
    ...
    it('creates server only files for default configuration', function () {
        helpers.run(path.join(__dirname, '../app'))
    ...
    it('creates client only files for default configuration', function () {
        helpers.run(path.join(__dirname, '../app'))
            .withOptions({skipInstall: true, skipServer: true})
            .withPrompts({
                "baseName": "jhipster",
                "useSass": false,
                "enableTranslation": true,
