...
const ParsedJDLToJDLObjectConverter = require('../../../../src/jdl/converters/parsed-jdl-to-jdl-object/parsed-jdl-to-jdl-object-converter');
...
const FieldTypes = require('../../../../src/jdl/jhipster/field-types').CommonDBTypes;
const Validations = require('../../../../src/jdl/jhipster/validations');
const UnaryOptions = require('../../../../src/jdl/jhipster/unary-options');
const BinaryOptions = require('../../../../src/jdl/jhipster/binary-options').Options;
const BinaryOptionValues = require('../../../../src/jdl/jhipster/binary-options').Values;
...
const { Options } = require('../../../../src/jdl/jhipster/binary-options');
