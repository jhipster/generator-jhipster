        ...
        context('when passing an invalid argument', () => {
            ...
            context('because the file does not exist', () => {
                it('should fail', () => {
                    expect(() => {
                        ...
                        new RegExp("The passed file 'test/test_files/WrongFile.json' must exist and must not be a directory to be read.")
                    );
                });
            });
            context('because the file is a folder', () => {
                it('should fail', () => {
                    ...
                    }).to.throw(new RegExp("The passed file 'test/test_files/' must exist and must not be a directory to be read."));
                });
            });
        });
