...
const expectedFiles = {
  ...
  couchbase: [
    ...
    `${SERVER_MAIN_RES_DIR}config/couchmove/changelog/V0.1__initial_setup/jhipster/authority/ROLE_ADMIN.json`,
    `${SERVER_MAIN_RES_DIR}config/couchmove/changelog/V0.1__initial_setup/jhipster/authority/ROLE_USER.json`,
    `${SERVER_MAIN_RES_DIR}config/couchmove/changelog/V0.1__initial_setup/jhipster/user/admin.json`,
    `${SERVER_MAIN_RES_DIR}config/couchmove/changelog/V0.1__initial_setup/jhipster/user/user.json`,
