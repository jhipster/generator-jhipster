...
const expectedFiles = {
    entity: {
        clientNg2: [
            ...
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/foo/delete/foo-delete-dialog.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/foo/detail/foo-detail.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/foo/update/foo-update.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/foo/list/foo.component.spec.ts`,
        ...
        clientNg2WithSuffix: [
            ...
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/foo-management/delete/foo-management-delete-dialog.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/foo-management/detail/foo-management-detail.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/foo-management/update/foo-management-update.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/foo-management/list/foo-management.component.spec.ts`,
        ...
        clientNg2WithRootFolder: [
            ...
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/test-root/foo/delete/foo-delete-dialog.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/test-root/foo/detail/foo-detail.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/test-root/foo/update/foo-update.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/test-root/foo/list/foo.component.spec.ts`,
        ...
        clientNg2WithRootFolderAndSuffix: [
            ...
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/test-root/foo-management/delete/foo-management-delete-dialog.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/test-root/foo-management/detail/foo-management-detail.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/test-root/foo-management/update/foo-management-update.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/test-root/foo-management/list/foo-management.component.spec.ts`,
        ...
        clientNg2GatewayMicroserviceEntity: [
            ...
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/sampleMicroservice/bar/delete/bar-delete-dialog.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/sampleMicroservice/bar/detail/bar-detail.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/sampleMicroservice/bar/update/bar-update.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/sampleMicroservice/bar/list/bar.component.spec.ts`,
        ...
        clientBazGatewayMicroserviceEntity: [
            ...
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/sampleMicroservice/baz/delete/baz-delete-dialog.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/sampleMicroservice/baz/detail/baz-detail.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/sampleMicroservice/baz/update/baz-update.component.spec.ts`,
            `${CLIENT_TEST_SRC_DIR}spec/app/entities/sampleMicroservice/baz/list/baz.component.spec.ts`,
    ...
    userManagementClient: [
        ...
        `${CLIENT_TEST_SRC_DIR}spec/app/admin/user-management/detail/user-management-detail.component.spec.ts`,
        `${CLIENT_TEST_SRC_DIR}spec/app/admin/user-management/update/user-management-update.component.spec.ts`,
        `${CLIENT_TEST_SRC_DIR}spec/app/admin/user-management/list/user-management.component.spec.ts`,
    ...
    client: [
        ...
        `${CLIENT_MAIN_SRC_DIR}app/shared/item-count.component.ts`,
        ...
        `${CLIENT_TEST_SRC_DIR}spec/app/core/util/alert.service.spec.ts`,
        `${CLIENT_TEST_SRC_DIR}spec/app/home/home.component.spec.ts`,
        `${CLIENT_TEST_SRC_DIR}spec/app/login/login.component.spec.ts`,
        ...
        `${CLIENT_TEST_SRC_DIR}spec/app/shared/item-count.component.spec.ts`,
        ...
        `${CLIENT_TEST_SRC_DIR}spec/app/shared/date/format-medium-date.pipe.spec.ts`,
