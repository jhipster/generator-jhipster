...
const expectedFiles = {
    ...
    client: [
        ...
        `${CLIENT_MAIN_SRC_DIR}app/shared/date/format-medium.pipe.ts`,
        ...
        `${CLIENT_MAIN_SRC_DIR}app/core/event-manager/event-manager.service.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/core/event-manager/event-with-content.model.ts`,
        ...
        `${CLIENT_MAIN_SRC_DIR}app/core/config/datepicker-adapter.ts`,
        ...
        `${CLIENT_TEST_SRC_DIR}spec/app/core/event-manager/event-manager.service.spec.ts`,
        ...
        `${CLIENT_TEST_SRC_DIR}spec/app/shared/date/format-medium.pipe.spec.ts`,
    ...
    clientAdminAngular: [
        ...
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jvm-memory/jvm-memory.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jvm-memory/jvm-memory.component.html`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jvm-threads/jvm-threads.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jvm-threads/jvm-threads.component.html`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-cache/metrics-cache.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-cache/metrics-cache.component.html`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-datasource/metrics-datasource.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-datasource/metrics-datasource.component.html`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-endpoints-requests/metrics-endpoints-requests.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-endpoints-requests/metrics-endpoints-requests.component.html`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-garbagecollector/metrics-garbagecollector.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-garbagecollector/metrics-garbagecollector.component.html`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-modal-threads/metrics-modal-threads.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-modal-threads/metrics-modal-threads.component.html`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-request/metrics-request.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-request/metrics-request.component.html`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-system/metrics-system.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/metrics-system/metrics-system.component.html`,
