...
import { asPromptingWorkspaceTask } from '../support/task-type-inference.js';
 ...
 */
export const askForApplicationType = asPromptingWorkspaceTask(async function askForApplicationType(
 ...
 */
export const askForGatewayType = asPromptingWorkspaceTask(async function askForGatewayType(this: BaseWorkspacesGenerator, { control }) {
  if (!this.options.askAnswered && (this.regenerate || control.existingProject)) return;
 ...
 * Ask For Path
 */
export const askForPath = asPromptingWorkspaceTask(async function askForPath(this: BaseWorkspacesGenerator, { control }) {
  if (!this.options.askAnswered && (this.regenerate || control.existingProject)) return;
 ...
 * Ask For Apps
 */
export const askForApps = asPromptingWorkspaceTask(async function askForApps(this: BaseWorkspacesGenerator, { control }) {
  if (!this.options.askAnswered && (this.regenerate || control.existingProject)) return;
 ...
 */
export const askForClustersMode = asPromptingWorkspaceTask(async function askForClustersMode(
  this: BaseWorkspacesGenerator,
 ...
 * Ask For Monitoring
 */
export const askForMonitoring = asPromptingWorkspaceTask(async function askForMonitoring(this: BaseWorkspacesGenerator, { control }) {
  if (!this.options.askAnswered && (this.regenerate || control.existingProject)) return;
 ...
 */
export const askForServiceDiscovery = asPromptingWorkspaceTask(async function askForServiceDiscovery(
  this: BaseWorkspacesGenerator,
  { control, applications },
) {
  if (!this.options.askAnswered && (this.regenerate || control.existingProject)) return;
 ...
 */
export const askForAdminPassword = asPromptingWorkspaceTask(async function askForAdminPassword(this: BaseWorkspacesGenerator, { control }) {
  if (!this.options.askAnswered && (this.regenerate || control.existingProject)) return;
 ...
 */
export const askForDockerRepositoryName = asPromptingWorkspaceTask(async function askForDockerRepositoryName(
  this: BaseWorkspacesGenerator,
  { control },
) {
  if (!this.options.askAnswered && (this.regenerate || control.existingProject)) return;
 ...
 */
export const askForDockerPushCommand = asPromptingWorkspaceTask(async function askForDockerPushCommand(
  this: BaseWorkspacesGenerator,
  { control },
) {
  if (!this.options.askAnswered && (this.regenerate || control.existingProject)) return;
