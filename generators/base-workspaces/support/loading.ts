...
export function loadWorkspacesConfig(this, { context = this, workspaces = this }) {
  workspaces.appsFolders = context.jhipsterConfig.appsFolders;
  workspaces.directoryPath = context.jhipsterConfig.directoryPath ?? './';
}
