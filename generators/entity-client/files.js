    ...
    return {
        ...
        writeClientFiles() {
            ...
            if (this.clientFramework === 'angularX') {
                ...
                this.addEntityToModule(this.entityInstance, this.entityClass, this.entityAngularName,
                    this.entityFolderName, this.entityFileName, this.enableTranslation, this.clientFramework, this.microserviceName);
            } else if (this.clientFramework === 'react') {
                // write client side files for react
                this.writeFilesToDisk(reactFiles, this, false, CLIENT_REACT_TEMPLATES_DIR);
                this.addEntityToModule(this.entityInstance, this.entityClass, this.entityAngularName,
                    this.entityFolderName, this.entityFileName, this.enableTranslation, this.clientFramework);
            }
