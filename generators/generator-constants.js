...
const SPRING_BOOT_VERSION = '2.2.8.RELEASE';
...
const DOCKER_NEO4J = 'neo4j:4.0.5';
...
const DOCKER_KEYCLOAK = 'jboss/keycloak:10.0.2'; // The version should match the attribute 'keycloakVersion' from /docker-compose/templates/realm-config/jhipster-realm.json.ejs and /server/templates/src/main/docker/config/realm-config/jhipster-realm.json.ejs
