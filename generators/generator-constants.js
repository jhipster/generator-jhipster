...
const DOCKER_MYSQL_VERSION = '8.0.29';
...
const DOCKER_KEYCLOAK_VERSION = '18.0.0';
...
const DOCKER_ELASTICSEARCH_VERSION = '7.17.3'; // The version should be coherent with the one from spring-data-elasticsearch project
const DOCKER_ELASTICSEARCH = `${DOCKER_ELASTICSEARCH_CONTAINER}:${DOCKER_ELASTICSEARCH_VERSION}`;
const DOCKER_KAFKA_VERSION = '7.1.1';
const DOCKER_KAFKA = `confluentinc/cp-kafka:${DOCKER_KAFKA_VERSION}`;
const DOCKER_ZOOKEEPER = `confluentinc/cp-zookeeper:${DOCKER_KAFKA_VERSION}`;
const DOCKER_SONAR_VERSION = '9.4.0-community';
const DOCKER_SONAR = `sonarqube:${DOCKER_SONAR_VERSION}`;
const DOCKER_CONSUL_VERSION = '1.12.1';
...
const DOCKER_PROMETHEUS_VERSION = 'v2.36.0';
...
const DOCKER_GRAFANA_VERSION = '8.5.4';
...
const constants = {
  ...
  DOCKER_ELASTICSEARCH_VERSION,
  DOCKER_KEYCLOAK,
  DOCKER_KEYCLOAK_VERSION,
  DOCKER_KAFKA,
  DOCKER_KAFKA_VERSION,
  DOCKER_ZOOKEEPER,
  DOCKER_SONAR,
  DOCKER_CONSUL,
