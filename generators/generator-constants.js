...
const DOCKER_HAZELCAST_MANAGEMENT_CENTER = 'hazelcast/management-center:3.12.4';
const DOCKER_MEMCACHED = 'memcached:1.5.16-alpine';
const DOCKER_KEYCLOAK = 'jboss/keycloak:7.0.0';
