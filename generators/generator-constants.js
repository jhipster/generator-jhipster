...
const DOCKER_TRAEFIK = 'traefik:1.7.25'; // waiting for https://github.com/jhipster/generator-jhipster/issues/11198
const DOCKER_CONSUL = 'consul:1.8.0';
const DOCKER_CONSUL_CONFIG_LOADER = 'jhipster/consul-config-loader:v0.3.1';
const DOCKER_PROMETHEUS = 'prom/prometheus:v2.19.2';
const DOCKER_PROMETHEUS_ALERTMANAGER = 'prom/alertmanager:v0.21.0';
const DOCKER_GRAFANA = 'grafana/grafana:7.1.0';
...
const DOCKER_PROMETHEUS_OPERATOR = 'quay.io/coreos/prometheus-operator:v0.40.0';
