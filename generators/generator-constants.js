...
const DOCKER_ELASTICSEARCH = 'docker.elastic.co/elasticsearch/elasticsearch:7.15.1'; // The version should be coherent with the one from spring-data-elasticsearch project
