...
const DOCKER_ELASTICSEARCH = 'docker.elastic.co/elasticsearch/elasticsearch:6.8.5'; // The version should be coerent with the one from spring-data-elasticsearch project
