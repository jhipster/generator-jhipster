...
const SPRING_BOOT_VERSION = '2.5.1';
...
const DOCKER_ELASTICSEARCH = 'docker.elastic.co/elasticsearch/elasticsearch:7.12.1'; // The version should be coherent with the one from spring-data-elasticsearch project
