...
const DOCKER_POSTGRESQL = 'postgres:13.0';
const DOCKER_MONGODB = 'mongo:4.4.1';
...
const DOCKER_MEMCACHED = 'memcached:1.6.8-alpine';
...
const SUPPORTED_VALIDATION_RULES = Object.keys(validationOptions).map(key => validationOptions[key]).filter(e => typeof e === 'string');
