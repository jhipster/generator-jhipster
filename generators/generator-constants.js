...
const ELASTICSEARCH_VERSION = '7.17.6'; // The version should be coherent with the one from spring-data-elasticsearch project
...
const DOCKER_SONAR_VERSION = '9.6.1-community';
