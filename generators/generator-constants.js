...
const DOCKER_MARIADB = 'mariadb:10.4.1';
const DOCKER_POSTGRESQL = 'postgres:11.1';
const DOCKER_MONGODB = 'mongo:4.1.7';
const DOCKER_COUCHBASE = 'couchbase/server:6.0.0';
const DOCKER_CASSANDRA = 'cassandra:3.11.3';
const DOCKER_MSSQL = 'microsoft/mssql-server-linux:latest';
const DOCKER_ORACLE = 'sath89/oracle-12c:latest';
const DOCKER_HAZELCAST_MANAGEMENT_CENTER = 'hazelcast/management-center:3.11.2';
const DOCKER_MEMCACHED = 'memcached:1.5.12-alpine';
const DOCKER_KEYCLOAK = 'jboss/keycloak:4.6.0.Final';
const DOCKER_ELASTICSEARCH = 'docker.elastic.co/elasticsearch/elasticsearch:6.2.4'; // The version should be coerent with the one from spring-data-elasticsearch project
...
const DOCKER_TRAEFIK = 'traefik:1.7.7';
const DOCKER_CONSUL = 'consul:1.4.0';
const DOCKER_CONSUL_CONFIG_LOADER = 'jhipster/consul-config-loader:v0.3.0';
const DOCKER_PROMETHEUS = 'prom/prometheus:v2.5.0';
const DOCKER_PROMETHEUS_ALERTMANAGER = 'prom/alertmanager:v0.15.3';
const DOCKER_GRAFANA = 'grafana/grafana:5.3.4';
