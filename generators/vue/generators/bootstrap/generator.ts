            ...
            this.editFile(
              ...
              createNeedleCallback({
                contentToAdd: newLanguages.map(
                  lang =>
                    `    './i18n-${lang.languageTag}': './${application.clientBundlerRsbuild || application.clientBundlerVite ? '' : this.relativeDir(clientRootDir, clientSrcDir)}i18n/${lang.languageTag}/${lang.languageTag}.js',`,
                ),
