        ...
        writeServerResourceFiles: function () {
            ...
            if (this.databaseType === 'cassandra' || this.applicationType === 'gateway') {
                ...
                if (this.applicationType !== 'microservice') {
                    this.copy(SERVER_MAIN_RES_DIR + 'config/cql/changelog/insert_default_users.cql', SERVER_MAIN_RES_DIR + 'config/cql/changelog/00000000000000_insert_default_users.cql');
                }
            }
        },
