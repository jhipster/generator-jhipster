    ...
    writing: {
        ...
        writeServerResourceFiles: function () {
            ...
            if (this.databaseType === 'cassandra' || this.applicationType === 'gateway') {
                ...
                this.template(SERVER_MAIN_RES_DIR + 'config/cql/_create-tables.cql', SERVER_MAIN_RES_DIR + 'config/cql/create-tables.cql', this, {});
                ...
                if (this.applicationType !== 'microservice' && this.databaseType === 'cassandra') {
                    this.template(SERVER_MAIN_RES_DIR + 'config/cql/changelog/_insert_default_users.cql', SERVER_MAIN_RES_DIR + 'config/cql/changelog/00000000000000_insert_default_users.cql', this, {});
                }
            }
        },
