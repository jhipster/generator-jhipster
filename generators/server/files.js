...
function writeFiles() {
    return {
        ...
        writeServerJavaConfigFiles() {
            ...
            if (this.hibernateCache === 'ehcache' || this.hibernateCache === 'hazelcast' || this.hibernateCache === 'infinispan' || this.clusteredHttpSession === 'hazelcast' || this.clusteredHttpSession === 'infinispan' || this.applicationType === 'gateway') {
