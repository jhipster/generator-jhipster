...
describe('generator - upgrade', function () {
  describe('default application', () => {
    ...
    it('generated git commits to match snapshot', () => {
      const commits = execaSync({ stdio: 'pipe', reject: false })`git log --pretty=format:%s`.stdout;
...
`);
    ...
    it('generates expected number of commits', () => {
      const commitsCount = execaSync({ stdio: 'pipe', reject: false })`git rev-list --count HEAD`.stdout.replace('\n', '');
  ...
  describe.skip('blueprint application', () => {
    ...
    before(async () => {
      ...
      // Create a fake generator, otherwise env.lookup doesn't find it.
