...
const { NO: NO_MESSAGE_BROKER, KAFKA, RABBITMQ } = messageBrokerTypes; // added rabbitMQ - cmi-tic-varun
...
matrix = extendMatrix(matrix, {
  ...
  messageBroker: [NO_MESSAGE_BROKER, KAFKA, RABBITMQ], // added rabbitMQ - cmi-tic-varun
});
