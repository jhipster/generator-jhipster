...
export default asWritingTask<AngularEntity, AngularApplication<AngularEntity>>(function cleanupOldFilesTask({ application, control }) {
  ...
  if (control.isJhipsterVersionLessThan('9.0.1')) {
    this.removeFile(`${application.clientSrcDir}app/account/activate/activate.component.html`);
    this.removeFile(`${application.clientSrcDir}app/account/activate/activate.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/activate/activate.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/password-reset/finish/password-reset-finish.component.html`);
    this.removeFile(`${application.clientSrcDir}app/account/password-reset/finish/password-reset-finish.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/password-reset/finish/password-reset-finish.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/password-reset/init/password-reset-init.component.html`);
    this.removeFile(`${application.clientSrcDir}app/account/password-reset/init/password-reset-init.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/password-reset/init/password-reset-init.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/password/password-strength-bar/password-strength-bar.component.html`);
    this.removeFile(`${application.clientSrcDir}app/account/password/password-strength-bar/password-strength-bar.component.scss`);
    this.removeFile(`${application.clientSrcDir}app/account/password/password-strength-bar/password-strength-bar.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/password/password-strength-bar/password-strength-bar.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/password/password.component.html`);
    this.removeFile(`${application.clientSrcDir}app/account/password/password.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/password/password.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/register/register.component.html`);
    this.removeFile(`${application.clientSrcDir}app/account/register/register.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/register/register.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/sessions/sessions.component.html`);
    this.removeFile(`${application.clientSrcDir}app/account/sessions/sessions.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/sessions/sessions.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/settings/settings.component.html`);
    this.removeFile(`${application.clientSrcDir}app/account/settings/settings.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/account/settings/settings.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/configuration/configuration.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/configuration/configuration.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/configuration/configuration.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/docs/docs.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/docs/docs.component.scss`);
    this.removeFile(`${application.clientSrcDir}app/admin/docs/docs.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/gateway/gateway.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/gateway/gateway.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/health/health.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/health/health.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/health/health.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/health/modal/health-modal.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/health/modal/health-modal.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/health/modal/health-modal.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/logs/logs.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/logs/logs.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/logs/logs.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/jvm-memory/jvm-memory.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/jvm-memory/jvm-memory.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-cache/metrics-cache.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-cache/metrics-cache.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-datasource/metrics-datasource.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-datasource/metrics-datasource.component.ts`);
    this.removeFile(
      `${application.clientSrcDir}app/admin/metrics/blocks/metrics-endpoints-requests/metrics-endpoints-requests.component.html`,
    );
    this.removeFile(
      `${application.clientSrcDir}app/admin/metrics/blocks/metrics-endpoints-requests/metrics-endpoints-requests.component.ts`,
    );
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-garbagecollector/metrics-garbagecollector.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-garbagecollector/metrics-garbagecollector.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-modal-threads/metrics-modal-threads.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-modal-threads/metrics-modal-threads.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-modal-threads/metrics-modal-threads.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-request/metrics-request.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-request/metrics-request.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-system/metrics-system.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-system/metrics-system.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/metrics.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/metrics.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/metrics/metrics.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/tracker/tracker.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/tracker/tracker.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/delete/user-management-delete-dialog.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/delete/user-management-delete-dialog.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/delete/user-management-delete-dialog.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/detail/user-management-detail.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/detail/user-management-detail.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/detail/user-management-detail.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/list/user-management.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/list/user-management.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/list/user-management.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/update/user-management-update.component.html`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/update/user-management-update.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/admin/user-management/update/user-management-update.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/home/home.component.html`);
    this.removeFile(`${application.clientSrcDir}app/home/home.component.scss`);
    this.removeFile(`${application.clientSrcDir}app/home/home.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/home/home.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/layouts/error/error.component.html`);
    this.removeFile(`${application.clientSrcDir}app/layouts/error/error.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/layouts/footer/footer.component.html`);
    this.removeFile(`${application.clientSrcDir}app/layouts/footer/footer.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/layouts/main/main.component.html`);
    this.removeFile(`${application.clientSrcDir}app/layouts/main/main.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/layouts/main/main.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/layouts/navbar/navbar.component.html`);
    this.removeFile(`${application.clientSrcDir}app/layouts/navbar/navbar.component.scss`);
    this.removeFile(`${application.clientSrcDir}app/layouts/navbar/navbar.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/layouts/navbar/navbar.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/layouts/profiles/page-ribbon.component.scss`);
    this.removeFile(`${application.clientSrcDir}app/layouts/profiles/page-ribbon.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/layouts/profiles/page-ribbon.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/login/login.component.html`);
    this.removeFile(`${application.clientSrcDir}app/login/login.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/login/login.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/shared/alert/alert-error.component.html`);
    this.removeFile(`${application.clientSrcDir}app/shared/alert/alert-error.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/shared/alert/alert-error.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/shared/alert/alert.component.html`);
    this.removeFile(`${application.clientSrcDir}app/shared/alert/alert.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/shared/alert/alert.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/shared/filter/filter.component.html`);
    this.removeFile(`${application.clientSrcDir}app/shared/filter/filter.component.ts`);
    this.removeFile(`${application.clientSrcDir}app/shared/pagination/item-count.component.spec.ts`);
    this.removeFile(`${application.clientSrcDir}app/shared/pagination/item-count.component.ts`);
  }
});
