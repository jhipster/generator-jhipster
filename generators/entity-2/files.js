...
function writeFiles() {
    return {
        ...
        writeEnumFiles: function() {
            for (var idx in this.fields) {
                ...
                if (field.fieldIsEnum === true) {
                    ...
                    // Copy for each
                    if (!this.skipClient) {
                        this.template(ANGULAR_DIR + 'entities/_entity.enum.ts', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + fieldType + '.enum.ts', enumInfo, {});
        ...
        writeClientFiles: function () {
            ...
            this.copyHtml(ANGULAR_DIR + 'entities/_entity-management.component.html', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-management.component.html', this, {}, true);
            this.copyHtml(ANGULAR_DIR + 'entities/_entity-management-detail.component.html', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-management-detail.component.html', this, {}, true);
            this.copyHtml(ANGULAR_DIR + 'entities/_entity-management-dialog.component.html', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-management-dialog.component.html', this, {}, true);
            this.copyHtml(ANGULAR_DIR + 'entities/_entity-management-delete-dialog.component.html', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-management-delete-dialog.component.html', this, {}, true);

            this.addEntityToMenu(this.entityStateName, this.enableTranslation);

            this.template(ANGULAR_DIR + 'entities/_entity-management.state.ts', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '.state.ts', this, {});
            this.template(ANGULAR_DIR + 'entities/_entity.model.ts', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '.model.ts', this, {});
            this.template(ANGULAR_DIR + 'entities/_entity-management.component.ts', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-management.component' + '.ts', this, {});
            this.template(ANGULAR_DIR + 'entities/_entity-management-dialog.component.ts', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-management-dialog.component' + '.ts', this, {});
            this.template(ANGULAR_DIR + 'entities/_entity-management-delete-dialog.component.ts', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-management-delete-dialog.component' + '.ts', this, {});
            this.template(ANGULAR_DIR + 'entities/_entity-management-detail.component.ts', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-management-detail.component' + '.ts', this, {});
            this.template(ANGULAR_DIR + 'entities/_entity.service.ts', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityServiceFileName + '.service' + '.ts', this, {});
            if (this.searchEngine === 'elasticsearch') {
                this.template(ANGULAR_DIR + 'entities/_entity-search.service.ts', ANGULAR_DIR + 'entities/' + this.entityFolderName + '/' + this.entityServiceFileName + '.search.service' + '.ts', this, {});
            }
