...
type GeneratorsByNamespace = {
  ...
  deployment: import('./deployment/generator.ts').default;
  'jhipster:deployment': import('./deployment/generator.ts').default;
  ...
  'jhipster:spring-boot:graalvm': import('./spring-boot/generators/graalvm/generator.ts').default;
