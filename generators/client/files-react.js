    ...
    image: [
        {
            ...
            templates: [
                ...
                { file: 'static/images/hipster-man-1.png', method: 'copy' },
                { file: 'static/images/hipster-man-12x.png', method: 'copy' },
                { file: 'static/images/hipster-man-2.png', method: 'copy' },
                { file: 'static/images/hipster-man-22x.png', method: 'copy' },
                { file: 'static/images/hipster-woman-1.png', method: 'copy' },
                { file: 'static/images/hipster-woman-12x.png', method: 'copy' },
                { file: 'static/images/hipster-woman-2.png', method: 'copy' },
                { file: 'static/images/hipster-woman-22x.png', method: 'copy' },
