...
const vueFiles = {
    ...
    clientTestFw: [
        ...
        },
        {
            condition: generator => generator.enableTranslation,
            path: VUE_DIR,
            templates: ['shared/config/formatter.spec.ts'],
        },
        {
            condition: generator => generator.authenticationType === 'oauth2',
            path: VUE_DIR,
            templates: ['account/login.service.spec.ts'],
        },
        {
            condition: generator => generator.authenticationType !== 'oauth2',
            path: VUE_DIR,
            templates: ['account/login-form/login-form.component.spec.ts'],
        },
        {
            condition: generator => generator.authenticationType === 'session' && !generator.skipUserManagement,
            path: VUE_DIR,
            templates: ['account/sessions/sessions.component.spec.ts', 'account/login.service.spec.ts'],
        },
        {
            condition: generator => !generator.skipUserManagement,
            path: VUE_DIR,
        ...
        },
        {
            condition: generator => generator.websocket === 'spring-websocket',
            path: VUE_DIR,
            templates: ['admin/tracker/tracker.component.spec.ts', 'admin/tracker/tracker.service.spec.ts'],
        },
        {
            condition: generator => !generator.skipUserManagement,
            path: VUE_DIR,
        ...
        },
        {
            condition: generator => generator.applicationType === 'gateway' && generator.serviceDiscoveryType,
            path: VUE_DIR,
            templates: ['admin/gateway/gateway.component.spec.ts'],
        },
        {
            condition: generator => generator.protractorTests,
