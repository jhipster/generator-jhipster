    ...
    image: [
        {
            ...
            templates: [
                ...
                { file: 'content/images/hipster-man-12x.png', method: 'copy' },
                { file: 'content/images/hipster-man-2.png', method: 'copy' },
                { file: 'content/images/hipster-man-22x.png', method: 'copy' },
                { file: 'content/images/hipster-woman-1.png', method: 'copy' },
                { file: 'content/images/hipster-woman-12x.png', method: 'copy' },
                { file: 'content/images/hipster-woman-2.png', method: 'copy' },
                { file: 'content/images/hipster-woman-22x.png', method: 'copy' },
