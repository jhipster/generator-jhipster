...
import ChangePassword from '@/components/account/change-password/change-password.vue';
import ChangePasswordClass from '@/components/account/change-password/change-password.component';
