      ...
      <div>
        <Pagination>
          <PaginationItem {... activePage === 1 && { disabled: true }}>
            <PaginationLink onClick={this.updateActivePage(1)} href="javascript:void(0)">««</PaginationLink>
          </PaginationItem>
          <PaginationItem {... activePage === 1 && { disabled: true }}>
          ...
          <PaginationItem {... activePage === items && { disabled: true }}>
            <PaginationLink onClick={this.updateActivePage(items)} href="javascript:void(0)">»»</PaginationLink>
          </PaginationItem>
        </Pagination>
      </div>
    );
