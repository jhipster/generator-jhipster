                    ...
                    <td>
                      {
                        user.activated ? (
                          <span
                            className="badge badge-success" ng-click="vm.setActive(user, false)" ng-show="user.activated"
                            style={{ cursor: 'pointer' }}
                          >Activated</span>
                        ) : (
                          <span
                            className="badge badge-danger" ng-click="vm.setActive(user, true)" ng-show="!user.activated"
                            style={{ cursor: 'pointer' }}
                          >Deactivated</span>
                        )
                      }
