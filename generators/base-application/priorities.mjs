import { PRIORITY_PREFIX, QUEUE_PREFIX, PRIORITY_NAMES as PRIORITY_NAMES2, QUEUES as QUEUES2 } from '../base/priorities.mjs';

const { DEFAULT, TRANSFORM, PRE_CONFLICTS } = PRIORITY_NAMES2;
...
export const PRIORITY_NAMES_LIST = [
  ...
  POST_WRITING_ENTITIES,
  PRIORITY_NAMES2.INSTALL,
  PRIORITY_NAMES2.POST_INSTALL,
  PRIORITY_NAMES2.END,
];
