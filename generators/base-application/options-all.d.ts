...
export type ApplicationOptions = Simplify<
  ExportGeneratorOptionsFromCommand<typeof import('../app/command.ts').default> &
    ...
    ExportGeneratorOptionsFromCommand<typeof import('../javascript/generators/bootstrap/command.ts').default> &
    ExportGeneratorOptionsFromCommand<typeof import('../javascript/generators/prettier/command.ts').default> &
