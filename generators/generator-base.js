...
module.exports = class extends PrivateBase {
    ...
    setupClientOptions(generator, context = generator) {
        ...
        generator.cacheProvider = context.options['cache-provider'] || context.config.get('cacheProvider') || this.config.get('hibernateCache');;
        generator.enableHibernateCache = context.options['hb-cache'] || context.config.get('enableHibernateCache');
