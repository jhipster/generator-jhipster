...
describe('generator - base - with blueprint with constructor error', () => {
  class BlueprintBlueprintedGenerator extends BaseGenerator<any, any, any, any, any, any, any, any, any> {
...
describe('generator - base-blueprint', () => {
  ...
  const createAllBlueprint = mockedPriorities => {
     ...
     */
    return class extends BaseGenerator<any, any, any, any, any, any, any, any, any> {
      get initializing() {
        return {
          mockedInitializing() {
