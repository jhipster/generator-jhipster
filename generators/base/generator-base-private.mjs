...
import { destinationPath } from './logic/output/path.mjs';
...
export default class PrivateBase extends Generator {
  ...
  destinationPath(...paths) {
    return destinationPath(this, paths, updatedPaths => super.destinationPath(updatedPaths), this.options, this.configOptions);
  }
