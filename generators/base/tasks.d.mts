...
export type GenericSourceTypeDefinition<SourceType = Record<string, (...args: any[]) => any>> = { sourceType: SourceType };
...
export type BaseGeneratorDefinition<
  Definition extends GenericSourceTypeDefinition = { sourceType: Record<string, (...args: any[]) => any> }
> = Record<
