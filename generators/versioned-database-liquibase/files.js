...
const { INTERPOLATE_REGEX, SERVER_MAIN_RES_DIR } = require('../generator-constants');
...
const fakeFiles = {
    fakeData: [
        ...
        {
            condition: generator => generator.fieldsContainImageBlob === true || generator.fieldsContainBlob === true,
            path: SERVER_MAIN_RES_DIR,
            templates: [{ file: 'config/liquibase/fake-data/blob/hipster.png', method: 'copy', noEjs: true }],
        },
        {
            condition: generator => generator.fieldsContainTextBlob === true,
            path: SERVER_MAIN_RES_DIR,
