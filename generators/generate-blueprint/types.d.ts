 ...
 */
export type BlueprintConfig = BaseSimpleApplicationConfig & {
...
export type BlueprintApplication = BlueprintConfig &
  BaseSimpleApplicationApplication & { commands: string[]; blueprintsPath?: string; js?: boolean };

export type BlueprintOptions = BaseSimpleApplicationOptions &
