    ...
    return this.asWritingTaskGroup({
      async cleanup({ application, control }) {
        await control.cleanupFiles({
          '9.2.1': [
            `${application.javaPackageSrcDir}config/Neo4jTestContainersSpringContextCustomizerFactory.java`,
          ...
          annotations: [
            {
              ...
              parameters: (_, cb) => cb.addKeyValue('classes', 'Neo4jTestContainer.class'),
            },
          ],
        });
      },
