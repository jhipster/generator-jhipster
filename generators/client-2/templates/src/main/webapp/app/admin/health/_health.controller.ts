...
export function <%=jhiPrefixCapitalized%>HealthCheckController (<%=jhiPrefixCapitalized%>HealthService, $uibModal) {
    var vm = this;
    ...
    function refresh () {
        ...
        <%=jhiPrefixCapitalized%>HealthService.checkHealth().subscribe(health => {
            vm.healthData = <%=jhiPrefixCapitalized%>HealthService.transformHealthData(health);
