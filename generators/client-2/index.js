...
module.exports = JhipsterClientGenerator.extend({
    ...
    writing: {
        ...
        writeAngularUserMgmntFiles: function () {
            ...
            this.template(ANGULAR_DIR + 'admin/user-management/_user-management-dialog.component.ts', ANGULAR_DIR + 'admin/user-management/user-management-dialog.component.ts', this, {});
            this.template(ANGULAR_DIR + 'admin/user-management/_user-management-delete-dialog.component.ts', ANGULAR_DIR + 'admin/user-management/user-management-delete-dialog.component.ts', this, {});
