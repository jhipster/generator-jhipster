  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      Object.defineProperty(e, '__esModule', { value: !0 }),
        ...
        (e.isES2015MapSupported = function() {
    ...
    function(t, e, n) {
        ...
        s = (function() {
          ...
          return (
            (t.prototype.accept = function(t) {
              t.visit(this),
                o.forEach(this.definition, function(e) {
                  e.accept(t);
                });
            }),
            t
      ...
      function y(t) {
        ...
        if (t instanceof c) return { type: 'NonTerminal', name: t.nonTerminalName, idx: t.idx };
        ...
        if (t instanceof f)
          return {
            ...
            name: t.name,
            idx: t.idx,
            separator: y(new T({ terminalType: t.separator })),
        ...
        if (t instanceof d) return { type: 'Repetition', name: t.name, idx: t.idx, definition: e(t.definition) };
        if (t instanceof m) return { type: 'Alternation', name: t.name, idx: t.idx, definition: e(t.definition) };
        if (t instanceof T) {
          var n = {
              type: 'Terminal',
        ...
        if (t instanceof u) return { type: 'Rule', name: t.name, orgText: t.orgText, definition: e(t.definition) };
    ...
    function(t, e, n) {
      ...
      var o = n(0),
        ...
        d = n(5);
      function E(t) {
        return c.getProductionDslName(t) + '_#_' + t.idx + '_#_' + m(t);
      }
      function m(t) {
        return t instanceof f.Terminal
          ? u.tokenName(t.terminalType)
      ...
      (e.validateGrammar = function(t, e, n, r, i, p) {
        var h = o.map(t, function(t) {
          ...
          S = [];
        a.every(f, a.isEmpty) &&
          ((d = a.map(t, function(t) {
            return O(t, i);
          })),
          (g = a.map(t, function(t) {
            return _(t, e, r, i);
          })),
          (S = M(t, e, i)));
            ...
            return (
              a.forEach(t, function(t) {
                ...
                a.forEach(a.values(o), function(r) {
                  ...
                  n.push({ message: o, type: s.ParserDefinitionErrorType.DUPLICATE_NESTED_NAME, ruleName: t.name });
                });
              }),
              n
            );
          })(t, i),
          x = a.map(t, function(t) {
            return I(t, i);
          }),
          U = a.map(t, function(t) {
            return y(t, i);
          }),
          D = a.map(t, function(e) {
            return N(e, t, p, i);
          });
        return o.flatten(h.concat(C, k, P, S, f, d, g, L, x, U, D));
      }),
      ...
      function A(t, n, r) {
        ...
        return (
          n.name.match(e.validNestedRuleName) ||
            ...
            o.push({ message: i, type: s.ParserDefinitionErrorType.INVALID_NESTED_RULE_NAME, ruleName: t.name })),
          o
        );
      }
      function v(t, n) {
        var r = [];
        return (
          u.tokenName(t).match(e.validTermsPattern) ||
            r.push({
      ...
      function N(t, e, n, r) {
        ...
        if (
          ...
          i.push({ message: o, type: s.ParserDefinitionErrorType.DUPLICATE_RULE_NAME, ruleName: t.name });
        }
        return i;
      }
      function R(t, e, n, r) {
        ...
        var u = o.difference(a, r.concat([t])),
          p = o.map(u, function(e) {
            var i = o.cloneArr(r);
      ...
      function g(t) {
        ...
        if (n instanceof f.NonTerminal) e.push(n.referencedRule);
          ...
          e = e.concat(g(n.definition));
        else if (n instanceof f.Alternation)
          e = o.flatten(
            o.map(n.definition, function(t) {
              return g(t.definition);
            })
          );
        else if (!(n instanceof f.Terminal)) throw Error('non exhaustive match');
        var r = c.isOptionalProd(n),
          i = t.length > 1;
        if (r && i) {
          var a = o.drop(t);
          return e.concat(g(a));
        ...
        (e.validateRuleIsOverridden = function(t, e, n) {
          ...
          return (
            o.contains(e, t) ||
              ...
              i.push({ message: r, type: s.ParserDefinitionErrorType.INVALID_RULE_OVERRIDE, ruleName: t })),
            i
          );
        }),
        (e.validateNoLeftRecursion = R),
        (e.getFirstNoneTerminal = g);
      var S = (function(t) {
        function e() {
          var e = (null !== t && t.apply(this, arguments)) || this;
          ...
          function(n, r) {
            var i = o.dropRight(r.definition),
              a = o.map(i, function(n, i) {
                var a = h.nextPossibleTokensAfter([n], [], null, 1);
                return o.isEmpty(a)
                  ? {
                      message: e.buildEmptyAlternationError({ topLevelRule: t, alternation: r, emptyChoiceIdx: i }),
      ...
      function _(t, e, n, r) {
        var i = new S();
        t.accept(i);
        var u = i.alternations,
          l = n[t.name];
        return (
          l &&
            (u = a.reject(u, function(t) {
              return l[c.getProductionDslName(t) + (0 === t.idx ? '' : t.idx)];
            })),
          o.reduce(
            u,
            function(n, i) {
              var c = i.idx,
                u = p.getLookaheadPathsForOr(c, t, e),
                l = (function(t, e, n, r) {
                  var i = [],
                    c = a.reduce(
                      t,
                    ...
                    a.forEach(o, function(t) {
                      var c = t.idx,
                        ...
                        l = a.findAll(o, function(t) {
                          return t.idx < c && p.isStrictPrefixOfPath(t.path, u);
                        }),
      ...
      (e.validateEmptyOrAlternative = O), (e.validateAmbiguousAlternationAlternatives = _);
      var L = (function(t) {
        function e() {
          var e = (null !== t && t.apply(this, arguments)) || this;
          return (e.allProductions = []), e;
          ...
          a.forEach(t, function(t) {
            ...
            a.forEach(o, function(i) {
              var o = p.getProdType(i),
                c = i.idx,
                u = p.getLookaheadPathsForOptionalProd(c, t, o, e)[0];
              if (a.isEmpty(a.flatten(u))) {
                var l = n.buildEmptyRepetitionError({ topLevelRule: t, repetition: i });
                r.push({ message: l, type: s.ParserDefinitionErrorType.NO_NON_EMPTY_LOOKAHEAD, ruleName: t.name });
              }
            });
          }),
          r
      ...
      (e.RepetionCollector = L), (e.validateTooManyAlts = I), (e.validateSomeNonEmptyLookaheadPath = M);
    },
    function(t, e, n) {
      'use strict';
      var r,
          ...
          return (
            ...
            !!(e instanceof a.Option || e instanceof a.Repetition || e instanceof a.RepetitionWithSeparator) ||
              (e instanceof a.Alternation
                ? o.some(e.definition, function(e) {
                    return t(e, n);
                  })
                : !(e instanceof a.NonTerminal && o.contains(n, e)) &&
                  e instanceof a.AbstractProduction &&
                  (e instanceof a.NonTerminal && n.push(e),
                  o.every(e.definition, function(e) {
                    return t(e, n);
                  })))
          );
        }),
      ...
      var u = (function(t) {
        ...
        return (
          i(e, t),
          (e.prototype.visitTerminal = function(t) {
            var e = c.tokenName(t.terminalType) + this.separator + 'Terminal';
      ...
      e.DslMethodsCollectorVisitor = u;
    },
    function(t, e, n) {
      'use strict';
      Object.defineProperty(e, '__esModule', { value: !0 });
        ...
        O = (function() {
          function t(t, e) {
            if (
              ...
              (this.CST_STACK = []),
              (this.tokensMap = {}),
              (this.lookAheadFuncsCache = a.isES2015MapSupported() ? new Map() : []),
            ...
            if (
              ((this.recoveryEnabled = a.has(e, 'recoveryEnabled') ? e.recoveryEnabled : R.recoveryEnabled),
              this.recoveryEnabled || (this.attemptInRepetitionRecovery = a.NOOP),
              (this.dynamicTokensEnabled = a.has(e, 'dynamicTokensEnabled')
                ? e.dynamicTokensEnabled
                : R.dynamicTokensEnabled),
              (this.maxLookahead = a.has(e, 'maxLookahead') ? e.maxLookahead : R.maxLookahead),
              (this.ignoredIssues = a.has(e, 'ignoredIssues') ? e.ignoredIssues : R.ignoredIssues),
              (this.outputCst = a.has(e, 'outputCst') ? e.outputCst : R.outputCst),
              (this.errorMessageProvider = a.defaults(e.errorMessageProvider, R.errorMessageProvider)),
              (this.serializedGrammar = a.has(e, 'serializedGrammar') ? e.serializedGrammar : R.serializedGrammar),
              a.isES2015MapSupported()
            ...
            else if (a.has(t, 'modes') && a.every(a.flatten(a.values(t.modes)), f.isTokenType)) {
              var n = a.flatten(a.values(t.modes)),
                r = a.uniq(n);
              this.tokensMap = a.reduce(
                r,
                function(t, e) {
              ...
              this.tokensMap = a.cloneObj(t);
            }
            var o = a.every(a.values(t), function(t) {
              return a.isEmpty(t.categoryMatches);
            });
            (this.tokenMatcher = o ? f.tokenStructuredMatcherNoCategories : f.tokenStructuredMatcher),
          ...
          return (
            ...
            (t.prototype.atLeastOneInternal = function(t, e) {
              var n = this.getKeyForAutomaticLookahead(E.AT_LEAST_ONE_IDX, t),
            ...
            (t.prototype.atLeastOneInternalLogic = function(t, e, n) {
              var r,
                i,
                o = this,
                a = this.getLookaheadFuncForAtLeastOne(n, t);
              if (void 0 !== e.DEF) {
              ...
              for (r.call(this); !0 === a.call(this); ) this.doSingleRepetition(r);
            ...
            (t.prototype.atLeastOneSepFirstInternal = function(t, e) {
              var n = this.getKeyForAutomaticLookahead(E.AT_LEAST_ONE_SEP_IDX, t),
                r = this.nestedRuleBeforeClause(e, n);
              try {
            ...
            (t.prototype.atLeastOneSepFirstInternalLogic = function(t, e, n) {
              ...
              this.attemptInRepetitionRecovery(
                ...
                [t, o, a, i, l.NextTerminalAfterAtLeastOneSepWalker],
                a,
            ...
            (t.prototype.manyInternal = function(t, e) {
              var n = this.getKeyForAutomaticLookahead(E.MANY_IDX, t),
                r = this.nestedRuleBeforeClause(e, n);
              try {
            ...
            (t.prototype.manyInternalLogic = function(t, e, n) {
              var r,
                i,
                o = this,
                a = this.getLookaheadFuncForMany(n, t);
              if (void 0 !== e.DEF) {
                if (((r = e.DEF), void 0 !== (i = e.GATE))) {
                  var s = a;
                  a = function() {
              ...
              for (; a.call(this); ) this.doSingleRepetition(r);
              this.attemptInRepetitionRecovery(
                this.manyInternal,
                [t, e],
                a,
            ...
            (t.prototype.manySepFirstInternal = function(t, e) {
              var n = this.getKeyForAutomaticLookahead(E.MANY_SEP_IDX, t),
                r = this.nestedRuleBeforeClause(e, n);
              try {
            ...
            (t.prototype.manySepFirstInternalLogic = function(t, e, n) {
              ...
              if (!0 === this.getLookaheadFuncForManySep(n, t).call(this)) {
                ...
                this.attemptInRepetitionRecovery(
                  this.repetitionSepSecondInternal,
                  [t, o, a, i, l.NextTerminalAfterManySepWalker],
                  a,
                  E.MANY_SEP_IDX,
                  t,
            ...
            (t.prototype.getLookaheadFuncFor = function(t, e, n, r) {
              var i = this.getLaFuncFromCache(t);
              if (void 0 === i) {
      ...
      var s = (function() {
        ...
        return (
          ...
          (t.prototype.tokenizeInternal = function(t, e) {
            ...
            for (b.call(this, e); A < y; ) {
              ...
              for (n = 0; n < G; n++) {
                ...
                if (
                  (!1 !== (Z = U.short)
                    ? w === Z && (c = K)
                    : !0 === U.isCustom
                      ? (c = null !== (E = K.exec(T, A, R, _)) ? E[0] : E)
                      : (this.updateLastIndex(K, A), (c = this.match(K, t, A))),
                  null !== c)
                ) {
                  if (void 0 !== (s = U.longerAlt)) {
                    var V = C[s],
                      Y = V.pattern;
                    !0 === V.isCustom
                      ? (a = null !== (E = Y.exec(T, A, R, _)) ? E[0] : E)
                      : (this.updateLastIndex(Y, A), (a = this.match(Y, t, A))),
              ...
              if (null !== c) {
                if (
                  ...
                  void 0 !== (p = U.group) &&
                    ((l = U.tokenTypeIdx),
                    (h = this.createTokenInstance(c, A, l, U.tokenType, S, O, u)),
                    !1 === p ? (v = this.addToken(R, v, h)) : _[p].push(h)),
                ...
                this.handleModes(U, F, b, h);
              } else {
                for (var X = A, z = S, $ = O, q = !1; !q && A < y; )
                  for (T.charCodeAt(A), t = this.chopInput(t, 1), A++, o = 0; o < M; o++) {
                    var Z,
                      Q = C[o];
                    K = Q.pattern;
                    if (
                      (!1 !== (Z = Q.short)
                        ? T.charCodeAt(A) === Z && (q = !0)
                        : !0 === Q.isCustom
                          ? (q = null !== K.exec(T, A, R, _))
                          : (this.updateLastIndex(K, A), (q = null !== K.exec(t))),
                      !0 === q)
                    )
                      break;
                  }
            ...
            return this.hasCustom || (R.length = v), { tokens: R, groups: _, errors: g };
          }),
        ...
        return (
          ...
          (e.prototype.walkTerminal = function(t, e, n) {
            if (
              ...
              var r = e.concat(n),
                i = new u.Flat({ definition: r });
              (this.possibleTokTypes = c.first(i)), (this.found = !0);
            }
          }),
          e
        );
          ...
          (e.prototype.walkMany = function(e, n, r) {
            if (e.idx === this.occurrence) {
              ...
              (this.result.isEndOfRule = void 0 === i),
                i instanceof u.Terminal && ((this.result.token = i.terminalType), (this.result.occurrence = i.idx));
      ...
      (e.NextTerminalAfterAtLeastOneSepWalker = m),
        (e.possiblePathsFrom = function t(e, n, r) {
          ...
          var i = [],
            o = 0;
          function s(s) {
            var c = t(s.concat(a.drop(e, o + 1)), n, r);
            return i.concat(c);
          }
          for (; r.length < n && o < e.length; ) {
            var c = e[o];
            if (c instanceof u.Flat) return s(c.definition);
            if (c instanceof u.NonTerminal) return s(c.definition);
            if (c instanceof u.Option) i = s(c.definition);
            else {
              if (c instanceof u.RepetitionMandatory) return s(c.definition);
              if (c instanceof u.RepetitionMandatoryWithSeparator)
                return s(
                  (p = [
                    new u.Flat({ definition: c.definition }),
                    new u.Repetition({
                      definition: [new u.Terminal({ terminalType: c.separator })].concat(c.definition)
                    })
                  ])
                );
              if (c instanceof u.RepetitionWithSeparator) {
                var p = c.definition.concat([
                  new u.Repetition({ definition: [new u.Terminal({ terminalType: c.separator })].concat(c.definition) })
                ]);
                i = s(p);
              } else if (c instanceof u.Repetition) i = s(c.definition);
              else {
                if (c instanceof u.Alternation)
                  return (
                    a.forEach(c.definition, function(t) {
                      i = s(t.definition);
                    }),
                    i
                  );
                if (!(c instanceof u.Terminal)) throw Error('non exhaustive match');
            ...
            if ('EXIT_ALTERNATIVE' !== h) {
              ...
              if (!a.isEmpty(f)) {
                ...
                if ('EXIT_NONE_TERMINAL' === y) {
                  var A = { idx: d, def: a.drop(f), ruleStack: a.dropRight(E), occurrenceStack: a.dropRight(m) };
                  l.push(A);
                } else if (y instanceof u.Terminal)
                  if (d < s - 1) {
                    var v = d + 1;
                    n(e[v], y.terminalType) &&
                      ((A = { idx: v, def: a.drop(f), ruleStack: E, occurrenceStack: m }), l.push(A));
                  } else {
                ...
                else if (y instanceof u.NonTerminal) {
                  var N = a.cloneArr(E);
                  N.push(y.nonTerminalName);
                  var R = a.cloneArr(m);
                  R.push(y.idx),
                    (A = { idx: d, def: y.definition.concat(i, a.drop(f)), ruleStack: N, occurrenceStack: R }),
                    l.push(A);
                } else if (y instanceof u.Option) {
                  var g = { idx: d, def: a.drop(f), ruleStack: E, occurrenceStack: m };
                  l.push(g), l.push('EXIT_ALTERNATIVE');
                  var S = { idx: d, def: y.definition.concat(a.drop(f)), ruleStack: E, occurrenceStack: m };
                  l.push(S);
                } else if (y instanceof u.RepetitionMandatory) {
                  var O = new u.Repetition({ definition: y.definition, idx: y.idx });
                  (A = { idx: d, def: y.definition.concat([O], a.drop(f)), ruleStack: E, occurrenceStack: m }),
                    l.push(A);
                } else if (y instanceof u.RepetitionMandatoryWithSeparator) {
                  var _ = new u.Terminal({ terminalType: y.separator });
                  (O = new u.Repetition({ definition: [_].concat(y.definition), idx: y.idx })),
                    (A = { idx: d, def: y.definition.concat([O], a.drop(f)), ruleStack: E, occurrenceStack: m }),
                    l.push(A);
                } else if (y instanceof u.RepetitionWithSeparator) {
                  (g = { idx: d, def: a.drop(f), ruleStack: E, occurrenceStack: m }),
                    l.push(g),
                    l.push('EXIT_ALTERNATIVE'),
                    (_ = new u.Terminal({ terminalType: y.separator }));
                  var L = new u.Repetition({ definition: [_].concat(y.definition), idx: y.idx });
                  (S = { idx: d, def: y.definition.concat([L], a.drop(f)), ruleStack: E, occurrenceStack: m }),
                    l.push(S);
                } else if (y instanceof u.Repetition)
                  (g = { idx: d, def: a.drop(f), ruleStack: E, occurrenceStack: m }),
                    l.push(g),
                    l.push('EXIT_ALTERNATIVE'),
                    (L = new u.Repetition({ definition: y.definition, idx: y.idx })),
                    (S = { idx: d, def: y.definition.concat([L], a.drop(f)), ruleStack: E, occurrenceStack: m }),
                    l.push(S);
                else if (y instanceof u.Alternation)
                  for (var I = y.definition.length - 1; I >= 0; I--) {
                    var M = {
                      idx: d,
                      def: y.definition[I].definition.concat(a.drop(f)),
                      ruleStack: E,
                      occurrenceStack: m
                    };
                    l.push(M), l.push('EXIT_ALTERNATIVE');
                  }
                else if (y instanceof u.Flat)
                  l.push({ idx: d, def: y.definition.concat(a.drop(f)), ruleStack: E, occurrenceStack: m });
                else {
                  if (!(y instanceof u.Rule)) throw Error('non exhaustive match');
                  l.push(T(y, d, E, m));
                }
              }
            } else o && a.last(l).idx <= c && l.pop();
          }
          return p;
        });
    },
        ...
        (e.defaultGrammarValidatorErrorProvider = {
          buildDuplicateFoundError: function(t, e) {
            var n,
              ...
              c = o.first(e),
              u = c.idx,
              p = s.getProductionDslName(c),
              l =
                (n = c) instanceof a.Terminal
    ...
    function(t, e, n) {
      'use strict';
      Object.defineProperty(e, '__esModule', { value: !0 }), (e.VERSION = '4.1.0');
    },
    function(t, e, n) {
      'use strict';
      Object.defineProperty(e, '__esModule', { value: !0 });
    ...
    function(t, e, n) {
      ...
      !(function(t) {
        ...
        (e.buildLookaheadFuncForOr = function(t, e, n, r, i, o) {
          var a = E(t, e, n);
          return o(a, r, y(a) ? u.tokenStructuredMatcherNoCategories : u.tokenStructuredMatcher, i);
        }),
        (e.buildLookaheadFuncForOptionalProd = function(t, e, n, r, i, o) {
          var a = m(t, e, i, n),
            s = y(a) ? u.tokenStructuredMatcherNoCategories : u.tokenStructuredMatcher;
          return o(a[0], s, r);
        }),
                  ...
                  return (
                    a.forEach(e, function(e) {
                      a.has(t, e.tokenTypeIdx) || (t[e.tokenTypeIdx] = n),
                        a.forEach(e.categoryMatches, function(e) {
                          a.has(t, e) || (t[e] = n);
                        });
                    }),
                    t
          ...
          for (var h = 0; h < l.length; h++)
            for (var f = l[h], d = n(l, h), E = 0; E < f.length; E++) {
              var m = f[E].partialPath,
                y = f[E].suffixDef;
              if (r(d, m) || a.isEmpty(y) || m.length === e) {
                var A = c[h];
                T(A, m) || A.push(m);
              } else {
                var v = s.possiblePathsFrom(y, p + 1, m);
                u[h] = u[h].concat(v);
              }
            }
        }
    ...
    function(t, e, n) {
        ...
        return (
          ...
          (e.prototype.collectNamedDSLMethod = function(t, e, n) {
            if (!o.isUndefined(t.name)) {
              var r = void 0;
              if (
                t instanceof c.Option ||
                t instanceof c.Repetition ||
                t instanceof c.RepetitionMandatory ||
                t instanceof c.Alternation
              )
                r = new e({ definition: t.definition, idx: t.idx });
              else {
                if (!(t instanceof c.RepetitionMandatoryWithSeparator || t instanceof c.RepetitionWithSeparator))
                  throw Error('non exhaustive match');
          ...
          (e.prototype.visitOption = function(t) {
            this.collectNamedDSLMethod(t, c.Option, s.OPTION_IDX);
          }),
          (e.prototype.visitRepetition = function(t) {
            this.collectNamedDSLMethod(t, c.Repetition, s.MANY_IDX);
          }),
          (e.prototype.visitRepetitionMandatory = function(t) {
            this.collectNamedDSLMethod(t, c.RepetitionMandatory, s.AT_LEAST_ONE_IDX);
          }),
          (e.prototype.visitRepetitionMandatoryWithSeparator = function(t) {
            this.collectNamedDSLMethod(t, c.RepetitionMandatoryWithSeparator, s.AT_LEAST_ONE_SEP_IDX);
          }),
          (e.prototype.visitRepetitionWithSeparator = function(t) {
            this.collectNamedDSLMethod(t, c.RepetitionWithSeparator, s.MANY_SEP_IDX);
          }),
          (e.prototype.visitAlternation = function(t) {
            var e = this;
            this.collectNamedDSLMethod(t, c.Alternation, s.OR_IDX);
            var n = t.definition.length > 1;
            o.forEach(t.definition, function(r, i) {
              if (!o.isUndefined(r.name)) {
                var a = r.definition;
                a = n ? [new c.Option({ definition: r.definition })] : r.definition;
                var u = s.getKeyForAltIndex(e.ruleIdx, s.OR_IDX, t.idx, i);
                e.result.push({ def: a, key: u, name: r.name, orgProd: r });
              }
            });
          }),
          e
      ...
      (e.NamedDSLMethodsCollectorVisitor = p),
        (e.analyzeCst = function(t, e) {
          var n = { dictDef: new a.HashTable(), allRuleNames: [] };
          return (
    ...
    function(t, e, n) {
      const { tokens: r, JDLLexer: i } = n(7),
        { parse: o, getSyntacticAutoCompleteSuggestions: a } = n(38),
        s = n(11);
    ...
    function(t, e, n) {
      ...
      var o = n(19),
        ...
        l = 'PATTERN';
      function h(t) {
        var e = c.filter(t, function(t) {
          return !c.has(t, l);
        });
        return {
          errors: c.map(e, function(t) {
            return {
          ...
          valid: c.difference(t, e)
        };
      }
      function f(t) {
        var e = c.filter(t, function(t) {
          var e = t[l];
          return !(c.isRegExp(e) || c.isFunction(e) || c.has(e, 'exec') || c.isString(e));
        });
        return {
          errors: c.map(e, function(t) {
            return {
      ...
      (e.DEFAULT_MODE = 'defaultMode'),
        ...
        (e.analyzeTokenTypes = function(t, n) {
          ...
          var r = c.reject(t, function(t) {
              return t[l] === s.Lexer.NA;
            }),
            i = !1,
            o = c.map(r, function(t) {
              var e = t[l];
              if (c.isRegExp(e)) {
                var r = e.source;
                return 1 === r.length && '^' !== r && '$' !== r && '.' !== r
                  ...
                  : 2 !== r.length ||
                    '\\' !== r[0] ||
                    c.contains(['d', 'D', 's', 'S', 't', 'r', 'n', 't', '0', 'c', 'b', 'B', 'f', 'v', 'w', 'W'], r[1])
                    ? n.useSticky
                      ? O(e)
                      : S(e)
                    : r[1];
              }
              if (c.isFunction(e)) return (i = !0), { exec: e };
              if (c.has(e, 'exec')) return (i = !0), e;
              if ('string' == typeof e) {
                if (1 === e.length) return e;
                var o = e.replace(/[\\^$.*+?()[\]{}|]/g, '\\$&'),
                  a = new RegExp(o);
                return n.useSticky ? O(a) : S(a);
              }
              throw Error('non exhaustive match');
            }),
            p = c.map(r, function(t) {
              return t.tokenTypeIdx;
            }),
            h = c.map(r, function(t) {
              var e = t.GROUP;
              if (e !== s.Lexer.SKIPPED) {
                if (c.isString(e)) return e;
                if (c.isUndefined(e)) return !1;
                throw Error('non exhaustive match');
              }
            }),
            f = c.map(r, function(t) {
              var e = t.LONGER_ALT;
              if (e) return c.indexOf(r, e);
            }),
            d = c.map(r, function(t) {
              return t.PUSH_MODE;
            }),
            E = c.map(r, function(t) {
              return c.has(t, 'POP_MODE');
            }),
            m = C(n.lineTerminatorCharacters),
            T = c.map(r, function(t) {
              return !1;
            });
          'onlyOffset' !== n.positionTracking &&
            (T = c.map(r, function(t) {
              return c.has(t, 'LINE_BREAKS')
                ? t.LINE_BREAKS
                : !1 === I(t, m)
                  ? u.canMatchCharCode(m, t.PATTERN)
                  : void 0;
            }));
          var y = c.map(r, _),
            A = c.map(o, L),
            v = c.reduce(
              ...
              function(t, e) {
                var n = e.GROUP;
                return c.isString(n) && n !== s.Lexer.SKIPPED && (t[n] = []), t;
              },
              {}
            ),
            N = c.map(o, function(t, e) {
              return {
                pattern: o[e],
                longerAlt: f[e],
          ...
          return (
              ...
              (M = c.reduce(
                ...
                function(t, e, r) {
                  if ('string' == typeof e.PATTERN) {
                    ...
                    R(t, i, N[r]);
                  } else if (c.isArray(e.START_CHARS_HINT))
                    c.forEach(e.START_CHARS_HINT, function(e) {
                      var n = 'string' == typeof e ? e.charCodeAt(0) : e;
                      R(t, n, N[r]);
                    });
                  else if (c.isRegExp(e.PATTERN))
                    if (e.PATTERN.unicode)
                      (g = !1),
                        n.ensureOptimizations &&
                          c.PRINT_ERROR(
                            u.failedOptimizationPrefixMsg +
                              '\tUnable to analyze < ' +
                              e.PATTERN.toString() +
                              " > pattern.\n\tThe regexp unicode flag is not currently supported by the regexp-to-ast library.\n\tThis will disable the lexer's first char optimizations.\n\tFor details See: https://sap.github.io/chevrotain/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE"
                          );
                    else {
                      var o = u.getStartCodes(e.PATTERN, n.ensureOptimizations);
                      c.isEmpty(o) && (g = !1),
            ...
            g && M.length < 65536 && (M = c.packArray(M)),
            { emptyGroups: v, patternIdxToConfig: N, charCodeToPatternIdxToConfig: M, hasCustom: i, canBeOptimized: g }
          );
        }),
        (e.validatePatterns = function(t, e) {
          ...
          return (n = (n = (n = (n = (n = n.concat(i.errors)).concat(
            (function(t) {
              var e = [],
                n = c.filter(t, function(t) {
                  return c.isRegExp(t[l]);
                });
              return (e = (e = (e = (e = (e = e.concat(E(n))).concat(y(n))).concat(A(n))).concat(v(n))).concat(m(n)));
            })(o)
          )).concat(N(o))).concat(R(o, e))).concat(g(o)));
        }),
      ...
      function A(t) {
        ...
        return c.map(e, function(t) {
          return {
            message:
              'Token Type: ->' + a.tokenName(t) + "<- static 'PATTERN' may NOT contain global('g') or multiline('m')",
      ...
      function v(t) {
        var e = [],
          n = c.map(t, function(n) {
            return c.reduce(
              t,
              function(t, r) {
                return n.PATTERN.source !== r.PATTERN.source || c.contains(e, r) || r.PATTERN === s.Lexer.NA
                  ? t
                  : (e.push(r), t.push(r), t);
              },
              []
        ...
        n = c.compact(n);
        var r = c.filter(n, function(t) {
          return t.length > 1;
        });
        return c.map(r, function(t) {
          var e = c.map(t, function(t) {
      ...
      function N(t) {
        var e = c.filter(t, function(t) {
          if (!c.has(t, 'GROUP')) return !1;
          var e = t.GROUP;
          return e !== s.Lexer.SKIPPED && e !== s.Lexer.NA && !c.isString(e);
        });
        return c.map(e, function(t) {
          return {
            message:
              'Token Type: ->' + a.tokenName(t) + "<- static 'GROUP' can only be Lexer.SKIPPED/Lexer.NA/A String",
      ...
      function R(t, e) {
        var n = c.filter(t, function(t) {
          return void 0 !== t.PUSH_MODE && !c.contains(e, t.PUSH_MODE);
        });
        return c.map(n, function(t) {
          return {
            message:
            ...
            c.forEach(n, function(n) {
              ...
              if (
                ...
                (function(t, e) {
                  ...
                  if (c.isFunction(e)) return e(t, 0, [], {});
                  if (c.has(e, 'exec')) return e.exec(t, 0, [], {});
                ...
                e.push({ message: p, type: s.LexerDefinitionErrorType.UNREACHABLE_PATTERN, tokenTypes: [t, u] });
              }
            });
          }),
          e
      ...
      function L(t) {
        return !(!c.isString(t) || 1 !== t.length) && t.charCodeAt(0);
      }
      function I(t, e) {
        if (c.has(t, 'LINE_BREAKS')) return !1;
        if (c.isRegExp(t.PATTERN)) {
          try {
            u.canMatchCharCode(e, t.PATTERN);
          } catch (t) {
            return { issue: s.LexerDefinitionErrorType.IDENTIFY_TERMINATOR, errMsg: t.message };
          }
          return !1;
        }
        if (c.isString(t.PATTERN)) return !1;
        if (_(t)) return { issue: s.LexerDefinitionErrorType.CUSTOM_LINE_BREAK };
        throw Error('non exhaustive match');
      }
      function M(t, e) {
      ...
      function C(t) {
        return c.map(t, function(t) {
          return c.isString(t) && t.length > 0 ? t.charCodeAt(0) : t;
        });
      }
      (e.findStartOfInputAnchor = y),
        (e.findUnsupportedFlags = A),
        (e.findDuplicatePatterns = v),
        (e.findInvalidGroupType = N),
        (e.findModesThatDoNotExist = R),
        (e.findUnreachablePatterns = g),
        (e.addStartOfInput = S),
        (e.addStickyFlag = O),
        (e.performRuntimeChecks = function(t, n, r) {
          var i = [];
          return (
            c.has(t, e.DEFAULT_MODE) ||
              i.push({
                message:
            ...
            c.has(t, e.MODES) &&
              c.forEach(t.modes, function(t, e) {
                c.forEach(t, function(t, n) {
                  c.isUndefined(t) &&
                    i.push({
                      message:
        ...
        (e.performWarningRuntimeChecks = function(t, e, n) {
          var r = [],
            ...
            o = c.compact(
              c.flatten(
                c.mapValues(t.modes, function(t) {
                  return t;
                })
              )
            ),
            a = c.reject(o, function(t) {
              return t[l] === s.Lexer.NA;
            }),
            p = C(n);
          return (
            e &&
              c.forEach(a, function(t) {
                var e = I(t, p);
                if (!1 !== e) {
                  var n = { message: M(t, e), type: e.issue, tokenType: t };
                  r.push(n);
                } else c.has(t, 'LINE_BREAKS') ? !0 === t.LINE_BREAKS && (i = !0) : u.canMatchCharCode(p, t.PATTERN) && (i = !0);
              }),
            e &&
              !i &&
              r.push({
        ...
        (e.cloneEmptyGroups = function(t) {
          ...
          return (
            c.forEach(n, function(n) {
              var r = t[n];
              if (!c.isArray(r)) throw Error('non exhaustive match');
              e[n] = [];
            }),
            e
          );
        ...
        (e.buildLineBreakIssueMessage = M);
    },
    function(t, e, n) {
      'use strict';
      var r,
      ...
      var o = n(19),
        ...
        c = 'Complement Sets are not supported for first char optimization';
      function u(t) {
        switch (t.type) {
          case 'Disjunction':
            return a.flatten(a.map(t.value, u));
          case 'Alternative':
              ...
              if (
                ...
                switch (o.type) {
                  case 'Character':
                    ...
                    break;
                  case 'Set':
                    if (!0 === o.complement) throw Error(c);
                    a.forEach(o.value, function(t) {
                ...
                if (void 0 === o.quantifier || (void 0 !== o.quantifier && o.quantifier.atLeast > 0)) break;
              }
            }
            return e;
          default:
    ...
    function(t, e, n) {
      ...
      (e.ResyncFollowsWalker = h),
        ...
        (e.buildInProdFollowPrefix = function(t) {
          return p.tokenName(t.terminalType) + t.idx + u.IN;
        });
    },
    function(t, e, n) {
      'use strict';
      ...
      var s = /(?:\s*{\s*NAME\s*:\s*["'`]([\w$]*)["'`])?/,
        ...
        A = /\s*SEP\s*:\s*(?:[a-zA-Z_$]\w*\s*\.\s*)*([a-zA-Z_$]\w*)/,
        v = new RegExp(/\.\s*MANY_SEP(\d+)?\s*\(\s*{/.source + c.source + A.source),
        N = new RegExp(v.source, 'g'),
        R = new RegExp(/\.\s*AT_LEAST_ONE_SEP(\d+)?\s*\(\s*{/.source + c.source + A.source),
      ...
      function P(t, n) {
        switch (t.type) {
          ...
          case r.MANY_SEP:
            return (function(t, e) {
              return U(t, e, a.RepetitionWithSeparator, v);
            })(t, n);
          case r.MANY:
            return (function(t, e) {
      ...
      (e.terminalNameToConstructor = {}),
        ...
        (e.buildProdGast = P),
        (e.getDirectlyContainedRanges = F);
      var b = /\/\/.*/g,
        w = /\/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*+\//g,
      ...
      var c = (function(t) {
        ...
        return (
          ...
          (e.prototype.resolveRefs = function() {
            var t = this;
            a.forEach(this.nameToTopRule.values(), function(e) {
    ...
    function(t, e, n) {
      const r = n(6),
        { EOF: i } = n(3),
        { JDLLexer: o, tokens: a } = n(7),
        s = n(11),
        { performAdditionalSyntaxChecks: c } = n(39),
        { buildAst: u } = n(41),
        { checkTokens: p } = n(26);
      t.exports = {
        ...
        getSyntacticAutoCompleteSuggestions: function(t, e = 'prog') {
          const n = o.tokenize(t);
          l.input = n.tokens;
          const i = l.computeContentAssist(e, n.tokens);
          return r.uniq(i.map(t => t.nextTokenType));
        }
      };
      const l = s.getParser();
      l.parse();
      const h = l.getGAstProductions().values();
      p(r.values(a), h);
    },
    function(t, e, n) {
      const r = n(6),
        ...
        E = /^[a-z]+(-[A-Za-z0-9]+)*$/,
        m = {
          APPLICATION_TYPE: { type: 'NAME', pattern: /^[a-z]+$/, msg: 'applicationType property' },
          AUTHENTICATION_TYPE: { type: 'NAME', pattern: d, msg: 'authenticationType property' },
          BASE_NAME: { type: 'NAME', pattern: d, msg: 'baseName property' },
          BUILD_TOOL: { type: 'NAME', pattern: d, msg: 'buildTool property' },
          CACHE_PROVIDER: { type: 'NAME', pattern: d, msg: 'cacheProvider property' },
          CLIENT_FRAMEWORK: { type: 'NAME', pattern: d, msg: 'clientFramework property' },
          CLIENT_PACKAGE_MANAGER: { type: 'NAME', pattern: d, msg: 'clientPackageManager property' },
          DATABASE_TYPE: { type: 'NAME', pattern: d, msg: 'databaseType property' },
          DEV_DATABASE_TYPE: { type: 'NAME', pattern: d, msg: 'devDatabaseType property' },
          ...
          LANGUAGES: { type: 'list', pattern: E, msg: 'languages property' },
          MESSAGE_BROKER: { type: 'NAME', pattern: d, msg: 'messageBroker property' },
          NATIVE_LANGUAGE: { type: 'NAME', pattern: E, msg: 'nativeLanguage property' },
          ...
          SEARCH_ENGINE: { type: 'NAME', pattern: d, msg: 'searchEngine property' },
          SERVER_PORT: { type: 'INTEGER' },
          SERVICE_DISCOVERY_TYPE: { type: 'NAME', pattern: d, msg: 'serviceDiscoveryType property' },
          SKIP_CLIENT: { type: 'BOOLEAN' },
          SKIP_SERVER: { type: 'BOOLEAN' },
          SKIP_USER_MANAGEMENT: { type: 'BOOLEAN' },
          TEST_FRAMEWORKS: { type: 'list', pattern: d, msg: 'testFrameworks property' },
      ...
      const T = o.getParser();
      T.parse();
      const y = T.getBaseCstVisitorConstructorWithDefaults();
      class A extends y {
        constructor() {
        ...
        checkNameSyntax(t, e, n) {
          ...
          e.test(t.image) ||
            this.errors.push({
              message: `The ${n} name must match: ${((r = e.toString()), r.replace(/^\^/, '').replace(/\$$/, ''))}`,
              token: t
            });
        }
        checkIsSingleName(t) {
          ...
          return (
            !(e && e.length >= 1) ||
            (this.errors.push({ message: 'A single name is expected, but found a fully qualified name.', token: v(t) }),
            !1)
          );
        }
          ...
          switch (t) {
            case 'NAME':
              return 'qualifiedName' !== e.name && e.tokenType && !r.includes(e.tokenType.CATEGORIES, a.BOOLEAN)
                ? (this.errors.push({ message: `A name is expected, but found: "${v(e).image}"`, token: v(e) }), !1)
                : this.checkIsSingleName(e);
            case 'qualifiedName':
              return (
                'qualifiedName' === e.name ||
                (this.errors.push({
                  message: `A fully qualified name is expected, but found: "${v(e).image}"`,
                  token: v(e)
                }),
                !1)
              );
            case 'list':
              return (
                'list' === e.name ||
                (this.errors.push({
                  message: `An array of names is expected, but found: "${v(e).image}"`,
                  token: v(e)
                }),
                !1)
              );
            case 'INTEGER':
              return (
                ...
                (this.errors.push({
                  message: `An integer literal is expected, but found: "${v(e).image}"`,
                  token: v(e)
                }),
                !1)
              );
            case 'STRING':
              return (
                ...
                (this.errors.push({ message: `A string literal is expected, but found: "${v(e).image}"`, token: v(e) }),
                !1)
              );
            case 'BOOLEAN':
              return (
                !!i(e, a.BOOLEAN) ||
                (this.errors.push({
                  message: `A boolean literal is expected, but found: "${v(e).image}"`,
                  token: v(e)
                }),
                !1)
              );
        ...
        fieldDeclaration(t) {
          super.fieldDeclaration(t), this.checkNameSyntax(t.NAME[0], d, 'fieldName');
        }
        type(t) {
        ...
        relationshipSide(t) {
          super.relationshipSide(t),
            ...
            t.injectedField &&
              (this.checkNameSyntax(t.injectedField[0], d, 'injectedField'),
              t.injectedFieldParam && this.checkNameSyntax(t.injectedFieldParam[0], d, 'injectedField'));
        }
        enumDeclaration(t) {
