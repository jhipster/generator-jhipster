        ...
        <div class="row">
            <div class="col-md-4">
                <div *ngIf="garbageCollectorMetrics">
                    ...
                    <ngb-progressbar [max]="garbageCollectorMetrics['jvm.gc.max.data.size']" [value]="garbageCollectorMetrics['jvm.gc.live.data.size']" [striped]="true"
            ...
            <div class="col-md-4">
                <div *ngIf="garbageCollectorMetrics">
                    ...
                    <ngb-progressbar [max]="garbageCollectorMetrics['jvm.gc.memory.allocated']" [value]="garbageCollectorMetrics['jvm.gc.memory.promoted']" [striped]="true"
                                     [animated]="false" type="success">
