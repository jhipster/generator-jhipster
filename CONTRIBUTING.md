...
* JavaSripct files **must follow** [Google's JavaScript Style Guide](https://google-styleguide.googlecode.com/svn/trunk/javascriptguide.xml).
...
### Scope
The scope could be anything specifying place of the commit change. For example `spring security`,
`jpa`, `mongodb`, `atmosphere`, `liquibase`, `angularJs`, `twitter bootstrap`, etc...
