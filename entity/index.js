...
EntityGenerator.prototype.files = function files() {
    ...
    this.template('src/main/webapp/app/_entity-details.html',
        'src/main/webapp/scripts/app/entities/' +    this.entityInstance  + '/' + this.entityInstance + 'Details.html', this, {});
    ...
    this.template('src/main/webapp/app/_entity-details-controller.js',
        'src/main/webapp/scripts/app/entities/' +    this.entityInstance + '/' + this.entityInstance + 'Details.controller' + '.js', this, {});
    this.addAppScriptToIndex(this.entityInstance + '/' + this.entityInstance + 'Details.controller' + '.js');
