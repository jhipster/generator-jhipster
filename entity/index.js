...
EntityGenerator.prototype.files = function files() {
    ...
    this.copyHtml('src/main/webapp/app/_entity-create-edit-detail.html',
        'src/main/webapp/scripts/app/entities/' +    this.entityInstance  + '/' + this.entityInstance + '-create-edit-detail.html', this, {}, true);
    ...
    this.template('src/main/webapp/app/_entity-create-edit-detail-controller.js',
        'src/main/webapp/scripts/app/entities/' +    this.entityInstance + '/' + this.entityInstance + '-create-edit-detail-controller' + '.js', this, {});
    this.addAppScriptToIndex(this.entityInstance + '/' + this.entityInstance + '-create-edit-detail-controller' + '.js');
