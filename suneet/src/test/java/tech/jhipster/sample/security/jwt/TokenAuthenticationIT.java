...
class TokenAuthenticationIT {
    ...
    @Test
    public void testReturnFalseWhenJWThasInvalidSignature() throws Exception {
        expectUnauthorized(createTokenWithDifferentSignature());
    }

    @Test
    public void testReturnFalseWhenJWTisMalformed() throws Exception {
        expectUnauthorized(createSignedInvalidJwt(jwtKey));
    }

    @Test
    public void testReturnFalseWhenJWTisExpired() throws Exception {
