package tech.jhipster.sample.security.jwt;

import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.http.HttpHeaders.AUTHORIZATION;
import static tech.jhipster.sample.security.jwt.JwtAuthenticationTestUtils.*;
...
class TokenAuthenticationSecurityMetersIT {
    ...
    @Test
    public void testValidTokenShouldNotCountAnything() throws Exception {
    ...
    @Test
    public void testTokenExpiredCount() throws Exception {
    ...
    @Test
    public void testTokenSignatureInvalidCount() throws Exception {
    ...
    @Test
    public void testTokenMalformedCount() throws Exception {
    ...
    @Test
    public void testTokenInvalidCount() throws Exception {
        var count = meterRegistry.get(INVALID_TOKENS_METER_EXPECTED_NAME).tag("cause", "malformed").counter().count();
